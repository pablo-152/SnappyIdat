...
<?php
    $query_d=mysqli_query($con, "SELECT * FROM producto_interes WHERE id_empresa=3 AND id_sede=6 AND estado=2 AND formulario=1 ORDER BY orden_producto_interes ASC");
        ...
        <div class="contenedor-secundario">
			...
			<!--
                    <div class="respon-4">
                        ...
                        <label class="color-sub colortitu2">26 <label class="mes">Noviembre</label> <label class="hr"></label> </label>
                    </div>
			-->
                    <div class="respon-9">
                    ...
                    <div class="respon-2">
                        <input type="text" class="corre_re" id="nombres" name="nombres" placeholder="Nombres:" onkeypress="return solo_letras(event);">
                    </div>
                    <div class="respon-3">
                        <input type="text" class="corre_re" id="apellidos" name="apellidos" placeholder="Apellidos:" onkeypress="return solo_letras(event);">
                    </div>
                </div>
                ...
                <div class="div2">
                    ...
                    <div class="titu2">
                        <input type="text" class="corre_re" id="tel" name="tel" placeholder="Numero de Celular:" maxlength="9" onkeypress="return numeros(event)">
                    </div>

                    <div class="titu3">
                        <input type="text" class="corre_re" id="mail" name="mail" placeholder="Correo Electronico:">
                    </div>
                </div>
                    ...
                    <div class="respon-5">
                        <select id="grado" name="grado">
                            ...
                            <?php if($totalRows_d>0){ do{ ?>
                                <option value="<?php echo $row_d['id_producto_interes']?>"><?php echo $row_d['nom_producto_interes']; ?></option>
