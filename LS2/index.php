        ...
        <div class="contenedor-secundario">
			...
			<!--
                    <div class="respon-4">
                        ...
                        <label class="color-sub colortitu2">09 <label class="mes">Diciembre</label></label>
                    </div>
			-->
                    <div class="respon-9">
                    ...
                    <div class="respon-2">
                        <input id="nombres" name="nombres" type="text" placeholder="Nombres:" class="corre_re no_paste" onkeypress="return solo_letras(event);">
                    </div>
                    <div class="respon-3">
                        <input id="apellidos" name="apellidos" type="text" placeholder="Apellidos:" class="corre_re no_paste" onkeypress="return solo_letras(event);">
                    </div>
                </div>
                ...
                <div class="div2">
                    ...
                    <div class="titu2">
                        <input id="tel" name="tel" type="text" placeholder="Numero de Celular:" maxlength="9" class="corre_re no_paste" onkeypress="return numeros(event)">
                    </div>

                    <div class="titu3">
                        <input id="mail" name="mail" type="text" placeholder="Correo Electronico:" class="corre_re no_paste" onkeypress="return solo_correos(event);">
                    </div>
                </div>
