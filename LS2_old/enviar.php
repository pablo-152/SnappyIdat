    ...
    if ($totalRows_v==0){
        ...
        if($totalRows_t>0){
            ...
            if($totalRows_buscar>0){
                ...
                $query_ihrm=mysqli_query($con, "INSERT INTO historial_registro_mail (id_registro,id_evento,comentario,observacion,fecha_accion,id_accion,
                            envio_correo,estado,fec_reg,user_reg)
                            VALUES ('$id_registro','$id_evento','$get_id[2]','$get_id[2]',NOW(),12,1,57,NOW(),0)");
                ...
                $query_irm=mysqli_query($con, "INSERT INTO registro_mail (cod_registro,id_informe,nombres_apellidos,contacto1,
                            correo,id_empresa,id_sede,recibir_info,fecha_inicial,observacion,envio_correo,estado,fec_reg,user_reg) 
                            VALUES ('$cod_registro',14,'$nombre','$tel','$mail',$id_empresa,$id_sede,'$checkbox2',NOW(),
                            '$get_id[2]',1,1,NOW(),0)");
