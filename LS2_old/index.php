...
<?php
    $query_d=mysqli_query($con, "SELECT * FROM producto_interes WHERE id_empresa=4 AND id_sede=5 AND estado=2 AND formulario=1 ORDER BY orden_producto_interes ASC");
...
<body>
    <section class="grid-1">
        ...
        <div class="item-2">
            ...
            <form class="subitemdos-1 form" id="formulario_registro" enctype="multipart/form-data" method="post">
                <div class="inputBox">
                ...
                <div class="inputBox">
                    <input type="text" class="input-form" name="numero_dni" onkeypress="return numeros(event)"  id="numero_dni" value="" placeholder="" required="required" maxlength="8">
                ...
                <div class="inputBox ">
                    <input type="text" class="input-form" name="tel" id="tel" value="" maxlength="9" onkeypress="return numeros(event)" placeholder="" required="required">
                    <span>Teléfono</span>
                    <i class="fas fa-check-circle"></i>
                    <i class="fas fa-exclamation-circle"></i>
                    <small>Error Msg</small>
                ...
                <div class="inputBox  cuadroinpu4">
                    <!---->
                    <!--<input list="browsers" class="input-form"  value="" placeholder="" required="required">-->
                ...
                <div class="inputBoxdos cuadroinpu5">
                    <input type="button" onclick="Insert_Contacto()" style="background-color:#0e75c9;color:white;cursor:pointer;" value="Enviar">
                </div>
			...
			<div class="nuevodiv" >
        			<label class="nuevolabel">info@leadershipschool.edu.pe</label>
    			</div>
                    ...
                    if(val=="validez"){
                        ...
                        if(val=="error"){
                            ...
                            swal.fire(
                                ...
                                window.location = "https://snappy.org.pe/LS2/";
                            });
                        }
                    }
                }
