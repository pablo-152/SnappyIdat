...
$query_t = mysqli_query($con, "SELECT * FROM inscripcion WHERE dni='$numero_dni' AND empresa='LS'");
    ...
    if ($totalRows_t>0){
        ...
        $query_b=mysqli_query($con, "INSERT INTO inscripcion (cod_inscripcion,empresa,
                nombres,dni,correo,celular,id_grado_escuela,id_tipodoc,recibir_info,fec_reg,user_reg,id_estadoi) 
                VALUES ('$cod_inscripcion','LS','$nombres','$numero_dni','$correo','$celular','$id_grado','$id_tipodoc',
