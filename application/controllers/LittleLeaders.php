...
class LittleLeaders extends CI_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->model('Model_LittleLeaders');
    ...
    public function index(){
        if ($this->session->userdata('usuario')) {
            $dato['fondo'] = $this->Model_LittleLeaders->fondo_index();
            ...
            $dato['list_nav_sede'] = $this->Model_LittleLeaders->get_list_nav_sede();

            $this->load->view('view_LL/administrador/index',$dato);
        }
        else{
            redirect('/login');
        }
    ...
    public function Detalle_Aviso() {
        if ($this->session->userdata('usuario')) { 
            ...
            $this->load->view('view_LL/aviso/detalle',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Informe_Lista() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/informe/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Informe(){
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/informe/informe',$dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Informe(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_informe'] = $this->Model_LittleLeaders->get_list_informe();
            $this->load->view('view_LL/informe/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Lista_Informe($tipo){
        $list_informe = $this->Model_LittleLeaders->get_list_informe();
    ...
    public function Detalle_Informe($CourseId=null){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_detalle'] = $this->Model_LittleLeaders->get_list_detalle_informe($CourseId);
            ...
            $this->load->view('view_LL/informe/detalle',$dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Detalle_Informe($CourseId){
        $list_detalle = $this->Model_LittleLeaders->get_list_detalle_informe($CourseId);
    ...
    public function Detalle_Alumno($CourseId=null, $PaymentDueDate=null){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_alumno'] = $this->Model_LittleLeaders->get_list_alumno_informe($CourseId,$PaymentDueDate);
            ...
            $dato['list_empresa']=$this->Admin_model->get_id_empresa_usuario($id_usuario);
            $dato['list_nav_sede'] = $this->Model_LittleLeaders->get_list_nav_sede();
            $this->load->view('view_LL/informe/detalle_alumno',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Detalle_Alumno($CourseId,$PaymentDueDate){
        $PaymentDueDate = substr($PaymentDueDate,0,4)."-".substr($PaymentDueDate,4,2)."-".substr($PaymentDueDate,6,2);
        $list_alumno = $this->Model_LittleLeaders->get_list_alumno_informe($CourseId,$PaymentDueDate);
    ...
    public function Profesor() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/profesor/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Profesor() {
        if ($this->session->userdata('usuario')) {
            $dato['list_profesor'] = $this->Model_LittleLeaders->get_list_profesor();
            $this->load->view('view_LL/profesor/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Profesor(){
        $list_profesor = $this->Model_LittleLeaders->get_list_profesor();
    ...
    public function Documento() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/documento/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Documento() {
        if ($this->session->userdata('usuario')) {
            $dato['list_documento'] = $this->Model_LittleLeaders->get_list_documento();
            $this->load->view('view_LL/documento/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Documento(){
        if ($this->session->userdata('usuario')) {
            $this->load->view('view_LL/documento/modal_registrar');   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Documento(){
        ...
        $total=count($this->Model_LittleLeaders->valida_insert_documento($dato));

        if($total>0){
            echo "error";
        }else{
            $this->Model_LittleLeaders->insert_documento($dato);
            if($dato['aplicar_todos']==1){
                $get_id = $this->Model_LittleLeaders->ultimo_id_documento();
                $dato['id_documento'] = $get_id[0]['id_documento'];
                $dato['anio'] = date('Y');

                $list_alumno = $this->Model_LittleLeaders->get_list_alumno_documento_todos();

                foreach($list_alumno as $list){
                    $dato['id_alumno'] = $list['Id'];
                    $valida = $this->Model_LittleLeaders->valida_insert_documento_todos($dato);
                    if(count($valida)==0){
                        $this->Model_LittleLeaders->insert_documento_todos($dato);
                    }
                }
            }
        }
    ...
    public function Modal_Update_Documento($id_documento){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_documento($id_documento);
            $dato['list_status'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/documento/modal_editar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Documento(){ 
        ...
        $total=count($this->Model_LittleLeaders->valida_update_documento($dato));

        if($total>0){
            echo "error";
        }else{
            $this->Model_LittleLeaders->update_documento($dato); 
            if($dato['aplicar_todos']==1){
                $dato['anio'] = date('Y');
    ...
    public function Delete_Documento(){
        $dato['id_documento']= $this->input->post("id_documento");
        $this->Model_LittleLeaders->delete_documento($dato); 
    }

    public function Excel_Documento(){
        $list_documento = $this->Model_LittleLeaders->get_list_documento();
    ...
    public function Matriculados() {
        if ($this->session->userdata('usuario')) {
            $dato['informe'] = $this->Model_LittleLeaders->get_informe_matriculados(); 
            ...
            $this->load->view('view_LL/matriculados/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Matriculados() {
        if ($this->session->userdata('usuario')) { 
            $dato['tipo'] = $this->input->post("tipo");
            $dato['list_alumno'] = $this->Model_LittleLeaders->get_list_matriculados($dato['tipo']);
            $this->load->view('view_LL/matriculados/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Retiro_Alumno($id_alumno) {
        if ($this->session->userdata('usuario')) { 
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_matriculados($id_alumno);
            $dato['get_retirado'] = $this->Model_LittleLeaders->valida_alumno_retirado($id_alumno);
            $dato['list_motivo'] = $this->Model_LittleLeaders->get_list_motivo();
            ...
            $this->load->view('view_LL/matriculados/retirar_alumno',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Retiro_Alumno(){
        if ($this->session->userdata('usuario')) {
            ...
            $cant = count($this->Model_LittleLeaders->valida_alumno_retirado($dato['id_alumno']));

            if($cant>0){
                $this->Model_LittleLeaders->update_retiro_alumno($dato);
            }else{
                $this->Model_LittleLeaders->insert_retiro_alumno($dato);

                $get_id = $this->Model_LittleLeaders->get_id_matriculados($dato['id_alumno']);
    ...
    public function Modal_Update_Obs_Retiro($id_alumno_retirado){
        if ($this->session->userdata('usuario')){
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_alumno_retirado($id_alumno_retirado);
            $this->load->view('view_LL/matriculados/modal_obs_retiro', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Obs_Motivo_Retiro(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['obs_retiro']= $this->input->post("obs_retiro");
            $this->Model_LittleLeaders->update_obs_motivo_retiro($dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Actualizar_Lista_Matriculados() {   
        if ($this->session->userdata('usuario')) {
            $this->Model_LittleLeaders->truncate_todos_ll_temporal();

            $list_matriculados = $this->Model_LittleLeaders->get_list_matriculados_arpay(); 

            foreach($list_matriculados as $list){
                $dato['Id'] = $list['Id'];
                ...
                $this->Model_LittleLeaders->insert_todos_ll_temporal($dato);
            }

            $list_todos_ll = $this->Model_LittleLeaders->get_list_todos_ll(); 
            $list_todos_ll_temporal = $this->Model_LittleLeaders->get_list_todos_ll_temporal(); 

            if($list_todos_ll_temporal[0]['cantidad']>$list_todos_ll[0]['cantidad']){
                $list_datos_todos_ll_temporal = $this->Model_LittleLeaders->get_list_datos_todos_ll_temporal(); 

                foreach($list_datos_todos_ll_temporal as $list){
                    $dato['Id'] = $list['Id'];
                    ...
                    $list_datos_documento_alumno_empresa = $this->Model_LittleLeaders->get_list_datos_documento_alumno_empresa();

                    foreach($list_datos_documento_alumno_empresa as $documento){
                        $dato['id_documento'] = $documento['id_documento'];

                        if($documento['obligatorio']==2){
                            if($edad>4){
                                $this->Model_LittleLeaders->insert_datos_documento_alumno_empresa($dato);
                            }
            ...
            $this->Model_LittleLeaders->truncate_todos_ll();
            $this->Model_LittleLeaders->insert_todos_ll();
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Matriculados($tipo){
        $list_alumno = $this->Model_LittleLeaders->get_list_matriculados($tipo);
        $sede = 'LL1';
        ...
        foreach($list_alumno as $list){
            ...
            $list_tutor = $this->Model_LittleLeaders->get_list_tutores_alumno($list['Id']);
    ...
    public function Detalle_Matriculados($id_alumno) {
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_matriculados($id_alumno);
            $dato['get_foto'] = $this->Model_LittleLeaders->get_list_foto_matriculados($id_alumno);
            $dato['list_tutor'] = $this->Model_LittleLeaders->get_list_tutor(null,$id_alumno);
            $dato['list_modulo']=$this->Model_LittleLeaders->get_ingresos_modulo($id_alumno);
            $dato['id_empresa']=2;
            ...
            $this->load->view('view_LL/matriculados/detalle',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Update_Sexo($id_alumno){ 
        if ($this->session->userdata('usuario')) {
            ...
            $valida = $this->Model_LittleLeaders->valida_sexo($dato['id_alumno']);

            if(count($valida)>0){
                $dato['update'] = 1;
                $dato['get_id'] = $this->Model_LittleLeaders->valida_sexo($dato['id_alumno']);
            }else{
                $dato['update'] = 0;
            }

            $this->load->view('view_LL/matriculados/modal_sexo', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Sexo(){
        ...
        if($dato['id_sexo']>0){
            $this->Model_LittleLeaders->update_sexo($dato);
        }else{
            $this->Model_LittleLeaders->insert_sexo($dato);
        }
    }

    public function Modal_Tutor(){ 
        if ($this->session->userdata('usuario')) {
            $dato['list_parentesco'] = $this->Model_LittleLeaders->get_list_parentesco();
            $this->load->view('view_LL/matriculados/modal_tutor', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Tutor(){
        if ($this->session->userdata('usuario')) {
            ...
            $this->Model_LittleLeaders->insert_tutor($dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Update_Tutor($id_tutor){ 
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_tutor($id_tutor);
            $dato['list_parentesco'] = $this->Model_LittleLeaders->get_list_parentesco();
            $this->load->view('view_LL/matriculados/modal_update_tutor', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Tutor(){
        if ($this->session->userdata('usuario')) {
            ...
            $this->Model_LittleLeaders->update_tutor($dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Delete_Tutor(){
        if ($this->session->userdata('usuario')) {
            $dato['id_tutor']= $this->input->post("id_tutor");
            $this->Model_LittleLeaders->delete_tutor($dato);
        }else{
            redirect('/login');
        } 
    }
    ...
    public function Lista_Documento_Matriculados() {
        if ($this->session->userdata('usuario')) { 
            $dato['id_alumno'] = $this->input->post("id_alumno");
            $dato['list_documento'] = $this->Model_LittleLeaders->get_list_documento_matriculados($dato['id_alumno']);
            $this->load->view('view_LL/matriculados/lista_documentos',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Documento_Alumno($id_documento,$id_alumno){
        if ($this->session->userdata('usuario')) {
            $dato['get_documento'] = $this->Model_LittleLeaders->get_list_documento($id_documento);
            $dato['id_documento'] = $id_documento;
            $dato['id_alumno'] = $id_alumno;
            $this->load->view('view_LL/matriculados/modal_registrar_documento', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Documento_Alumno(){
        ...
        if($_FILES["archivo_i"]["name"] != ""){
            ...
            $config['upload_path'] = './documento_alumno_matriculado/LL/'.$dato['id_alumno'];
            if (!file_exists($config['upload_path'])) {
                mkdir($config['upload_path'], 0777, true);
                chmod($config['upload_path'], 0777);
                chmod('./documento_alumno_matriculado/', 0777);
                chmod('./documento_alumno_matriculado/LL/', 0777);
                chmod('./documento_alumno_matriculado/LL/'.$dato['id_alumno'], 0777);
            }
            ...
            if($this->upload->do_upload('file')){
                ...
                $dato['archivo'] = "documento_alumno_matriculado/LL/".$dato['id_alumno']."/".$dato['nom_documento'];
            }     
        }
        $this->Model_LittleLeaders->insert_documento_matriculados($dato);
    }

    public function Modal_Update_Documento_Alumno($id_detalle){
        if ($this->session->userdata('usuario')) {
            $dato['get_detalle'] = $this->Model_LittleLeaders->get_id_detalle_alumno_empresa($id_detalle);
            $dato['get_documento'] = $this->Model_LittleLeaders->get_list_documento( $dato['get_detalle'][0]['id_documento']);
            $this->load->view('view_LL/matriculados/modal_editar_documento', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Documento_Alumno(){
        ...
        $get_id = $this->Model_LittleLeaders->get_id_detalle_alumno_empresa($dato['id_detalle']);
        ...
        $this->Model_LittleLeaders->update_documento_matriculados($dato);
    }

    public function Descargar_Imagen($id_detalle){
        if ($this->session->userdata('usuario')) {
            $dato['doc']=$this->Model_LittleLeaders->get_id_detalle_alumno_empresa($id_detalle);
    ...
    public function Delete_Documento_Alumno(){
        if ($this->session->userdata('usuario')) {
            $dato['id_detalle']= $this->input->post("id_detalle");
            $dato['doc']=$this->Model_LittleLeaders->get_documento_alumno($dato);
            unlink($dato['doc'][0]['archivo']);
            $this->Model_LittleLeaders->delete_documento_alumno($dato);
        }else{
            redirect('/login');
        } 
    }
    ...
    public function Excel_Documento_Alumno($id_alumno){
        $list_documento = $this->Model_LittleLeaders->get_list_documento_matriculados($id_alumno); 
    ...
    public function Lista_Pago_Matriculados() {
        if ($this->session->userdata('usuario')) { 
            ...
            $dato['list_pago'] = $this->Model_LittleLeaders->get_list_pago_matriculados($dato['id_alumno']);
            $this->load->view('view_LL/matriculados/lista_pagos',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Pago_Matriculados($id_alumno,$estado){
        $list_pago = $this->Model_LittleLeaders->get_list_pago_matriculados($id_alumno);
    ...
    public function Lista_Foto() {
        if ($this->session->userdata('usuario')) {
            $dato['id_alumno']= $this->input->post("id_alumno"); 
            $dato['list_foto'] = $this->Model_LittleLeaders->get_list_foto_matriculados($dato['id_alumno']);
            $this->load->view('view_LL/matriculados/lista_foto',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Descargar_Foto_Matriculados($id_detalle) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_id_detalle_alumno_empresa($id_detalle);
    ...
    public function Lista_Contrato_Matriculados() { 
        if ($this->session->userdata('usuario')) { 
            $dato['id_alumno'] = $this->input->post("id_alumno");
            $dato['list_contrato'] = $this->Model_LittleLeaders->get_list_contrato_matriculados($dato['id_alumno']);
            $this->load->view('view_LL/matriculados/lista_contratos',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Update_Contrato_Matriculados($id_documento_firma){ 
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_contrato($id_documento_firma);
            $this->load->view('view_LL/matriculados/modal_editar_contrato', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Contrato_Matriculados(){
        ...
        $this->Model_LittleLeaders->update_contrato_matriculados($dato);
    }

    public function Lista_Mensaje_Matriculados() {
        if ($this->session->userdata('usuario')) { 
            $dato['id_alumno'] = $this->input->post("id_alumno");
            $dato['list_mensaje'] = $this->Model_LittleLeaders->get_list_mensaje_matriculados($dato['id_alumno']);
            $this->load->view('view_LL/matriculados/lista_mensajes',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Sms_Matriculados() {  
        if ($this->session->userdata('usuario')) { 
            ...
            $get_id = $this->Model_LittleLeaders->get_id_matriculados($id_alumno);
            $dato['list_sms'] = $this->Model_LittleLeaders->get_list_sms_matriculados($get_id[0]['Celular']);
            $this->load->view('view_LL/matriculados/lista_sms',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Sms_Alumno($id_alumno){
        $get_id = $this->Model_LittleLeaders->get_id_matriculados($id_alumno);
        $list_sms = $this->Model_LittleLeaders->get_list_sms_matriculados($get_id[0]['Celular']);
    ...
    public function Lista_Observacion_Alumno() {
        if ($this->session->userdata('usuario')) {
            $dato['id_alumno'] = $this->input->post("id_alumno");
            $dato['list_observacion']=$this->Model_LittleLeaders->get_list_observacion_alumno($dato['id_alumno']);
            $this->load->view('view_LL/matriculados/lista_observacion',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Registrar_Observacion_Alumno() {
        if ($this->session->userdata('usuario')) {
            $dato['id_alumno'] = $this->input->post("id_alumno");
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_matriculados($dato['id_alumno']);
            $dato['list_tipo_obs'] = $this->Model_LittleLeaders->get_list_tipo_obs(1);
            $dato['list_usuario'] = $this->Model_LittleLeaders->get_list_usuario_observacion();
            $this->load->view('view_LL/matriculados/registrar_observacion',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Observacion_Alumno() {
        if ($this->session->userdata('usuario')) { 
            ...
            if($_FILES["observacion_archivo"]["name"] != ""){
                ...
                $config['upload_path'] = './alumno/ll/observacion/'.$dato['id_alumno'];
                if (!file_exists($config['upload_path'])) {
                    mkdir($config['upload_path'], 0777, true);
                    chmod($config['upload_path'], 0777);
                    chmod('./alumno/ll/observacion/', 0777);
                    chmod('./alumno/ll/observacion/'.$dato['id_alumno'], 0777);
                }
                ...
                if($this->upload->do_upload('file')){
                    $data = $this->upload->data();
                    $dato['observacion_archivo'] = "alumno/ll/observacion/".$dato['id_alumno']."/".$dato['nom_documento'];
                }    
            }else{
            ...
            if($id_tipo!=0){
                $valida = $this->Model_LittleLeaders->valida_insert_observacion_alumno($dato);
        
                if(count($valida)>0){
                    echo "error";
                }else{
                    $this->Model_LittleLeaders->insert_observacion_alumno($dato);
                }
            }

            $this->Model_LittleLeaders->update_comentario_alumno($dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Editar_Observacion_Alumno() {
        if ($this->session->userdata('usuario')) { 
            ...
            $dato['get_id']=$this->Model_LittleLeaders->get_list_observacion_alumno(null,$dato['id_observacion']);
            $dato['list_tipo_obs'] = $this->Model_LittleLeaders->get_list_tipo_obs(1);
            $dato['list_usuario'] = $this->Model_LittleLeaders->get_list_usuario_observacion();
            $this->load->view('view_LL/matriculados/editar_observacion',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Observacion_Alumno() {
        if ($this->session->userdata('usuario')) { 
            ...
            $valida = $this->Model_LittleLeaders->valida_update_observacion_alumno($dato);

            if(count($valida)>0){
                echo "error";
            }else{
                $this->Model_LittleLeaders->update_observacion_alumno($dato);
            }
        }else{
            redirect('/login');
        }
    ...
    public function Delete_Observacion_Alumno() {
        if ($this->session->userdata('usuario')) { 
            $dato['id_observacion'] = $this->input->post("id_observacion");
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_obsaimg($dato['id_observacion']);

            if (file_exists($dato['get_id'][0]['observacion_archivo'])) {
                unlink($dato['get_id'][0]['observacion_archivo']);
            }

            $this->Model_LittleLeaders->delete_observacion_alumno($dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Observacion_Alumno($id_alumno){
        $list_observacion = $this->Model_LittleLeaders->get_list_observacion_alumno($id_alumno);
    ...
    public function Doc_Alumno() {
        if ($this->session->userdata('usuario')) { 
            ...
            $this->load->view('view_LL/doc_alumno/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Doc_Alumno() {
        if ($this->session->userdata('usuario')) {
            $dato['list_alumno'] = $this->Model_LittleLeaders->get_list_todos_alumno();
            $this->load->view('view_LL/doc_alumno/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Doc_Alumno(){
        $list_alumno = $this->Model_LittleLeaders->get_list_todos_alumno();
        $list_documento = $this->Model_LittleLeaders->get_list_doc_alumnos();
        ...
        foreach($list_alumno as $list){
            ...
            foreach($list_documento as $documento){
                ...
                $list_detalle = $this->Model_LittleLeaders->get_list_detalle_doc_alumnos($list['Id'],$documento['cod_documento']);
    ...
    public function Alumno_Obs() {
        if ($this->session->userdata('usuario')) { 
            ...
            $this->load->view('view_LL/alumno_obs/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Alumno_Obs() {
        if ($this->session->userdata('usuario')) {
            $dato['list_alumno_obs'] = $this->Model_LittleLeaders->get_list_alumno_obs();
            $this->load->view('view_LL/alumno_obs/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    public function Excel_Alumno_Obs(){
        $list_alumno_obs = $this->Model_LittleLeaders->get_list_alumno_obs();
    ...
    public function Soporte_Doc() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/soporte_doc/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Soporte_Doc() {
        if ($this->session->userdata('usuario')) {
            $dato['list_soporte_doc'] = $this->Model_LittleLeaders->get_list_soporte_doc();
            $this->load->view('view_LL/soporte_doc/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Soporte_Doc(){
        $list_soporte_doc = $this->Model_LittleLeaders->get_list_soporte_doc();
    ...
    public function C_Contrato() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/c_contrato/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_C_Contrato() {
        if ($this->session->userdata('usuario')) {
            $dato['list_c_contrato'] = $this->Model_LittleLeaders->get_list_c_contrato();
            $this->load->view('view_LL/c_contrato/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_C_Contrato(){
        if ($this->session->userdata('usuario')) {
            $dato['list_anio'] = $this->Model_LittleLeaders->get_list_anio();
            $dato['list_mes'] = $this->Model_LittleLeaders->get_list_mes();
            $dato['list_grado'] = $this->Model_LittleLeaders->get_list_grado_contrato();
            $this->load->view('view_LL/c_contrato/modal_registrar',$dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Traer_Seccion_Contrato_I() {
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_seccion'] = $this->Model_LittleLeaders->get_list_seccion_contrato($dato['id_grado']);
            $this->load->view('view_LL/c_contrato/seccion',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_C_Contrato(){
        ...
        $cantidad = $this->Model_LittleLeaders->ultimo_id_c_contrato();
        ...
        $this->Model_LittleLeaders->insert_c_contrato($dato);
    }

    public function Modal_Update_C_Contrato($id_c_contrato){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_c_contrato($id_c_contrato);
            $dato['list_anio'] = $this->Model_LittleLeaders->get_list_anio();
            $dato['list_mes'] = $this->Model_LittleLeaders->get_list_mes();
            $dato['list_grado'] = $this->Model_LittleLeaders->get_list_grado_contrato();
            $dato['list_seccion'] = $this->Model_LittleLeaders->get_list_seccion_contrato($dato['get_id'][0]['id_grado']);
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/c_contrato/modal_editar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_C_Contrato(){ 
        ...
        $this->Model_LittleLeaders->update_c_contrato($dato); 
    }

    public function Delete_C_Contrato(){ 
        $dato['id_c_contrato']= $this->input->post("id_c_contrato");
        $this->Model_LittleLeaders->delete_c_contrato($dato); 
    }

    public function Excel_C_Contrato(){
        $list_c_contrato = $this->Model_LittleLeaders->get_list_c_contrato();
    ...
    public function Descargar_C_Contrato($id_c_contrato) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_list_c_contrato($id_c_contrato);
    ...
    public function Contrato() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/contrato/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Contrato() {
        if ($this->session->userdata('usuario')) {
            $dato['tipo']= $this->input->post("tipo");
            $dato['list_nuevos'] = $this->Model_LittleLeaders->get_list_contrato($dato['tipo']);
            $this->load->view('view_LL/contrato/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Actualizar_Lista_Contrato() {   
        if ($this->session->userdata('usuario')) {
            $this->Model_LittleLeaders->truncate_tables_contrato(); 

            $list_nuevos_ll = $this->Model_LittleLeaders->get_list_nuevos_ll_arpay(); 
            ...
            foreach($list_nuevos_ll as $list){
                ...
                $this->Model_LittleLeaders->insert_nuevos_ll($dato);
            }

            $get_id = $this->Model_LittleLeaders->get_Ids_nuevos_ll();

            $list_apoderados_ll = $this->Model_LittleLeaders->get_list_apoderados_ll_arpay($get_id[0]['ids']);

            foreach($list_apoderados_ll as $list){
                $dato['Id'] = $list['Id'];
                ...
                $this->Model_LittleLeaders->insert_apoderados_ll($dato);
            }
            ...
            $list_contrato = $this->Model_LittleLeaders->get_contratos_activos();

            foreach($list_contrato as $get_contrato){
                $list_apoderados = $this->Model_LittleLeaders->get_datos_alumno_contrato($get_contrato['id_c_contrato']);

                foreach($list_apoderados as $list){
                    if($get_contrato['id_c_contrato']==17){
                        if($list['grado_alumno']!="2 Años"){
                            $valida = $this->Model_LittleLeaders->valida_envio_correo_contrato($list['Id_Alumno'],$list['Id'],$get_contrato['id_c_contrato']);
                            ...
                            if(count($valida)==0){
                                ...
                                $this->Model_LittleLeaders->insert_documento_firma($dato);
                                $ultimo = $this->Model_LittleLeaders->ultimo_id_documento_firma();
                                ...
                                try {
                                    ...
                                    $mail->Password   = 'xpmcvlmggnolcxjr';                                // SMTP password evyianodudmuqijp 
                                    $mail->SMTPSecure = 'tls';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
                                    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
    ...
    public function Modal_Update_Email_Contrato($id_documento_firma) {
        if ($this->session->userdata('usuario')) { 
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_contrato($id_documento_firma);
            $this->load->view('view_LL/contrato/modal_editar',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Email_Contrato(){
        if ($this->session->userdata('usuario')) { 
            ...
            $this->Model_LittleLeaders->update_email_contrato($dato); 
        }else{
            redirect('/login');
        }
    }
    ...
    public function Reenviar_Email(){ 
        if ($this->session->userdata('usuario')) { 
            ...
            $dato['id_documento_firma'] = $this->input->post("id_documento_firma");
            $get_id = $this->Model_LittleLeaders->get_id_contrato($dato['id_documento_firma']);
            $get_alumno = $this->Model_LittleLeaders->get_datos_alumno_arpay($get_id[0]['id_alumno']);
            $get_apoderado = $this->Model_LittleLeaders->get_datos_apoderados_arpay($get_id[0]['id_apoderado']);
            ...
            $this->Model_LittleLeaders->update_documento_firma($dato);

            $get_correo = $this->Model_LittleLeaders->get_list_c_contrato($get_id[0]['id_contrato']);
    ...
    public function Delete_Contrato(){ 
        $dato['id_documento_firma']= $this->input->post("id_documento_firma");
        $this->Model_LittleLeaders->delete_documento_firma($dato); 
    }

    public function Excel_Contrato($tipo){
        $list_nuevos = $this->Model_LittleLeaders->get_list_contrato($tipo);
    ...
    public function Matricula_Pendiente() {
        if ($this->session->userdata('usuario')) { 
            ...
            $this->load->view('view_LL/matricula_pendiente/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Matricula_Pendiente() {
        if ($this->session->userdata('usuario')) { 
            ...
            $dato['list_alumno'] = $this->Model_LittleLeaders->get_list_matricula_pendiente($tipo);
            $this->load->view('view_LL/matricula_pendiente/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Matricula_Pendiente($tipo){
        $list_alumno = $this->Model_LittleLeaders->get_list_matricula_pendiente($tipo);
    ...
    public function Retirados(){ 
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/retirados/index', $dato);
    ...
    public function Lista_Retirados(){ 
        if ($this->session->userdata('usuario')) {
            $dato['list_retirados'] = $this->Model_LittleLeaders->get_list_retirados();
            $this->load->view('view_LL/retirados/lista', $dato);
        }else{
            redirect('');
        }
    }
    ...
    public function Excel_Retirados(){
        $list_retirados = $this->Model_LittleLeaders->get_list_retirados($tipo);
    ...
    public function Colaborador(){
        if($this->session->userdata('usuario')){
            ...
            $this->load->view('view_LL/colaborador/index', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Colaborador(){
        if($this->session->userdata('usuario')){
            $tipo = $this->input->post("tipo");
            $dato['list_colaborador'] = $this->Model_LittleLeaders->get_list_colaborador($tipo);
            $this->load->view('view_LL/colaborador/lista', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Registrar_Colaborador(){
        if($this->session->userdata('usuario')){
            $dato['list_departamento'] = $this->Model_LittleLeaders->get_list_departamento();
            $dato['list_perfil'] = $this->Model_LittleLeaders->get_list_perfil();
            ...
            $this->load->view('view_LL/colaborador/registrar',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Traer_Provincia_Colaborador(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_provincia'] = $this->Model_LittleLeaders->get_list_provincia($id_departamento);
            $this->load->view('view_LL/colaborador/provincia',$dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Traer_Distrito_Colaborador(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_distrito'] = $this->Model_LittleLeaders->get_list_distrito($id_provincia);
            $this->load->view('view_LL/colaborador/distrito',$dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Colaborador(){ 
        ...
        if($dato['usuario']==""){
            if($_FILES["foto"]["name"] != ""){
                $cantidad = (count($this->Model_LittleLeaders->get_cantidad_colaborador()))+1;
            ...
            $this->Model_LittleLeaders->insert_colaborador($dato);
        }else{
            $valida = $this->Model_LittleLeaders->valida_insert_usuario_colaborador($dato);
            ...
            if(count($valida)>0){
                ...
                $this->Model_LittleLeaders->insert_colaborador($dato);
                $ultimo = $this->Model_LittleLeaders->ultimo_id_colaborador();
                $dato['id_externo'] = $ultimo[0]['id_colaborador'];
                $this->Model_LittleLeaders->insert_usuario_colaborador($dato);
            }
        }
    }
    ...
    public function Editar_Colaborador($id_colaborador){
        if($this->session->userdata('usuario')){
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_colaborador($id_colaborador);
            $dato['list_perfil'] = $this->Model_LittleLeaders->get_list_perfil();
            $dato['list_departamento'] = $this->Model_LittleLeaders->get_list_departamento();
            $dato['list_provincia'] = $this->Model_LittleLeaders->get_list_provincia($dato['get_id'][0]['id_departamento']);
            $dato['list_distrito'] = $this->Model_LittleLeaders->get_list_distrito($dato['get_id'][0]['id_provincia']);
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            ...
            $this->load->view('view_LL/colaborador/editar', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Colaborador(){
        ...
        if($dato['usuario']==""){
            ...
            $this->Model_LittleLeaders->update_colaborador($dato);
        }else{

            $valida = $this->Model_LittleLeaders->valida_update_usuario_colaborador($dato);
            ...
            if(count($valida)>0){
                ...
                $valida = $this->Model_LittleLeaders->valida_insert_users_colaborador($dato);

                if(count($valida)>0){
                    $this->Model_LittleLeaders->update_usuario_colaborador($dato);
                }else{
                    $this->Model_LittleLeaders->insert_usuario_colaborador($dato);
                }
            }
    ...
    public function Descargar_Foto_Colaborador($id_colaborador) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_id_colaborador($id_colaborador);
    ...
    public function Delete_Colaborador(){
        $dato['id_colaborador'] = $this->input->post("id_colaborador");
        $this->Model_LittleLeaders->delete_colaborador($dato);
    }

    public function Excel_Colaborador($tipo){ 
        $list_colaborador = $this->Model_LittleLeaders->get_list_colaborador($tipo);
    ...
    public function Detalle_Colaborador($id_colaborador){
        if($this->session->userdata('usuario')){
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_colaborador($id_colaborador);
            $dato['list_tipo_obs'] = $this->Model_LittleLeaders->get_list_tipo_obs(2);
            $dato['list_usuario'] = $this->Model_LittleLeaders->get_list_usuario_obs();
            ...
            $this->load->view('view_LL/colaborador/detalle', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Cv_Colaborador(){ 
        ...
        $this->Model_LittleLeaders->update_cv_colaborador($dato);
    }

    public function Lista_Contrato_Colaborador(){
        if($this->session->userdata('usuario')){
            $id_colaborador = $this->input->post("id_colaborador");
            $dato['list_contrato'] = $this->Model_LittleLeaders->get_list_contrato_colaborador($id_colaborador);
            $this->load->view('view_LL/colaborador/lista_contrato', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Contrato_Colaborador($id_colaborador){
        if ($this->session->userdata('usuario')){
            ...
            $this->load->view('view_LL/colaborador/modal_registrar_contrato',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Contrato_Colaborador(){
        ...
        $valida = $this->Model_LittleLeaders->valida_insert_contrato_colaborador($dato);

        if (count($valida)>0) {
            echo "error";
        }else{
            if($_FILES["archivo_i"]["name"] != ""){
                $cantidad = (count($this->Model_LittleLeaders->get_cantidad_contrato_colaborador()))+1;
            ...
            $this->Model_LittleLeaders->insert_contrato_colaborador($dato);
        }
    }

    public function Modal_Update_Contrato_Colaborador($id_contrato){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_contrato_colaborador($id_contrato);
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/colaborador/modal_editar_contrato', $dato);
        } else {
            redirect('/login');
        }
    }
    ...
    public function Update_Contrato_Colaborador(){
        ...
        $valida = $this->Model_LittleLeaders->valida_update_contrato_colaborador($dato);
        ...
        if (count($valida)>0) {
            ...
            $this->Model_LittleLeaders->update_contrato_colaborador($dato);
        }
    }

    public function Descargar_Contrato_Colaborador($id_contrato) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_id_contrato_colaborador($id_contrato);
            $image = $dato['get_file'][0]['archivo'];
            $name     = basename($image);
            $ext      = pathinfo($image, PATHINFO_EXTENSION);
            force_download($name , file_get_contents($dato['get_file'][0]['archivo']));
    ...
    public function Delete_Contrato_Colaborador(){
        $dato['id_contrato'] = $this->input->post("id_contrato");
        $this->Model_LittleLeaders->delete_contrato_colaborador($dato);
    }

    public function Lista_Pago_Colaborador(){
        if($this->session->userdata('usuario')){
            $id_colaborador = $this->input->post("id_colaborador");
            $dato['list_pago'] = $this->Model_LittleLeaders->get_list_pago_colaborador($id_colaborador);
            $this->load->view('view_LL/colaborador/lista_pago', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Pago_Colaborador($id_colaborador){
        if ($this->session->userdata('usuario')){
            $dato['id_colaborador'] = $id_colaborador;
            $this->load->view('view_LL/colaborador/modal_registrar_pago',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Pago_Colaborador(){
        ...
        $valida = $this->Model_LittleLeaders->valida_insert_pago_colaborador($dato);

        if (count($valida)>0) {
            echo "error";
        }else{
            $this->Model_LittleLeaders->insert_pago_colaborador($dato);
        }
    }

    public function Modal_Update_Pago_Colaborador($id_pago){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_pago_colaborador($id_pago);
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/colaborador/modal_editar_pago', $dato);
        } else {
            redirect('/login');
        }
    }
    ...
    public function Update_Pago_Colaborador(){
        ...
        $valida = $this->Model_LittleLeaders->valida_update_pago_colaborador($dato);

        if (count($valida)>0) {
            echo "error";
        }else{
            $this->Model_LittleLeaders->update_pago_colaborador($dato);
        }
    }

    public function Delete_Pago_Colaborador(){
        $dato['id_pago'] = $this->input->post("id_pago");
        $this->Model_LittleLeaders->delete_pago_colaborador($dato);
    }

    public function Lista_Asistencia_Colaborador(){
        if($this->session->userdata('usuario')){
            $id_colaborador = $this->input->post("id_colaborador");
            $dato['list_asistencia'] = $this->Model_LittleLeaders->get_list_asistencia_colaborador($id_colaborador);
            $this->load->view('view_LL/colaborador/lista_asistencia', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Ingresos_Colaborador($id_colaborador){
        $list_asistencia = $this->Model_LittleLeaders->get_list_asistencia_colaborador($id_colaborador);
    ...
    public function Lista_Observacion_Colaborador() {
        if ($this->session->userdata('usuario')) { 
            $id_colaborador = $this->input->post("id_colaborador");
            $dato['list_observacion']=$this->Model_LittleLeaders->get_list_observacion_colaborador($id_colaborador);
            $this->load->view('view_LL/colaborador/lista_observacion',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Observacion_Colaborador() {
        ...
        if($id_tipo!=0){
            $valida = $this->Model_LittleLeaders->valida_insert_observacion_colaborador($dato);

            if(count($valida)>0){
                echo "error";
            }else{
                $this->Model_LittleLeaders->insert_observacion_colaborador($dato);
            }
        }

        $this->Model_LittleLeaders->update_comentario_colaborador($dato);
    }

    public function Delete_Observacion_Colaborador() {
        $dato['id_observacion'] = $this->input->post("id_observacion");
        $dato['get_id'] = $this->Model_LittleLeaders->get_id_obscimg($dato['id_observacion']);

        if (file_exists($dato['get_id'][0]['observacion_archivo'])) {
            unlink($dato['get_id'][0]['observacion_archivo']);
        }
        $this->Model_LittleLeaders->delete_observacion_colaborador($dato);
    }
    ...
    public function Colaborador_Obs() {
        if ($this->session->userdata('usuario')) { 
            ...
            $this->load->view('view_LL/colaborador_obs/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Colaborador_Obs() {
        if ($this->session->userdata('usuario')) { 
            $dato['list_colaborador_obs'] = $this->Model_LittleLeaders->get_list_colaborador_obs();
            $this->load->view('view_LL/colaborador_obs/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    public function Excel_Colaborador_Obs(){
        $list_colaborador_obs = $this->Model_LittleLeaders->get_list_colaborador_obs();
    ...
    public function Calendario() { 
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/calendario/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Calendario() {
        if ($this->session->userdata('usuario')) {
            $dato['tipo']= $this->input->post("tipo");
            $dato['list_festivo'] = $this->Model_LittleLeaders->get_list_calendario($dato['tipo']);
            $this->load->view('view_LL/calendario/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Calendario(){
        if ($this->session->userdata('usuario')) { 
            $this->load->view('view_LL/calendario/modal_registrar');   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Calendario(){
        ...
        $this->Model_LittleLeaders->insert_calendario($dato);
    }

    public function Modal_Update_Calendario($id_calendario){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_calendario($id_calendario);
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/calendario/modal_editar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Calendario(){
        ...
        $dato['estado'] = $this->input->post("estado_u");
        $this->Model_LittleLeaders->update_calendario($dato);
    }

    public function Delete_Calendario(){
        $dato['id_calendario']= $this->input->post("id_calendario"); 
        $this->Model_LittleLeaders->delete_calendario($dato);
    }

    public function Excel_Calendario($tipo){
        $list_calendario = $this->Model_LittleLeaders->get_list_calendario($tipo);
    ...
    public function Asistencia_Colaborador(){
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/asistencia_colaborador/index', $dato); 
        }else{
            redirect('/login');
        }
    }
    ...
    public function Asistencia_Colaborador_Lista(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_registro_ingreso'] = $this->Model_LittleLeaders->get_list_registro_ingreso_c($fec_in,$fec_fi,$tipo);
                        
            $this->load->view('view_LL/asistencia_colaborador/lista', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Asistencia_Colaborador($fec_in,$fec_fi){     
        ...
        $list_registro_ingreso = $this->Model_LittleLeaders->get_list_registro_ingreso_c($fec_in,$fec_fi);
    ...
    public function Delete_Registro_Ingreso_Lista(){
        ...
        $this->Model_LittleLeaders->delete_registro_ingreso_lista($dato);
    }
    ...
    public function Salon() {
        ...
        $dato['list_salon'] = $this->Model_LittleLeaders->get_list_salon();
       ...
       $dato['list_empresa']=$this->Admin_model->get_id_empresa_usuario($id_usuario);
       $dato['list_nav_sede'] = $this->Model_LittleLeaders->get_list_nav_sede();
        $this->load->view('view_LL/salon/index',$dato);
    }

    public function Registrar_Salon(){
        if ($this->session->userdata('usuario')) {
            $dato['list_tipo_salon'] = $this->Model_LittleLeaders->get_list_tipo_salon();
            $dato['list_especialidad'] = $this->Model_LittleLeaders->get_list_especialidad_combo();
            ...
            $this->load->view('view_LL/salon/registrar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Salon(){
        ...
        $total=count($this->Model_LittleLeaders->valida_insert_salon($dato));

        if($total>0){
            echo "error";
        }else{
            $this->Model_LittleLeaders->insert_salon($dato);
        }
    }

    public function Editar_Salon($id_salon){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_salon($id_salon);
            $dato['list_tipo_salon'] = $this->Model_LittleLeaders->get_list_tipo_salon();
            $dato['list_especialidad'] = $this->Model_LittleLeaders->get_list_especialidad_combo();
           ...
           $dato['list_nav_sede'] = $this->Model_LittleLeaders->get_list_nav_sede();
            ...
            $this->load->view('view_LL/salon/editar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Salon(){
        ...
        $total=count($this->Model_LittleLeaders->valida_update_salon($dato));

        if($total>0){
            echo "error";
        }else{
            $this->Model_LittleLeaders->update_salon($dato);
        }
    }

    public function Delete_Salon(){
        $dato['id_salon']= $this->input->post("id_salon");
        $this->Model_LittleLeaders->delete_salon($dato);
    }

    public function Excel_Salon(){
        $list_salon = $this->Model_LittleLeaders->get_list_salon();
    ...
    public function Mailing() {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/mailing/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Mailing() {
        if ($this->session->userdata('usuario')) {
            $dato['list_mailing'] = $this->Model_LittleLeaders->get_list_mailing();
            $this->load->view('view_LL/mailing/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_Mailing(){
        if ($this->session->userdata('usuario')) {
            $dato['list_alumno'] = $this->Model_LittleLeaders->get_list_alumno_mailing();
            $dato['list_grado'] = $this->Model_LittleLeaders->get_list_grado_mailing();
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/mailing/modal_registrar',$dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Traer_Seccion_Mailing() {
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_seccion'] = $this->Model_LittleLeaders->get_list_seccion_mailing($dato['nom_grado']);
            $this->load->view('view_LL/mailing/seccion',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_Mailing(){
        if ($this->session->userdata('usuario')) {
            ...
            $cantidad = $this->Model_LittleLeaders->get_cantidad_mailing();
            ...
            $this->Model_LittleLeaders->insert_mailing($dato);
            $ultimo = $this->Model_LittleLeaders->ultimo_id_mailing();
            ...
            if(!is_null($this->input->post("id_alumno_i"))){
                foreach($this->input->post("id_alumno_i") as $id_alumno){
                    $dato['id_alumno'] = $id_alumno;
                    $this->Model_LittleLeaders->insert_envio_mailing($dato);
                }
            }
        }else{
            redirect('');
    ...
    public function Modal_Update_Mailing($id_mailing){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_mailing($id_mailing);
            $dato['list_alumno'] = $this->Model_LittleLeaders->get_list_alumno_mailing();
            $dato['list_envio'] = $this->Model_LittleLeaders->get_list_envio_mailing($id_mailing);
            $dato['list_grado'] = $this->Model_LittleLeaders->get_list_grado_mailing();
            $dato['list_seccion'] = $this->Model_LittleLeaders->get_list_seccion_mailing($dato['get_id'][0]['grado']);
            $dato['list_estado'] = $this->Model_LittleLeaders->get_list_status();
            $this->load->view('view_LL/mailing/modal_editar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_Mailing(){ 
        if ($this->session->userdata('usuario')) {
            ...
            $this->Model_LittleLeaders->update_mailing($dato);

            $this->Model_LittleLeaders->delete_envio_mailing($dato);
    ...
    public function Actualizar_Lista_Mailing(){  
        if ($this->session->userdata('usuario')){
            $list_mailing = $this->Model_LittleLeaders->get_mailing_activos();

            foreach($list_mailing as $list){
                $dato['id_mailing'] = $list['id_mailing'];

                $list_alumno = $this->Model_LittleLeaders->get_datos_alumno_mailing($dato['id_mailing']);
                ...
                foreach($list_alumno as $get_alumno){
                    ...
                    try {
                        ...
                        $this->Model_LittleLeaders->insert_detalle_mailing($dato);
                    } catch (Exception $e) {
                        echo "Hubo un error al enviar el correo: {$mail->ErrorInfo}";
                    } 
                }

                $this->Model_LittleLeaders->update_enviado_mailing($dato);
            }
        }else{
            redirect('');
        }
    ...
    public function Descargar_Mailing($id_mailing) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_list_mailing($id_mailing);
            $image = $dato['get_file'][0]['documento'];
            $name     = basename($image);
            $ext      = pathinfo($image, PATHINFO_EXTENSION);
            force_download($name , file_get_contents($dato['get_file'][0]['documento']));
    ...
    public function Delete_Mailing(){ 
        if ($this->session->userdata('usuario')) {
            $dato['id_mailing']= $this->input->post("id_mailing");
            $this->Model_LittleLeaders->delete_mailing($dato); 
        }else{
            redirect('');
        }
    }
    ...
    public function Excel_Mailing(){
        $list_mailing = $this->Model_LittleLeaders->get_list_mailing();
    ...
    public function Detalle_Mailing($id_mailing) {
        if ($this->session->userdata('usuario')) {
            ...
            $this->load->view('view_LL/mailing/detalle',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Lista_Detalle_Mailing() {
        if ($this->session->userdata('usuario')) {
            $dato['id_mailing']= $this->input->post("id_mailing");
            $dato['tipo']= $this->input->post("tipo");
            $dato['list_detalle'] = $this->Model_LittleLeaders->get_list_detalle_mailing($dato['id_mailing'],$dato['tipo']);
            $this->load->view('view_LL/mailing/lista_detalle',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Detalle_Mailing($id_mailing,$tipo){
        $list_detalle = $this->Model_LittleLeaders->get_list_detalle_mailing($id_mailing,$tipo);
    ...
    public function Descargar_ArchivoOA($id_comuimg) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_id_obsaimg($id_comuimg);
    ...
    public function Descargar_ArchivoOC($id_comuimg) {
        if ($this->session->userdata('usuario')) {
            $dato['get_file'] = $this->Model_LittleLeaders->get_id_obscimg($id_comuimg);
            $image = $dato['get_file'][0]['observacion_archivo'];
            $name     = basename($image);
            $ext      = pathinfo($image, PATHINFO_EXTENSION);
            force_download($name , file_get_contents($dato['get_file'][0]['observacion_archivo']));
    ...
    public function Lista_Ingreso_Matriculados() { 
        if ($this->session->userdata('usuario')) { 
            ...
            $dato['list_registro_ingreso'] = $this->Model_LittleLeaders->get_list_registro_ingreso_matriculados_modulo($dato);
           // $dato['list_registro_ingreso'] = $this->Model_IFV->get_list_registro_ingreso_matriculados($dato['id_alumno']);

            $this->load->view('view_LL/matriculados/lista_ingreso',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Excel_Modulo($id_alumno,$modulo){
        ...
        $list_registro_ingreso = $this->Model_LittleLeaders->get_list_registro_ingreso_matriculados_modulo($dato);
        $list_modulo=$this->Model_LittleLeaders->get_ingresos_modulo($id_alumno);
        $spreadsheet = new Spreadsheet();
        //$sheet = $spreadsheet->getActiveSheet();
    ...
    public function Modal_Historial_Registro_Ingreso($id_registro_ingreso){
        if ($this->session->userdata('usuario')) {
            $dato['list_historico_ingreso'] = $this->Model_LittleLeaders->get_list_historial_registro_ingreso($id_registro_ingreso); 
            $this->load->view('view_LL/registro_ingreso/modal_historial', $dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function C_Bimestres() {
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_empresa']=$this->Admin_model->get_id_empresa_usuario($id_usuario);
            $dato['list_nav_sede'] = $this->Model_LittleLeaders->get_list_nav_sede();
            $this->load->view('view_LL/c_bimestres/index',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Fotocheck_Colaborador(){
        if($this->session->userdata('usuario')){
            ...
            $this->load->view('view_LL/fotocheck_colaborador/index',$dato);
        }
    }
    ...
    public function Lista_Fotocheck_Colaboradores() {
        if ($this->session->userdata('usuario')) {
            $dato['tipo']= $this->input->post("tipo");
            $dato['list_fotocheck'] = $this->Model_LittleLeaders->get_list_fotocheck($dato['tipo']);
            $this->load->view('view_LL/fotocheck_colaborador/lista',$dato);
        }else{
            redirect('');
        }
    }
    public function Modal_Foto($id_fotocheck){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_fotocheck($id_fotocheck);
            $this->load->view('view_LL/fotocheck_colaborador/modal_foto', $dato);
        }else{
            redirect('');
        }
    }
    public function Guardar_Foto(){
        if ($this->session->userdata('usuario')) {
            ...
            if($_FILES["foto_fotocheck_2"]["name"] != ""){
                $get_doc = $this->Model_LittleLeaders->get_cod_documento_colaborador('D01');
                ...
                $config['upload_path'] = './documento_colaborador_ll/'.$get_doc[0]['id_documento'].'/'.$dato['id_colaborador'];
                if (!file_exists($config['upload_path'])) {
                    mkdir($config['upload_path'], 0777, true);
                    chmod($config['upload_path'], 0777);
                    chmod('./documento_colaborador_ll/', 0777);
                    chmod('./documento_colaborador_ll/'.$get_doc[0]['id_documento'], 0777);
                    chmod('./documento_colaborador_ll/'.$get_doc[0]['id_documento'].'/'.$dato['id_colaborador'], 0777);
                }
                ...
                if($this->upload->do_upload('file')){
                    $data = $this->upload->data();
                    $dato['foto_fotocheck_2'] = "documento_colaborador_ll/".$get_doc[0]['id_documento']."/".$dato['id_colaborador']."/".$dato['nom_documento'];
                }

                $dato['n_foto'] = 2;
                $this->Model_LittleLeaders->update_foto_fotocheck($dato);
                $get_detalle = $this->Model_LittleLeaders->get_detalle_colaborador_empresa($dato['id_colaborador'],$get_doc[0]['id_documento']);
                $dato['id_detalle'] = $get_detalle[0]['id_detalle'];
                $dato['archivo'] = $dato['foto_fotocheck_2'];
                $this->Model_LittleLeaders->update_documento_colaborador($dato);
            }

            if($_FILES["foto_fotocheck"]["name"] != ""){
                $get_doc = $this->Model_LittleLeaders->get_cod_documento_colaborador('D00');
                ...
                if($this->upload->do_upload('file')){
                    $data = $this->upload->data();
                    $dato['foto_fotocheck'] = "documento_colaborador_ll/".$get_doc[0]['id_documento']."/".$dato['id_colaborador']."/".$dato['nom_documento'];
                }
            ...
            if($_FILES["foto_fotocheck_3"]["name"] != ""){
                ...
                $config['upload_path'] = './documento_colaborador_ll/0/'.$dato['id_colaborador'];
                if (!file_exists($config['upload_path'])) {
                    mkdir($config['upload_path'], 0777, true);
                    chmod($config['upload_path'], 0777);
                    chmod('./documento_colaborador_ll/', 0777);
                    chmod('./documento_colaborador_ll/0', 0777);
                    chmod('./documento_colaborador_ll/0/'.$dato['id_colaborador'], 0777);
                }
                $config["allowed_types"] = 'jpeg|png|jpg|pdf|JPEG|JPG|PNG|PDF';
                $this->load->library('upload', $config);
                $this->upload->initialize($config);
                ...
                if($this->upload->do_upload('file')){
                    $data = $this->upload->data();
                    $dato['foto_fotocheck_3'] = "documento_colaborador_ll/0/".$dato['id_colaborador']."/".$dato['nom_documento'];
                }
            ...
            $valida = $this->Model_LittleLeaders->valida_fotocheck_completo($dato['id_fotocheck']);

            if(count($valida)==0){
                $this->Model_LittleLeaders->update_fotocheck_completo($dato);
            }
    ...
    public function Modal_Detalle($id_fotocheck){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_fotocheck($id_fotocheck);
            $this->load->view('view_LL/fotocheck_colaborador/modal_detalle', $dato);
        }else{
            redirect('');
        }
    }
    public function Carne_Colaborador($id_fotocheck){
        if ($this->session->userdata('usuario')) {
            ...
            $html = $this->load->view('view_LL/fotocheck_colaborador/carnet',$dato,true);
    ...
    public function Impresion_Fotocheck(){
        if ($this->session->userdata('usuario')) {
            $dato['id_fotocheck']= $this->input->post("id_fotocheck");
            $this->Model_LittleLeaders->impresion_fotocheck($dato);
        }else{
            redirect('');
        }
    }
    ...
    public function Modal_Anular($id_fotocheck){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_id_fotocheck($id_fotocheck);
            $this->load->view('view_LL/fotocheck_colaborador/modal_anular', $dato);
        }else{
            redirect('');
        }
    }
    public function Anular_Envio(){
        if ($this->session->userdata('usuario')) {
            ...
            $this->Model_LittleLeaders->anular_envio($dato);
        } else {
            redirect('/login');
        }
    }
    public function Modal_Envio(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['get_id_user'] = $this->Model_LittleLeaders->get_id_user();
            $dato['list_cargo_sesion'] = $this->Model_LittleLeaders->get_cargo_x_id($id_usuario);
            $this->load->view('view_LL/fotocheck_colaborador/modal_envio', $dato);
        }else{
            redirect('');
        }
    }
    public function Traer_Cargo(){
        if ($this->session->userdata('usuario')) {
            ...
            $dato['list_cargo'] = $this->Model_LittleLeaders->get_cargo_x_id($id_usuario_de);
            $dato['id_cargo'] = "cargo_envio_f";
            $this->load->view('view_LL/fotocheck_colaborador/cargo',$dato);
        }else{
            redirect('');
        }
    }
        ...
        if ($this->session->userdata('usuario')) {
            ...
            if($cantidad>0){
                ...
                while($i<count($array)){
                    ...
                    $alumno = $this->Model_LittleLeaders->get_id_fotocheck($dato['id_fotocheck']);

                    if(count($alumno)>0){
                        if ($alumno[0]['esta_fotocheck']=='Foto Rec'){
                            $this->Model_LittleLeaders->update_envio_fotocheck($dato);
                        }
                    }
    ...
    public function Lista_C_Bimestres() {
        if ($this->session->userdata('usuario')) {
            $dato['list_c_bimestres'] = $this->Model_LittleLeaders->get_list_c_bimestres();
            $this->load->view('view_LL/c_bimestres/lista',$dato);
        }else{
            redirect('/login');
        }
    }
    ...
    public function Modal_C_Bimestres(){
        if ($this->session->userdata('usuario')) {
            $this->load->view('view_LL/c_bimestres/modal_registrar');   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Insert_C_Bimestres(){
        ...
        $this->Model_LittleLeaders->insert_c_bimestres($dato);
    }

    public function Modal_Update_C_Bimestres($id_bimestre){
        if ($this->session->userdata('usuario')) {
            $dato['get_id'] = $this->Model_LittleLeaders->get_list_c_bimestres($id_bimestre);
            $this->load->view('view_LL/c_bimestres/modal_editar', $dato);   
        }else{
            redirect('/login');
        }
    }
    ...
    public function Update_C_Bimestres(){ 
        ...
        $this->Model_LittleLeaders->update_c_bimestres($dato); 
    }

    public function Delete_C_Bimestres(){ 
        $dato['id_bimestre']= $this->input->post("id_bimestre");
        $this->Model_LittleLeaders->delete_c_bimestres($dato); 
    }
}