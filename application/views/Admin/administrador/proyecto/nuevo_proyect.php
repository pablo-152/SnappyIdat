    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
      ...
      <div class="row">
        <div class="col-md-12" class="collapse" id="collapseExample">
          <div class="tile">
            <h3 class="tile-title line-head">Nuevo proyecto</h3>
            <div class="tile-body" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  <label class="control-label text-bold">Fecha:</label>
                   <input class="form-control date" id="fec_solicitante" name="fec_solicitante" placeholder= "Seleccione fecha"  type="date" value="<?php echo date('d/m/Y');?>" />
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input name="descripcion" type="text" maxlength="30" class="form-control" id="descripcion" placeholder="Ingresar descripción">
                </div>
                 ...
                 <div class="form-group col-md-12">
                        <div class="col-xs-12">
                            ...
                            <textarea name="proy_obs" rows="10" class="form-control" id="proy_obs"></textarea>
