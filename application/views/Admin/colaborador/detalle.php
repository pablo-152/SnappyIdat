            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group"> 
                        ...
                        app_crear_per="<?= site_url('Administrador/Modal_Contrato_Colaborador') ?>/<?php echo $get_id[0]['id_colaborador']; ?>" style="margin-right:5px;">
                        ...
                        app_crear_per="<?= site_url('Administrador/Modal_Pago_Colaborador') ?>/<?php echo $get_id[0]['id_colaborador']; ?>" style="margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/boton_nuevo_pago.png" alt="Exportar Excel">
                        </a>

                        <a title="Horario" data-toggle="modal" data-target="#acceso_modal" 
                        app_crear_per="<?= site_url('Administrador/Modal_Horario_Colaborador') ?>/<?php echo $get_id[0]['id_colaborador']; ?>" style="margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/horario_btn.png" alt="Exportar Excel">
                        </a>

                        <a type="button" href="<?= site_url('Administrador/Colaborador') ?>">
...
<script>
    ...
    function Descargar_Foto_Colaborador(id){
        window.location.replace("<?php echo site_url(); ?>Administrador/Descargar_Foto_Colaborador/"+id);
    }
    ...
    function Update_Cv_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>Administrador/Update_Cv_Colaborador";
        ...
        if (Valida_Update_Cv_Colaborador()) {
            $.ajax({
                ...
                success:function (data) {
                    window.location = "<?php echo site_url(); ?>Administrador/Detalle_Colaborador/"+id_colaborador;
                }
            });
        }
    }
    ...
    function Lista_Contrato(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>Administrador/Lista_Contrato_Colaborador";
    ...
    function Descargar_Contrato_Colaborador(id){
        window.location.replace("<?php echo site_url(); ?>Administrador/Descargar_Contrato_Colaborador/"+id);
    }

    function Delete_Contrato_Colaborador(id){
        Cargando();

        var url="<?php echo site_url(); ?>Administrador/Delete_Contrato_Colaborador";
    ...
    function Lista_Pago(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>Administrador/Lista_Pago_Colaborador";
    ...
    function Delete_Pago_Colaborador(id){
        ...
        var url="<?php echo site_url(); ?>Administrador/Delete_Pago_Colaborador";
    ...
    function Lista_Horario(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>Administrador/Lista_Horario_Colaborador";
    ...
    function Lista_Asistencia(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>Administrador/Lista_Asistencia_Colaborador";
    ...
    function Excel_Asistencia(){
        var id_colaborador = $("#id_colaborador").val();
        window.location ="<?php echo site_url(); ?>Administrador/Excel_Ingresos_Colaborador/"+id_colaborador;
    }
    ...
    function Lista_Observacion(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>Administrador/Lista_Observacion_Colaborador";
    ...
    function Insert_Observacion_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>Administrador/Insert_Observacion_Colaborador";
    ...
    function Delete_Observacion_Colaborador(id){
        ...
        var url="<?php echo site_url(); ?>Administrador/Delete_Observacion_Colaborador";
