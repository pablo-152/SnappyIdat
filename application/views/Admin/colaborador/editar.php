    ...
    <div class="container-fluid">
        <form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-default" href="<?= site_url('Administrador/Colaborador') ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function Traer_Provincia_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>Administrador/Traer_Provincia_Colaborador";
    ...
    function Traer_Distrito_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>Administrador/Traer_Distrito_Colaborador";
    ...
    function Update_Colaborador() {
        ...
        var url = "<?php echo site_url(); ?>Administrador/Update_Colaborador";
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data=="error"){
                        ...
                        window.location = "<?php echo site_url(); ?>Administrador/Colaborador";
                    }
                }
            });
        }
