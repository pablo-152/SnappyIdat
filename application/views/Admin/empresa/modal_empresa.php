...
<div class="modal-content">
    <form class="form-horizontal" id="from_foto" method="POST" enctype="multipart/form-data" action="<?= site_url('Snappy/Insert_Empresa')?>"  class="formulario">
        ...
        <div class="modal-body" style="max-height:450px; overflow:auto;">
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-10">
                    <input type="text" class="form-control" id="nom_empresa" name="nom_empresa" placeholder="Ingresar Nombre" autofocus>
                </div>
                <div class="form-group col-md-2">
                    <label class="col-sm-3 control-label text-bold">Código: </label>
                </div>
                <div class="form-group col-sm-4">
                    <input type="text" class="form-control" id="cod_empresa" name="cod_empresa" placeholder="Ingresar Código" autofocus>
                </div>
                <div class="form-group col-md-2">
                    <label class="col-sm-3 control-label text-bold">Orden: </label>
                </div>
                <div class="form-group col-sm-4">
                    <input type="text" class="form-control" id="orden_empresa" name="orden_empresa" placeholder="Ingresar Orden" autofocus>
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-sm-2">
                    <input type="checkbox" id="rep_redes" name="rep_redes" value="1" class="minimal"/>
                </div>
                <div class="form-group col-md-2">
                    <label class="col-sm-3 control-label text-bold">Observaciones: </label>
                </div>
                <div class="col-sm-10">
                    <textarea name="observaciones_empresa" rows="4" class="form-control" id="observaciones_empresa"></textarea>
                </div>
            </div>  	           	                	        
        </div> 
...
$("#createProductBtn").on('click', function(e){
    if (valida_empresa()) {
        bootbox.confirm({
            title: "Registrar Datos Empresa",
            message: "¿Desea registrar datos de la empresa?",
            buttons: {
                cancel: {
                    label: 'Cancelar'
                },
