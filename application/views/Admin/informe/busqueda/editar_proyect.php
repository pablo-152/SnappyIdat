...
<div class="panel panel-flat">
    ...
    <div class="container-fluid">
      <form id="from_proy" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <?php if($get_id[0]['imagen']!=""){ ?>
              <div class="col-md-2">
                ...
                <a style="cursor:pointer;" title="Descargar" class="download" type="button" id="download_file" data-image_id="<?php echo $get_id[0]['id_proyecto']?>">
        ...
        <div class="col-md-12 row">
          ...
          <div class="col">
            <textarea name="proy_obs" rows="6" class="form-control" id="proy_obs" ><?php echo $get_id[0]['proy_obs']?></textarea>
          ...
          <div class="col-md-12 row">
            ...
            $id_nivel==3 || $id_nivel==4 || $id_nivel==6){ ?>
              <div class="col-md-2">
        ...
        $id_nivel==3 || $id_nivel==4 || $id_nivel==6){ ?>
          <div class="col-md-12 row" style="margin-top:15px;margin-bottom:15px;">
            <div class="col-md-12" id="divcopy" <?php if($get_id[0]['id_tipo']==15 || $get_id[0]['id_tipo']==20 || $get_id[0]['id_tipo']==34){echo "style='display:block'"; }else{echo "style='display:none'"; }?>>
    ...
    <div class="modal-footer">
      ...
      <!--<a type="button" class="btn btn-default" href="<?= site_url('Snappy/Busqueda') ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</button>-->
      <a href="<?= site_url('Snappy/Busqueda') ?>"><button type="button" class="btn btn-default" ><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</button></a>
    </div>
</div>
...
<script>
  ...
  function Update_Proyecto(){
      ...
      //var url="<?php echo site_url(); ?>Snappy/Busqueda";
      ...
      if (proyecto()) {
          $.ajax({
              ...
              success:function (data) {
                  ...
                  window.location = "<?php echo site_url(); ?>Snappy/Busqueda";           
              }
          });
      }
  }
