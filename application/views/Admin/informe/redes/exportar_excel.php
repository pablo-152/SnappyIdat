...
header("Content-Disposition: filename=Reporte-Redes (Mensual).xls"); 
...
?>
<div class="box-header"><!--<div align="right">
  <button type="button" onClick="Nuevo()" class="btn btn-primary">Nuevo Proyecto</button>&nbsp;&nbsp;&nbsp;&nbsp;</div>-->

</div><!-- /.box-header -->

<div class="box-body table-responsive">
<?php /*if ($totalRows_p<1) 
{
