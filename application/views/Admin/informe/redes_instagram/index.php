        ...
        <div class="row">
            <div class="x_panel">
                ...
                <div class="page-title" style="background-color: #C1C1C1;">
                    <h4 style="font-size:40px; color:white; position: absolute;top: 40%;left: 5%;margin: -25px 0 0 -25px;"><span class="text-semibold"><b>Reporte Mensual Redes (Instagram)</b></span></h4>
                </div>
...
<script>
    function Consulta(){
        ...
        var url = "<?php echo site_url(); ?>Snappy/Reporte_Mensual_Instagram/";
    ...
    function Exportar(){
        ...
        window.location ="<?php echo site_url(); ?>Snappy/Excel_Reporte_Mensual_Instagram/"+id_empresa+"/"+nom_anio+"/"+id_mes;
    }
</script>