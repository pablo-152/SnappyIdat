    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-10">
                <input type="text" class="form-control" id="nom_tipo" name="nom_tipo" placeholder="Ingresar Tipo" autofocus onkeypress="if(event.keyCode == 13){ Insert_Tipo(); }">
            </div>
            ...
            <div class="form-group col-md-4">
                <input type="text" class="form-control" id="abr_tipo" name="abr_tipo" placeholder="Ingresar Abreviatura" autofocus onkeypress="if(event.keyCode == 13){ Insert_Tipo(); }">
            </div>
...
<script>
    function Insert_Tipo(){
        ...
        var url="<?php echo site_url(); ?>Snappy/Insert_Tipo";
