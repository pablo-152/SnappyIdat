<form id="from_foto" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title">Actualización del Tipo: <b><?php echo $get_id[0]['nom_tipo']; ?></b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-10">
                <input type="text" class="form-control" id="nom_tipo" name="nom_tipo" placeholder="Ingresar Tipo" value="<?php echo $get_id[0]['nom_tipo']; ?>" autofocus onkeypress="if(event.keyCode == 13){ Update_Tipo(); }">
            </div>

            <div class="form-group col-md-2">
                <label class="control-label text-bold">Abreviatura: </label>
            </div>
            <div class="form-group col-md-4">
                <input type="text" class="form-control" id="abr_tipo" name="abr_tipo" value="<?php echo $get_id[0]['abr_tipo']; ?>" placeholder="Ingresar Abreviatura" autofocus onkeypress="if(event.keyCode == 13){ Insert_Tipo(); }">
            </div>
...
<script>
    function Update_Tipo(){
        ...
        var url="<?php echo site_url(); ?>Snappy/Update_Tipo";
            ...
            $.ajax({
                ...
                success:function (data) {
                    swal.fire(
                        ...
                        window.location = "<?php echo site_url(); ?>Snappy/Tipo";
                    });
                }
            });          
        }
