            ...
            <tr class="even pointer text-center">
                ...
                <td>
                    ...
                    <?php if ($list['nom_estado'] == 'Pendiente') : ?>
                        <a title="Validar archivo" onclick="Validar_Archivo('<?= $list['id_detalle'] ?>' , '<?= $list['archivo']; ?>')">
                            <img src="<?= base_url() ?>template/img/check.png">
                        </a>
                        <a type="button" title="Rechazar Archivo" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('Administrador/Modal_Rechazar_Archivo/' . $list['id_detalle'] . '/' . $list['id_alumno'] . '/' . $tipo) ?>">
