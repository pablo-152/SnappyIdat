        ...
        <div class="row">
            <div class="x_panel">
                <div class="page-title" style="background-color: #C1C1C1;">
                    <h4 style="font-size:40px; color:white; position: absolute;top: 40%;left: 5%;margin: -25px 0 0 -25px;"><span class="text-semibold"><b>Aumento Capital</b></span></h4>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#aumento_capital").addClass('active');
