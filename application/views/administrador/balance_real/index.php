...
<div class="panel panel-flat">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="page-title" style="background-color: #C1C1C1;">
                    <h4 style="font-size:40px; color:white; position: absolute;top: 40%;left: 5%;margin: -25px 0 0 -25px;"><span class="text-semibold"><b>Balance Real (Lista)</b></span></h4>
                </div>

                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a onclick="Excel_Balance_Real();">
    ...
    <div class="container-fluid" style="margin-bottom:20px;">
        <div class="row">
            <div id="lista_balance_real" class="col-lg-12">
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $("#balances_reales").addClass('active');
    ...
    function Cambiar_Superior(){
        ...
        var url = "<?php echo site_url(); ?>Administrador/Cambiar_Superior_Balance_Real";
    ...
    function Cambiar_Empresa(empresa) {
        ...
        var anio = $('#anio_seleccionado').val();
        var url = "<?php echo site_url(); ?>Administrador/Cambiar_Balance_Real";
    ...
    function Excel_Balance_Real(){
        var empresa = $('#empresa_seleccionado').val();
        var anio = $('#anio_seleccionado').val();
        window.location = "<?php echo site_url(); ?>Administrador/Excel_Balance_Real/"+empresa+"/"+anio;
    }
</script>
