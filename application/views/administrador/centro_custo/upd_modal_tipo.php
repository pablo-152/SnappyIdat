<form id="from_foto" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title">Actualización del Centro Custo: <b><?php echo $get_id[0]['nom_ccr']; ?></b></h5>
    </div>
...
<script>
    function Update_Tipo(){
        ...
        var url="<?php echo site_url(); ?>Administrador/Update_Centro_Custo";
            ...
            $.ajax({
                ...
                success:function (data) {
                    swal.fire(
                        ...
                        window.location = "<?php echo site_url(); ?>Administrador/Centro_Custo";
                    });
                }
            });          
        }
