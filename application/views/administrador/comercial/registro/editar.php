  ...
  <div class="container-fluid">
    <form id="formulario_re" method="POST" enctype="multipart/form-data" class="formulario">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-default" href="<?= site_url('Administrador/Historial_Registro_Mail') ?>/<?php echo $get_id[0]['id_registro']; ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
      </div>
    </form>
  </div>
</div>
...
<script>
  ...
  function Update_Registro(){
    ...
    var dataString = new FormData(document.getElementById('formulario_re'));
    var url="<?php echo site_url(); ?>Administrador/Update_Registro_Mail";
    ...
    if (Valida_Registro_Mail()) {
      if(contacto1=="" && correo==""){
        var url2="<?php echo site_url(); ?>Administrador/Delete_Registro_Mail";
