            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    ...
                    <?php /*if($get_id[0]['id_evento']>0){ ?>
                      <a type="button" style="margin-right:5px;" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('Administrador/Modal_Historial_Registro_Mail_Evento') ?>/<?php echo $get_id[0]['id_registro']; ?>">  <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nueva Acción" />
                      </a>
                    <?php }else{*/ ?>
                      <a type="button" style="margin-right:5px;" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('Administrador/Modal_Historial_Registro_Mail') ?>/<?php echo $get_id[0]['id_registro']; ?>">  <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nueva Acción" />
                      </a>
                    <?php //} ?>

                    <a type="button" style="margin-right:5px;" href="<?= site_url('Administrador/Vista_Editar_Registro') ?>/<?php echo $get_id[0]['id_registro']; ?>">  <img src="<?= base_url() ?>template/img/editar_grande.png" alt="Nueva Acción" />
                    </a>
                    
                    <a type="button" href="<?= site_url('Administrador/Registro') ?>">
              ...
              <tr class="even pointer text-center">
                ...
                <?php //if($list['estado']!=57){ ?>
                  <?php if(($list['id_evento']>0) && ($id_nivel==1 || $id_nivel==6 || $id_nivel==7 || $id_nivel==9 || $id_nivel==12)){ ?>
                    <img title="Editar" data-toggle="modal" data-dismiss="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Administrador/Modal_Update_Historial_Registro_Mail_Evento') ?>/<?php echo $list['id_historial']; ?>/<?php echo $get_id[0]['id_registro']; ?>" src="<?= base_url() ?>template/img/editar.png" style="cursor:pointer; cursor: hand;width:22px;height:22px;" />
                  <?php }elseif($id_nivel==1 || $id_nivel==6 || $id_nivel==7 || $id_nivel==9){ ?>
                    <img title="Editar" data-toggle="modal" data-dismiss="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Administrador/Modal_Update_Historial_Registro_Mail') ?>/<?php echo $list['id_historial']; ?>/<?php echo $get_id[0]['id_registro']; ?>" src="<?= base_url() ?>template/img/editar.png" style="cursor:pointer; cursor: hand;width:22px;height:22px;" />
                  <?php } ?>
                <?php //} ?>
...
<script>
  function Delete_Historial_Mail(id,id_registro){
        ...
        var url="<?php echo site_url(); ?>Administrador/Delete_Historial_Mail";
        Swal({
