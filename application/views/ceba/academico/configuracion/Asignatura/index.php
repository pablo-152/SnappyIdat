            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo grado" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Ceba/Modal_Asignatura') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nueva Asignatura" />
                        </a>
                        <a href="<?= site_url('Ceba/Excel_Asignatura') ?>">
                        ...
                        <?php foreach($list_asignatura as $list) {  ?>                                           
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    app_crear_mod="<?= site_url('Ceba/Modal_Update_Asignatura') ?>/<?php echo $list['id_asignatura']; ?>" 
...
<script>
    ...
    function Delete_Asignatura(id){
        ...
        var url="<?php echo site_url(); ?>Ceba/Delete_Asignatura";
