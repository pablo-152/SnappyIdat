          ...
          <div class="heading-elements">
            <div class="heading-btn-group" >
                <?php if($get_id[0]['estado_cierre'] ==1){ ?>
                  ...
                  <a style="margin-right:5px;" onclick="Exportar();" style="cursor:pointer">
                    <img src="<?= base_url() ?>template/img/excel.png" alt="Exportar Excel" />
                  </a>
                <?php }else{ ?>
                    <a style="margin-right:5px;" type="button" title="Editar Curso" href="<?= site_url('Ceba/Modal_Update_Curso') ?>/<?php echo $get_id[0]['id_curso']; ?>">
                      <img class="top" src="<?= base_url() ?>template/img/editar_grande.png" alt="">
                    </a>
                    <a style="margin-right:5px;" type="button" title="Nuevo Requisito"  data-dismiss="modal" data-toggle="modal" data-target="#LargeLabelModal" LargeLabelModal="<?= site_url('Ceba/Modal_Requisito') ?>/<?php echo $get_id[0]['id_curso']; ?>">
                      <img class="top" src="<?= base_url() ?>template/img/ceba/crear_requisito.png" alt="">
                    </a>
                    <a style="margin-right:5px;" type="button" title="Asociar Tema"  data-dismiss="modal" data-toggle="modal" data-target="#LargeLabelModal" LargeLabelModal="<?= site_url('Ceba/Modal_Tema_Asociar') ?>/<?php echo $get_id[0]['id_curso']; ?>">
                    ...
                    <a style="margin-right:5px;" type="button" title="Regresar" href="<?= site_url('Ceba/Curso') ?>">
                      <img class="top" src="<?= base_url() ?>template/img/icono-regresar.png" alt="">
                    </a>
                      ...
                      <?php foreach($list_requisito_curso as $list) {  ?>
                          <tr class="even pointer text-center">
                            ...
                            <td>
                              ...
                              LargeLabelModal="<?= site_url('Ceba/Modal_Update_Requisito') ?>/<?php echo $list['id_requisito']; ?>" 
                            ...
                            <tbody>
                              <?php foreach($list_tema_asociar_curso as $list) {  ?>
                                  <tr class="even pointer text-center">
                                    ...
                                    <td>
                                      <img title="Editar Tema Asociar" data-toggle="modal"  data-dismiss="modal" data-target="#LargeLabelModal" 
                                          LargeLabelModal="<?= site_url('Ceba/Modal_Tema_Asociar_Editar') ?>/<?php echo $list['id_tema_asociar']; ?>" src="<?= base_url() ?>template/img/editar.png" 
                                          style="cursor:pointer; cursor: hand;width:22px;height:22px;" />
                                    </td>
                                  </tr>
                                <?php } ?>
...
<script>
  ...
  function Cerrar_Curso(id){
    ...
    var id = id;
    var url="<?php echo site_url(); ?>Ceba/Cerrar_Curso";
    var self = this;
