            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a style="margin-right:5px;" type="button" href="<?= site_url('Ceba/Detalles_Curso') ?>/<?php echo $get_id[0]['id_curso']; ?>">
    ...
    <div class="container-fluid">
        <form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-default" href="<?= site_url('Ceba/Detalles_Curso') ?>/<?php echo $get_id[0]['id_curso']; ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
            </div>
        </form>
    </div>
</div>
