            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a style="margin-right:5px;" type="button" href="<?= site_url('Ceba/Curso') ?>">
    ...
    <div id="curso_copiado" class="container-fluid">
        <form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-default" href="<?= site_url('Ceba/Curso') ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function Curso_Copiar(){
        ...
        var url="<?php echo site_url(); ?>Ceba/Curso_Copiar";
    ...
    function Insert_Curso(){
        ...
        var url="<?php echo site_url(); ?>Ceba/Insert_Curso";
