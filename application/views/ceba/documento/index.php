            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo Documento" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Ceba/Modal_Documento') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Exportar Excel" />
                        </a>

                        <a href="<?= site_url('Ceba/Excel_Documento') ?>">
...
<script>
    ...
    function Lista_Documento(){
        ...
        var url="<?php echo site_url(); ?>Ceba/Lista_Documento";
    ...
    function Delete_Documento(id){
        ...
        var url="<?php echo site_url(); ?>Ceba/Delete_Documento";
