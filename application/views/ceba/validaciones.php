...
function Delete_Alumno(id){
    var id = id;
    //alert(id);
    var url="<?php echo site_url(); ?>Ceba/Delete_Alumno";
    Swal({
            ...
            $.ajax({
                ...
                success:function () {
                    Swal(
                        ...
                        window.location = "<?php echo site_url(); ?>Ceba/Alumno";
                    });
                }
            });
        }
...
/*------------------------------*/
    ...
    function Insert_Slide(){
        ...
        var url="<?php echo site_url(); ?>Ceba/Valida_Insert_Slide";

        var dataString2 = new FormData(document.getElementById('formulario'));
        var url2="<?php echo site_url(); ?>Ceba/Insert_Slide";
        if (valida_slide()) {
            bootbox.confirm({
                                    ...
                                    $.ajax({
                                        ...
                                        success:function (data) {
                                            swal.fire(
                                                ...
                                                window.location = "<?php echo site_url(); ?>Ceba/Temas";
                                            });
                                        }
                                    });
                                }
    ...
    function Delete_Slide(id,id_tema){
            var id_tema = id_tema;
            var id = id;
            var url="<?php echo site_url(); ?>Ceba/Delete_Slide";
            Swal({
                title: '¿Realmente desea eliminar el registro',
                text: "El registro será eliminado permanentemente",
                type: 'warning',
                    ...
                    $.ajax({
                        ...
                        success:function () {
                            Swal(
                                ...
                                window.location = "<?php echo site_url(); ?>Ceba/Modal_Tema_View1/"+id_tema;
...
function Delete_Img_Slide(id,id_tema){
        var id_tema = id_tema;
        var id = id;
        var url="<?php echo site_url(); ?>Ceba/Delete_Img_Slide";
        Swal({
...
/*--------------REGISTRO INTRO--------*/
    function Insert_Intro(id_tema){
        ...
        var dataString = $("#formulario").serialize();
        var url="<?php echo site_url(); ?>Ceba/Valida_Insert_Intro";

        var dataString2 = new FormData(document.getElementById('formulario'));
        var url2="<?php echo site_url(); ?>Ceba/Insert_Intro_Index";
        if (valida_intro()) {
            bootbox.confirm({
                                    ...
                                    $.ajax({
                                        ...
                                        success:function (data) {
                                            swal.fire(
                                                ...
                                                if(id!="0"){
                                                    window.location = "<?php echo site_url(); ?>Ceba/Modal_Tema_View1/"+id;
                                                }else{
                                                    window.location = "<?php echo site_url(); ?>Ceba/Temas";
                                                }
                                            });
...
function valida_update_intro() {
    ...
    function Delete_Intro(id, id_tema){
        var id = id;
        var id_tema = id_tema;
        var url="<?php echo site_url(); ?>Ceba/Delete_Intro";
        Swal({
            title: '¿Realmente desea eliminar el registro',
            text: "El registro será eliminado permanentemente",
            type: 'warning',
    ...
    function Descargar_Img1_Intro(){
        ...
        window.location.replace("<?php echo site_url(); ?>Ceba/Descargar_Img_Intro/" + introduccion1 + "/" + foto_introduccion1);
    }
    ...
    function Descargar_Img2_Intro(){
        ...
        window.location.replace("<?php echo site_url(); ?>Ceba/Descargar_Img_Intro/" + introduccion2 + "/" + foto_introduccion2);
    }
    ...
    function Descargar_Img3_Intro(){
        ...
        window.location.replace("<?php echo site_url(); ?>Ceba/Descargar_Img_Intro/" + introduccion3 + "/" + foto_introduccion3);
    }
    ...
    function Insert_Repaso(){
        ...
        //alert("repaso");
        var dataString = $("#formulario").serialize();
        var url="<?php echo site_url(); ?>Ceba/Valida_Insert_Repaso";

        var dataString2 = new FormData(document.getElementById('formulario'));
        var url2="<?php echo site_url(); ?>Ceba/Insert_Repaso";
        if (valida_repaso()) {
            bootbox.confirm({
    ...
    function Delete_Repaso(id,id_tema){
            var id_tema = id_tema;
            var id = id;
            var url="<?php echo site_url(); ?>Ceba/Delete_Repaso";
            Swal({
                title: '¿Realmente desea eliminar el registro',
                text: "El registro será eliminado permanentemente",
                type: 'warning',
    ...
    function Delete_Img_Repaso(id,id_tema){
            var id_tema = id_tema;
            var id = id;
            var url="<?php echo site_url(); ?>Ceba/Delete_Img_Repaso";
            Swal({
    ...
    function Insert_Examen(){
        ...
        var dataString = $("#formulario").serialize();
        var url="<?php echo site_url(); ?>Ceba/Valida_Insert_Examen_Index";

        var dataString2 = new FormData(document.getElementById('formulario'));
        var url2="<?php echo site_url(); ?>Ceba/Insert_Examen";
        if (valida_examen()) {
            bootbox.confirm({
    ...
    function Insert_Examenv2(id_tema){
        ...
        var dataString = $("#formulario").serialize();
        var url="<?php echo site_url(); ?>Ceba/Valida_Insert_Examen_D";
        var id = id_tema;   
        var dataString2 = new FormData(document.getElementById('formulario'));
        var url2="<?php echo site_url(); ?>Ceba/Insert_Examen_Detalle";
        if (valida_examen()) {
            bootbox.confirm({
                title: "Registrar Pregunta para Examen",
                message: "¿Desea registrar pregunta para examen?",
    ...
    function Delete_Examen(id,id_tema){
            var id_tema = id_tema;
            var id = id;
            var url="<?php echo site_url(); ?>Ceba/Delete_Examen";
            Swal({
                title: '¿Realmente desea eliminar el registro',
                text: "El registro será eliminado permanentemente",
                type: 'warning',
    ...
    function Delete_Img_Examen(id,id_tema){
            var id_tema = id_tema;
            var id = id;
            var url="<?php echo site_url(); ?>Ceba/Delete_Img_Examen";
            Swal({
                title: '¿Realmente desea eliminar imágen del registro',
                text: "El archivo será eliminado permanentemente",
                type: 'warning',
    ...
    /*function Admision_Alumno(id) {
        var id = id;
        var url="<?php echo site_url(); ?>Ceba/Admision_Alumno";
        $.ajax({
            type:"POST",
            url:url,
            data: {'parametro':id},
    ...
    //alert(id);
    var url="<?php echo site_url(); ?>Ceba/Delete_Pago";
    Swal({
            ...
            $.ajax({
                ...
                success:function () {
                    Swal(
                        ...
                        window.location = "<?php echo site_url(); ?>Ceba/Detalles_Alumno/"+id_alumno;
                    });
                }
            });
        }
    ...
    function BuscadorIns(id) {
        ...
        var id = id;
        var url="<?php echo site_url(); ?>Ceba/BuscadorIns";
        $.ajax({
            type:"POST",
            url:url,
            data: {'parametro':id},
    ...
    function Actualizar_Observaciones(id){
        ...
        var url="<?php echo site_url(); ?>Ceba/Actualizar_Observaciones";
        var id=id;
        ...
        $.ajax({
            ...
            data:dataString,
            success:function(){
                window.location = "<?php echo site_url(); ?>Ceba/Detalles_Alumno/"+id;
            }
        });
    }
    ...
    function Insert_Mensaje(){
        var dataString = $("#formulario").serialize();
        var url="<?php echo site_url(); ?>Ceba/Insert_Mensaje";
        if (Valida_Mensaje()) {
            $.ajax({
                type:"POST",
                url:url,
                ...
                success:function () {
                    swal.fire(
                        ...
                        window.location = "<?php echo site_url(); ?>Ceba/Mensaje";
                    });
                }
            });
        }
    ...
    function Insert_Requisito_Matricula(){
        var dataString = $("#formulario").serialize();
        var url="<?php echo site_url(); ?>Ceba/Insert_Requisito_Matricula";
        if (Valida_Requisito()) {
            $.ajax({
                type:"POST",
                url:url,
                ...
                success:function () {
                    swal.fire(
                        ...
                        window.location = "<?php echo site_url(); ?>Ceba/Requisito";
                    });
                }
            });
        }else{
    ...
    function Actualizar_Requisito_Matricula(){
        ...
        var url="<?php echo site_url(); ?>Ceba/Update_Requisito_Matricula";
        if (Valida_Requisito()) {
            $.ajax({
                type:"POST",
                url:url,
    ...
    function Delete_Requisito_Matricula(id){
        var id = id;
        var url="<?php echo site_url(); ?>Ceba/Delete_Requisito_Matricula";
        Swal({
    ...
    function Matricular(id){
        ...
        var url="<?php echo site_url(); ?>Ceba/Registrar_Matricula";
        Swal({
                //title: '¿Realmente quieres eliminar el registro de '+ nombre +'?',
    ...
    function Realizar_Pago(id){
        var id_a=id;
        var dataString = new FormData(document.getElementById('from_pago'));
        var url="<?php echo site_url(); ?>Ceba/Update_Pago";
        if (valida_alumno()) {
            bootbox.confirm({
                title: "Actualizar Pago",
                message: "¿Desea actualizar información de Pago?",
                buttons: {
                    cancel: {
                        label: 'Cancelar'
                    },
                        ...
                        $.ajax({
                            ...
                            success:function (data) {
                                ...
                                Swal(
                                    ...
                                    window.location = "<?php echo site_url(); ?>Ceba/Detalles_Alumno/"+id_a;
                                    /*$('#div_pagos').html(data);
    ...
    function valida_alumno() {
        if($('#monto').val().trim() === '' || $('#monto').val()<1) {
            Swal(
                'Ups!',
                'Debe ingresar monto válido.',
                'warning'
            ).then(function() { });
            return false;
        }
        if($('#valida_fecha').val().trim() === '') {
            if($('#fec_pago').val().trim() === '') {
                Swal(
                    'Ups!',
                    'Debe ingresar Fecha de Pago.',
                    'warning'
                ).then(function() { });
                return false;
            }
    ...
    function Cargar_Historico_Biblioteca(){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url="<?php echo site_url(); ?>AppIFV/Cargar_Historico_Biblioteca";
        $.ajax({
            type:"POST",
            url:url,
            success:function (data) {
    ...
    function Guardar_Retiro(){
        ...
        var dataString = new FormData(document.getElementById('form-retiro'));
        var url="<?php echo site_url(); ?>AppIFV/Insert_Retiro_Alumno";
        if (valida_retiro()) {
            bootbox.confirm({
                title: "Registrar Retiro de Alumno",
                message: "¿Desea registrar retiro de alumno?",
                buttons: {
                    cancel: {
                        label: 'Cancelar'
                    },
