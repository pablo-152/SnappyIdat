            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo grado" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Ceba2/Modal_Area') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo area" />
                        </a>
                        <a href="<?= site_url('Ceba2/Excel_Area') ?>">
                        ...
                        <?php foreach($list_area as $list) {  ?>                                           
                            <tr class="even pointer text-center">
                                ...
                                <td>
                                    ...
                                    app_crear_mod="<?= site_url('Ceba2/Modal_Update_Area') ?>/<?php echo $list['id_area']; ?>" 
...
<script>
    ...
    function Delete_Area_Ceba(id){
        ...
        var url="<?php echo site_url(); ?>Ceba2/Delete_Area";
