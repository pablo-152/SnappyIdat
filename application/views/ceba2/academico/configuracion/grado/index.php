            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo grado" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Ceba2/Modal_Grado') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo Grado" />
                        </a>
                        <a href="<?= site_url('Ceba2/Excel_Grado') ?>">
                        ...
                        <?php foreach($list_grado as $list) {  ?>                                           
                            <tr class="even pointer text-center">
                                ...
                                <td>
                                    ...
                                    app_crear_mod="<?= site_url('Ceba2/Modal_Update_Grado') ?>/<?php echo $list["id_grado"]; ?>" 
...
<script>
    ...
    function Delete_Grado(id){
        ...
        var url="<?php echo site_url(); ?>Ceba2/Delete_Grado";
