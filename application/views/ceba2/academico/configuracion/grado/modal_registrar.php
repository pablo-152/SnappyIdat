<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Grado (Nuevo)</b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-10">
                <input type="text" class="form-control" id="descripcion_grado_i" name="descripcion_grado_i" placeholder="Ingresar Descripción" autofocus>
            </div>
            ...
            <div class="form-group col-md-4">
                <select class="form-control" name="id_status_i" id="id_status_i">
...
<script>
    function Insert_Grado(){
        ...
        var url="<?php echo site_url(); ?>Ceba2/Insert_Grado";
    ...
    function Valida_Insert_Grado() {
        if($('#descripcion_grado_i').val().trim() === '') {
            Swal(
                'Ups!',
