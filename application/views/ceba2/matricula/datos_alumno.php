<div class="col-md-12 row">
    ...
    <div class="form-group col-md-1">
        ...
        <div class="col">
            <input type="text" class="form-control solo_numeros" id="edad_alum" name="edad_alum" placeholder="Ingresar Edad" readonly value="<?php echo $get_id[0]['edad_alum']; ?>">
        </div>
    </div>
...
<div class="col-md-12 row">
    <div class="form-group col-md-2">
        ...
        <div class="col">
            <input type="text" class="form-control solo_numeros" id="celular_alum" name="celular_alum" maxlength="9" placeholder="Ingresar Celular" value="<?php echo $get_id[0]['celular_alum']; ?>">
        </div>
    </div>
    ...
    <div class="form-group col-md-2">
        ...
        <div class="col">
            <input type="text" class="form-control solo_numeros" id="telf_casa_alum" name="telf_casa_alum" maxlength="9" placeholder="Ingresar Teléfono Casa" value="<?php echo $get_id[0]['telf_casa_alum']; ?>">
        </div>
    </div>
    ...
    <div class="form-group col-md-2">
        ...
        <div class="col">
            <input type="text" class="form-control" id="correo_personal_alum" name="correo_personal_alum" placeholder="Ingresar Correo Personal" value="<?php echo $get_id[0]['correo_personal_alum']; ?>">
        </div>
    </div>
...
<div class="col-md-12 row">
    <div class="form-group col-md-3">
        ...
        <div class="col">
            <input type="text" class="form-control" id="inst_procedencia" name="inst_procedencia" placeholder="Inst. Procedencia" value="<?php echo $get_id[0]['inst_procedencia']; ?>">
        </div>
    </div>
    ...
    <div class="form-group col-md-2">
        ...
        <div class="col">
            <select class="form-control" id="id_departamento_inst_alum" name="id_departamento_inst_alum" onchange="Provincia_Inst_Alum();">
                <option value="0">Seleccione</option>
                <?php foreach($list_departamento as $list){ ?>
                    <option value="<?php echo $list['id_departamento']; ?>" <?php if($list['id_departamento']==$get_id[0]['id_departamento_inst_alum']){ echo "selected"; } ?>>
                        <?php echo $list['nombre_departamento']; ?>
                    </option>
                <?php } ?>
            </select>
    ...
    <div class="form-group col-md-2">
        ...
        <div id="minstprovincia" class="col">
            <select class="form-control" id="id_provincia_inst_alum" name="id_provincia_inst_alum" onchange="Distrito_Inst_Alum();">
                <option value="0">Seleccione</option>
                <?php foreach($list_provincia_inst_alum as $list){ ?>
                    <option value="<?php echo $list['id_provincia']; ?>" <?php if($list['id_provincia']==$get_id[0]['id_provincia_inst_alum']){ echo "selected"; } ?>>
                        <?php echo $list['nombre_provincia']; ?>
                    </option>
                <?php } ?>
            </select>
    ...
    <div class="form-group col-md-2">
        ...
        <div id="minstdistrito" class="col">
            <select class="form-control" id="id_distrito_inst_alum" name="id_distrito_inst_alum">
                <option value="0">Seleccione</option>
                <?php foreach($list_distrito_inst_alum as $list){ ?>
                    <option value="<?php echo $list['id_distrito']; ?>" <?php if($list['id_distrito']==$get_id[0]['id_distrito_inst_alum']){ echo "selected"; } ?>>
                        <?php echo $list['nombre_distrito']; ?>
                    </option>
                <?php } ?>
            </select>
