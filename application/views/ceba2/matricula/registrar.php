...
<div class="panel panel-flat">
            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('Ceba2/Matricula') ?>">
    ...
    <input type="hidden" id="cantidad_datos_alumno" value="<?php echo count($datos_alumno); ?>">
    <input type="hidden" id="cantidad_datos_documento" value="<?php echo count($datos_documento); ?>">
    <input type="hidden" id="cantidad_datos_matricula" value="<?php echo count($datos_matricula); ?>">
</div>
...
<form id="formulario" method="POST" enctype="multipart/form-data" class="formulario">
            ...
            <div id="div_datos_personales" class="content-group-lg">
                <div class="col-md-12 row">
                    ...
                    <div class="form-group col-md-1">
                        ...
                        <div class="col">
                            <input type="text" class="form-control solo_numeros" id="edad_alum" name="edad_alum" placeholder="Ingresar Edad" readonly>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <select class="form-control" id="id_departamento_alum" name="id_departamento_alum" onchange="Provincia_Alum();">
                                ...
                                <?php foreach($list_departamento as $list){ ?>
                                    <option value="<?php echo $list['id_departamento']; ?>"  <?php if($list['id_departamento']=='11'){ echo "selected"; } ?>>
                        ...
                        <div id="mprovincia" class="col">
                            <select class="form-control" id="id_provincia_alum" name="id_provincia_alum" onchange="Distrito_Alum();">
                                ...
                                <?php foreach($list_provincia as $list){ ?>
                                    <option value="<?php echo $list['id_provincia']; ?>" <?php if($list['id_provincia']=='1102'){ echo "selected"; } ?>>
                ...
                <div class="col-md-12 row">
                    <div class="form-group col-md-2">
                        ...
                        <div class="col">
                            <input type="text" class="form-control solo_numeros" id="celular_alum" name="celular_alum" maxlength="9" placeholder="Ingresar Celular">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="col">
                            <input type="text" class="form-control solo_numeros" id="telf_casa_alum" name="telf_casa_alum" maxlength="9" placeholder="Ingresar Teléfono Casa">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="correo_personal_alum" name="correo_personal_alum" placeholder="Ingresar Correo Personal">
                        </div>
                    </div>
                ...
                <div class="col-md-12 row">
                    <div class="form-group col-md-3">
                        <label class="control-label text-bold">Inst. Procedencia:</label>
                        <div class="col">
                            <input type="text" class="form-control" id="inst_procedencia" name="inst_procedencia" placeholder="Inst. Procedencia">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        <label class="control-label text-bold">Departamento:</label>
                        <div class="col">
                            <select class="form-control" id="id_departamento_inst_alum" name="id_departamento_inst_alum" onchange="Provincia_Inst_Alum();">
                                <option value="0">Seleccione</option>
                                <?php foreach($list_departamento as $list){ ?>
                                    <option value="<?php echo $list['id_departamento']; ?>" <?php if($list['id_departamento']=='11'){ echo "selected"; } ?>>
                                        <?php echo $list['nombre_departamento']; ?>
                    ...
                    <div class="form-group col-md-2">
                        <label class="text-bold">Provincia:</label>
                        <div id="minstprovincia" class="col">
                            <select class="form-control" id="id_provincia_inst_alum" name="id_provincia_inst_alum" onchange="Distrito_Inst_Alum();">
                                <option value="0">Seleccione</option>
                                <?php foreach($list_provincia as $list){ ?>
                                    <option value="<?php echo $list['id_provincia']; ?>" <?php if($list['id_provincia']=='1102'){ echo "selected"; } ?>>
                                        <?php echo $list['nombre_provincia']; ?>
                    ...
                    <div class="form-group col-md-2">
                        <label class="text-bold">Distrito:</label>
                        <div id="minstdistrito" class="col">
                            <select class="form-control" id="id_distrito_inst_alum" name="id_distrito_inst_alum">
                                <option value="0">Seleccione</option>
                            </select>
                        </div>
                    </div>
    ...
    <div class="panel panel-flat panel-collapsed">
        <div class="panel-heading">
            ...
            <?php if(count($datos_documento)>0){ if($datos_documento[0]['doc_iden_alumno']!=""){ ?>
                <div class="heading-elements">
                    <ul class="icons-list">
                        <li><a data-action="collapse"></a></li>
                    </ul>
...
<script>
    $(document).ready(function() {
        ...
        if($("#cantidad_datos_alumno").val()>0){
            Traer_Datos_Alumno();
            Traer_Datos_Tutor();
            Traer_Datos_Informacion();
        }

        if($("#cantidad_datos_documento").val()>0){
            Traer_Datos_Documento();
        }

        if($("#cantidad_datos_matricula").val()>0){
    ...
    function Provincia_Alum(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Busca_Provincia";
    ...
    function Distrito_Alum(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Busca_Distrito";
        var id_departamento = $('#id_departamento_alum').val();
    ...
    function Provincia_Inst_Alum(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Busca_Provincia";
        var id_departamento = $('#id_departamento_inst_alum').val();
        var tipo = 2;
        ...
        $.ajax({
            ...
            data: {'id_departamento':id_departamento,'tipo':tipo},
            success: function(data){
                $('#minstprovincia').html(data);
                $('#minstdistrito').html('<select class="form-control" id="id_distrito_inst_alum" name="id_distrito_inst_alum"><option value="0">Seleccione</option></select>');
            }
        });
    }

    function Distrito_Inst_Alum(){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Busca_Distrito";
        var id_departamento = $('#id_departamento_inst_alum').val();
        var id_provincia = $('#id_provincia_inst_alum').val();
        var tipo = 2;
    ...
    function Traer_Provincia_Prin(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Provincia";
        var id_departamento = $('#id_departamento_alum').val();
        var id_provincia = $('#id_provincia_alum').val();
        var tipo = 1;
    ...
    function Traer_Distrito_Prin(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Distrito";
        var id_departamento = $('#id_departamento_alum').val();
        var id_provincia = $('#id_provincia_alum').val();
        var id_distrito = $('#id_distrito_alum').val();
        var tipo = 1;
    ...
    function Validar_Extension_Dni_Alumno(){
        var archivoInput = document.getElementById('doc_iden_alumno');
    ...
    function Validar_Extension_Certificado_Estudio(){
        var archivoInput = document.getElementById('certificado_estudio');
        var archivoRuta = archivoInput.value;
        var extPermitidas = /(.jpeg|.png|.jpg|.pdf)$/i;
    ...
    function Validar_Extension_Foto(){
    ...
    function Validar_Extension_Dni_Apoderado(){
        var archivoInput = document.getElementById('doc_iden_apoderado');
        var archivoRuta = archivoInput.value;
        var extPermitidas = /(.jpeg|.png|.jpg|.pdf)$/i;
    ...
    function Insert_Datos_Alumno(){
        ...
        var url="<?php echo site_url(); ?>Ceba2/Insert_Datos_Alumno";
            ...
            $.ajax({
                ...
                success:function (data) {
                    swal.fire(
                        ...
                        //Traer_Datos_Alumno();
                        window.location = "<?php echo site_url(); ?>Ceba2/Modal_Matricula";
                    });
                }
            });       
        }
    ...
    function Update_Datos_Alumno(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Update_Datos_Alumno";
    ...
    function Traer_Datos_Alumno(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Datos_Alumno";
    ...
    function Insert_Datos_Tutor(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Insert_Datos_Tutor";
    ...
    function Update_Datos_Tutor(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Update_Datos_Tutor";
    ...
    function Traer_Datos_Tutor(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Datos_Tutor";
    ...
    function Insert_Datos_Informacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Insert_Datos_Informacion";
    ...
    function Update_Datos_Informacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Update_Datos_Informacion";
    ...
    function Traer_Datos_Informacion(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Datos_Informacion";
    ...
    function Insert_Datos_Documento(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Insert_Datos_Documento";
    ...
    function Update_Datos_Documento(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Update_Datos_Documento";
    ...
    function Valida_Datos_Documento() {
        if($('#doc_iden_alumno').val().trim() === '') {
            Swal(
                'Ups!',
                'Debe ingresar Documento DNI del Alumno.',
                'warning'
            ).then(function() { });
            return false;
        }
    ...
    function Traer_Datos_Documento(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Datos_Documento";
    ...
    function Descargar_Archivo_Documento(orden){
        window.location.replace("<?php echo site_url(); ?>Ceba2/Descargar_Archivo_Documento/"+orden);
    }
    ...
    function Insert_Datos_Matricula(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Insert_Datos_Matricula";
    ...
    function Update_Datos_Matricula(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Update_Datos_Matricula";
    ...
    function Traer_Datos_Matricula(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Datos_Matricula";
    ...
    function Insert_Datos_Confirmacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Insert_Datos_Confirmacion";
    ...
    function Update_Datos_Confirmacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Update_Datos_Confirmacion";
    ...
    function Traer_Datos_Confirmacion(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Traer_Datos_Confirmacion";
    ...
    function Descargar_Archivo_Matricula(orden){
        window.location.replace("<?php echo site_url(); ?>Ceba2/Descargar_Archivo_Matricula/"+orden);
    }
    ...
    function Enviar_Sms(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Enviar_Sms";
    ...
    function Pdf_Hoja_Matricula(){
        ...
        var url = "<?php echo site_url(); ?>Ceba2/Valida_Pdf_Hoja_Matricula";
        ...
        $.ajax({
            ...
            success: function(resp){
                if(resp=="error"){
                    ...
                    window.open('<?php echo site_url(); ?>Ceba2/Pdf_Hoja_Matricula', '_blank');
                }
            }
        });
    }
    ...
    function Insert_Matricula(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>Ceba2/Insert_Matricula";
                ...
                success:function (data) {
                    if(data=="alumno"){
                        ...
                        swal.fire(
                            ...
                            window.location = "<?php echo site_url(); ?>Ceba2/Matricula";
                        });
                    }
                }
            });       
    ...
    function Validar_Insert_Matricula() {
        /*if($('#dni_alumno').val().trim() === '') {
            Swal(
                'Ups!',
                'Debe ingresar DNI de Alumno.',
                'warning'
            ).then(function() { });
            return false;
        }*/
