...
<div class="panel-heading" >
    <div class="row">
        <div class="col-md-12" class="collapse" id="collapseExample">
            <div class="tile">
                <h3 class="tile-title line-head" style="color:black">Edición de Datos del Proyecto con <b>Código <?php echo $get_id[0]['cod_proyecto'];?></b></h3>
                ...
                <div class="tile-body" >
                    <form id="from_proy" method="POST" enctype="multipart/form-data" class="formulario">
                        ...
                        <div class="box-footer">
                            ...
                            <a type="button" href="<?= site_url('Diseniador/proyectos') ?>" class="btn btn-default">Cancelar</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success:function (data) {
                    swal.fire(
                        ...
                        window.location = "<?php echo site_url(); ?>Diseniador/proyectos";
                    });
                }
            });
        }
