<form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Asignacion Familiar (Editar) </b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
            ...
            <div class="form-group col-lg-4">
                <select name="id_empresae" id="id_empresae" class="form-control" onchange="Traer_Sede_Rrhhe();">
                    ...
                    <?php foreach($list_empresa as $list){ ?>
                        ...
                        <?php if($list['id_empresa']==$as_familiar[0]['id_empresa']){ echo "selected"; } ?>>
                            <?= $list['cod_empresa']; ?>
                        </option>
                    <?php } ?>
                </select>
            ...
            <div class="form-group col-lg-4">
                <select name="id_sedee" id="id_sedee" class="form-control" onchange="Traer_Tipo_Contrato_Rrhhe();">
                    ...
                    <?php foreach($list_sede as $list){ ?>
                        ...
                        <?php if($list['id_sede']==$as_familiar[0]['id_sede']){ echo "selected"; } ?>>
                            <?= $list['cod_sede']; ?>
                        </option>
                    <?php } ?>
                </select>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-4">
                <select class="form-control" name="id_tipo_contratoe" id="id_tipo_contratoe">
                    ...
                    <?php foreach($list_tipo_contrato as $list){ ?>
                        ...
                        <?php if($list['id']==$as_familiar[0]['id_tipo_contrato']){ echo "selected"; } ?>>
                            <?= $list['nombre']; ?>
                        </option>
                    <?php } ?>
                </select>
            ...
            <div class="form-group col-lg-4">
                <input type="text" class="form-control" name="codigoe" id="codigoe" placeholder="Ingresar Código" value="<?= $as_familiar[0]['codigo']; ?>">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-4">
                <input type="text" class="form-control" name="tipoe" id="tipoe" placeholder="Ingresar Tipo" value="<?= $as_familiar[0]['tipo']; ?>">
            </div>
            ...
            <div class="form-group col-lg-4">
                <input type="text" class="form-control" name="subtipoe" id="subtipoe" placeholder="Ingresar Sub-Tipo" value="<?= $as_familiar[0]['subtipo']; ?>">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-9">
                <input type="text" class="form-control" id="nombre_e" name="nombre_e" value="<?= $as_familiar[0]['nombre']?>" placeholder="Ingresar Nombre">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-9">
                <select class="form-control tipo-descuento-select" name="tipo_descuento_e" id="tipo_descuento_e">
                    <option value="0">Seleccione</option>
                    <option value="1" <?php if ($as_familiar[0]['tipo_descuento'] == 1) echo "selected"; ?>>%</option>
                    <option value="2" <?php if ($as_familiar[0]['tipo_descuento'] == 2) echo "selected"; ?>>Fijo</option>
                </select>
            </div>  	 
        </div>
        ...
        <div class="row">
            ...
            <input type="text"
                ...
                <span class="monto-simbolo" style="position: absolute; left: 30px; top: 9px;">
                    <?php echo ($as_familiar[0]['tipo_descuento'] == 1) ? "%" : "S/."; ?>
                </span>
            </div>   
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-4">
                <select class="form-control" name="id_estado_e" id="id_estado_e">
                        ...
                        <option value="<?php echo $item['id_status']; ?>" <?php if($item['id_status']==$as_familiar[0]['estado']){ echo "selected"; } ?>>
    ...
    <div class="modal-footer">
        <input type="hidden" id="id_as_familiar_e" name="id_as_familiar_e" value="<?= $as_familiar[0]['id']?>">
        <button type="button" class="btn btn-primary" onclick="Update_AsFamiliar_RRHH();">
...
<script>
    ...
    $(document).ready(function() {
        activateEnterKeyForFunction(Update_AsFamiliar_RRHH);
    });

    function Update_AsFamiliar_RRHH(){
        Cargando();

        var dataString = new FormData(document.getElementById('formulario_update'));
        var url="<?php echo site_url(); ?>General/Update_AsFamiliar_RRHH";

        if (Valida_Update_AsFamiliar_RRHH()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
    ...
    function Valida_Update_AsFamiliar_RRHH() {
