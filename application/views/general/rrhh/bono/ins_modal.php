<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario" >
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Bono (Nuevo) </b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-9">
                <select class="form-control" name="tipo_bono" id="tipo_bono">
                    <option value="0">Seleccione</option>
    ...
    <div class="modal-footer" >
        <button type="button" class="btn btn-primary" onclick="Insert_Bono_RRHH();">
...
<script>
    ...
    $(document).ready(function() {
        activateEnterKeyForFunction(Insert_Bono_RRHH);
    });

    function Insert_Bono_RRHH(){
        Cargando();

        var dataString = new FormData(document.getElementById('formulario_insert'));
        var url="<?php echo site_url(); ?>General/Insert_Bono_RRHH";

        if (Valida_Insert_Bono_RRHH()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
    ...
    function Valida_Insert_Bono_RRHH() {
