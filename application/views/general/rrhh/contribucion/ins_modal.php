<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Contribucion (Nuevo) </b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-9">
                <select class="form-control" name="tipo_contribucion" id="tipo_contribucion">
                    <option value="0">Seleccione</option>
                    <option value="1">AFP Aporte</option>
                    <option value="2">Prima de Seguro</option>
                    <option value="3">AFP Comisión</option>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="Insert_Contribucion_RRHH();">
...
<script>
    ...
    $(document).ready(function() {
        activateEnterKeyForFunction(Insert_Contribucion_RRHH);
    });   

    function Insert_Contribucion_RRHH(){
        Cargando();

        var dataString = new FormData(document.getElementById('formulario_insert'));
        var url="<?php echo site_url(); ?>General/Insert_Contribucion_RRHH";

        if (Valida_Insert_Contribucion_RRHH()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
    ...
    function Valida_Insert_Contribucion_RRHH() {
        ...
        if($('#tipo_contribucion').val().trim() === '0') {
            Swal(
                'Ups!',
