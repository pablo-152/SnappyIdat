<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Falta (Nueva) </b></h5>
    </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="Insert_Falta_RRHH();">
...
<script>
    ...
    $(document).ready(function() {
        activateEnterKeyForFunction(Insert_Falta_RRHH);
    });

    function Insert_Falta_RRHH(){
        Cargando();

        var dataString = new FormData(document.getElementById('formulario_insert'));
        var url="<?php echo site_url(); ?>General/Insert_Falta_RRHH";

        if (Valida_Insert_Falta_RRHH()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
    ...
    function Valida_Insert_Falta_RRHH() {
