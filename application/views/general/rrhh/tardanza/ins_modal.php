<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Tardanza (Nuevo) </b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-9">
                <select class="form-control" name="tipo_tardanza" id="tipo_tardanza">
                    <option value="0">Seleccione</option>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="Insert_Tardanza();">
...
<script>
    ...
    $(document).ready(function() {
        activateEnterKeyForFunction(Insert_Tardanza);
    });

    function Insert_Tardanza(){
        Cargando();

        var dataString = new FormData(document.getElementById('formulario_insert'));
        var url="<?php echo site_url(); ?>General/Insert_Tardanza_RRHH";

        if (Valida_Insert_Tardanza()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
    ...
    function Valida_Insert_Tardanza() {
