  ...
  <form id="from_proy" method="POST" enctype="multipart/form-data">
    ...
    <div class="container-fluid">
        ...
        <?php if($_SESSION['usuario'][0]['id_nivel']==1 || $_SESSION['usuario'][0]['id_nivel']==2 || $_SESSION['usuario'][0]['id_nivel']==4 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
            ...
            <div class="form-group col-md-12" id="divcopye" <?php if($get_id[0]['id_tipo']==15 || $get_id[0]['id_tipo']==20 || $get_id[0]['id_tipo']==34){echo "style='display:block'"; }else{ echo "style='display:none'"; } ?>>
    ...
    <div class="modal-footer">
      ...
      <!--<a href=""></a><button type="button" class="btn btn-default" data-dismiss="modal"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</button>-->
...
<script>
  ...
  function proyecto() {
    ...
    if($('#imagen_actual').val()==''){
      if($('#status').val()==5 && $('#foto').val()==""){
        Swal(
          'Ups!',
          'Debe ingresar Imagen.',
          'warning'
        ).then(function() {});
        return false;
      }
