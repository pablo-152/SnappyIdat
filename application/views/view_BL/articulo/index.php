            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        ...
                        app_crear_per="<?= site_url('BabyLeaders/Modal_Articulo') ?>">
...
<script>
    ...
    function Lista_Articulo(tipo){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Articulo";
    ...
    function Delete_Articulo(id){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Delete_Articulo";
    ...
    function Excel_Articulo(){ 
        var tipo_excel = $("#tipo_excel").val();
        window.location = "<?php echo site_url(); ?>BabyLeaders/Excel_Articulo/"+tipo_excel;
    }
</script>
