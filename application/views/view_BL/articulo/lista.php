    ...
    <tbody>
        <?php foreach($list_articulo as $list) {  ?>                                           
            <tr class="even pointer text-center">
                ...
                <td>
                    <img title="Editar Datos" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('BabyLeaders/Modal_Update_Articulo') ?>/<?php echo $list['id_articulo']; ?>" src="<?= base_url() ?>template/img/editar.png" style="cursor:pointer; cursor: hand;">
