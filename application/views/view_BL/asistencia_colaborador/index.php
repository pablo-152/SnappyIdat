...
<script>
    ...
    function Lista_Asistencia(tipo){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Asistencia_Colaborador_Lista";
    ...
    function Excel_Asistencia_Colaborador(){
        ...
        window.location = "<?php echo site_url(); ?>BabyLeaders/Excel_Asistencia_Colaborador/"+fec_in+"/"+fec_fi;
    }
    ...
    function Delete_Asistencia_Colaborador(id){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Delete_Registro_Ingreso_Lista";
