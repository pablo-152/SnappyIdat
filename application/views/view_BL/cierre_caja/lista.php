<table class="table table-hover table-bordered table-striped" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;"> 
            ...
            <th class="text-center" width="10%">Saldo Automático</th>
            <th class="text-center" width="8%">Monto Ent.</th>  
            <th class="text-center" width="7%">Productos</th>
            <th class="text-center" width="8%">Dif.</th> 
        ...
        <?php foreach($list_cierre_caja as $list){ ?>                                                
            <tr class="even pointer text-center" <?php if($list['cerrada']==0 && $list['estado']==2){ echo "style='background-color:#E2F0D9;'"; } ?>>
                ...
                <td>
                    ...
                    $_SESSION['usuario'][0]['id_usuario']==85 || $_SESSION['usuario'][0]['id_usuario']==135 || 
                    $_SESSION['usuario'][0]['id_usuario']==245 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                        <a title="Más Información" href="<?= site_url('BabyLeaders/Detalle_Cierre_Caja') ?>/<?php echo $list['id_cierre_caja']; ?>">
                            <img src="<?= base_url() ?>template/img/ver.png"/>
                        </a>
                    <?php } ?>

                    <a title="Documento" href="<?= site_url('BabyLeaders/Pdf_Cierre_Caja') ?>/<?php echo $list['id_cierre_caja']; ?>" target="_blank">
