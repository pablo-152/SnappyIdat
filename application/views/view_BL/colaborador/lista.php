    ...
    <tbody >
        <?php foreach($list_colaborador as $list){ ?>                                             
            <tr class="even pointer text-center">
                ...
                <td><?php echo $list['ft']; ?></td>
                <td>
                    <a title="Editar" href="<?= site_url('BabyLeaders/Editar_Colaborador') ?>/<?php echo $list['id_colaborador']; ?>">
                        <img src="<?= base_url() ?>template/img/editar.png">
                    </a>

                    <a title="Más Información" href="<?= site_url('BabyLeaders/Detalle_Colaborador') ?>/<?php echo $list['id_colaborador']; ?>">
