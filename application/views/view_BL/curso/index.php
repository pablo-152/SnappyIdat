            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo Curso" style="cursor:pointer;margin-right:5px;" href="<?= site_url('BabyLeaders/Modal_Curso') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo Curso" />
                        </a>
                        <a href="<?= site_url('BabyLeaders/Excel_Curso') ?>">
...
<script>
    ...
    function Lista_Curso(){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Curso";
