            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nueva Recaudación" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('BabyLeaders/Modal_Exportacion_Bbva') ?>">
...
<script>
    ...
    function Lista_Exportacion_Bbva(){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Exportacion_Bbva";
    ...
    function Generar_Txt(id){    
        window.location = "<?php echo site_url(); ?>BabyLeaders/Generar_Txt/"+id;
    }
</script>
