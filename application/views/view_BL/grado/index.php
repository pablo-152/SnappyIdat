            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo grado" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('BabyLeaders/Modal_Grado') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo Grado" />
                        </a>
                        <a href="<?= site_url('BabyLeaders/Excel_Grado') ?>">
...
<script>
    ...
    function Lista_Grado(){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Grado";
    ...
    function Delete_Grado(id){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Delete_Grado";
