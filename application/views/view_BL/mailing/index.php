            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        ...
                        app_crear_per="<?= site_url('BabyLeaders/Modal_Mailing') ?>" 
                        style="cursor:pointer;margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/nuevo.png">
                        </a>

                        <a href="<?= site_url('BabyLeaders/Excel_Mailing') ?>">
...
<script>
    ...
    function Lista_Mailing(){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Mailing";
    ...
    function Actualizar_Lista_Mailing(id){ 
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Actualizar_Lista_Mailing";
    ...
    function Delete_Mailing(id){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Delete_Mailing";
    ...
    function Descargar_Mailing(id){
        window.location.replace("<?php echo site_url(); ?>BabyLeaders/Descargar_Mailing/"+id); 
    }
</script>
