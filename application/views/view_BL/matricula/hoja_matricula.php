...
<html>
    ...
    <style type="text/css"  media="all">
        *{
        ...
        #contenido{
          ...
          width: 21cm;
          height: 29.7cm;
          background-image: url('template/img/Fondo_BL.png');
    ...
    <div id="contenido">
      ...
      <table class="primera_tabla" width="100%">
        ...
        <tbody>
          <tr>
            ...
            <td><span class="span_secundario"><?php echo $get_matricula[0]['nom_grado']; ?></span></td>
            ...
            <td><span class="span_secundario">BL1</span></td>
          </tr>
        </tbody>
      </table>
      ...
      <table class="segunda_tabla" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="span_secundario"><?php echo $diff->y; ?></span></td>
          ...
          <tr>
            ...
            <td colspan="7"><span class="span_secundario"><?php echo $get_id[0]['dis_alum']; ?></span></td>
          ...
          <tr>
            <td class="derecha"><span class="span_principal">Correo Corporativo:</span></td>
            <td colspan="7"><span class="span_secundario"><?php echo $get_id[0]['correo_corporativo']; ?></span></td>
          </tr>
          <!--<tr>
      ...
      <?php if($get_id[0]['n_doc_secu	']!=""){ ?>
        <table class="cuarta_tabla" width="100%">
          <thead>
            <tr>
              <th width="24%"></th>
              <th width="20%"></th>
          ...
          <tbody>
            <tr>
              <td class="derecha"><span class="span_principal">Parentesto:</span></td>
              <td colspan="5"><span class="span_secundario"><?php echo $get_id[0]['nom_parentesco_secu']; ?></span></td>
            </tr>
            <tr>
              <td class="derecha"><span class="span_principal">Nombre:</span></td>
              <td colspan="5"><span class="span_secundario"><?php echo $get_id[0]['nom_principal_secu']; ?></span></td>
            </tr>
            <tr>
              <td class="derecha"><span class="span_principal">Direccion:</span></td>
              <td colspan="5"><span class="span_secundario"><?php echo $get_id[0]['direccion_secu']; ?></span></td>
            </tr>
            <tr>
              <td class="derecha"><span class="span_principal">Distrito:</span></td>
              <td><span class="span_secundario"><?php echo $get_id[0]['dis_secu']; ?></span></td>
              <td class="derecha"><span class="span_principal">Telf. Casa:</span></td>
              <td><span class="span_secundario"><?php echo $get_id[0]['telf_casa_secu']; ?></span></td>
              <td class="derecha"><span class="span_principal">Celular:</span></td>
              <td><span class="span_secundario"><?php echo $get_id[0]['celular_secu']; ?></span></td>
            </tr>
            <tr>
              <td class="derecha"><span class="span_principal">Centro de Trabajo:</span></td>
              <td colspan="2"><span class="span_secundario"><?php echo $get_id[0]['centro_empleo_secu']; ?></span></td>
              <td class="derecha"><span class="span_principal">Ocupacion:</span></td>
              <td colspan="2"><span class="span_secundario"><?php echo $get_id[0]['ocupacion_secu']; ?></span></td>
            </tr>
            <tr>
              <td class="derecha"><span class="span_principal">Correo Electronico:</span></td>
              <td colspan="5"><span class="span_secundario"><?php echo $get_id[0]['correo_personal_secu']; ?></span></td>
            </tr>
          </tbody>
        </table>
      <?php } ?>
