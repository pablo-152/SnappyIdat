            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo grado" style="cursor:pointer;margin-right:5px;" href="<?= site_url('BabyLeaders/Modal_Matricula') ?>">
...
<script>
    ...
    function Lista_Matricula(parametro){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Matricula";
    ...
    function Excel_Matricula(){
        ...
        window.location ="<?php echo site_url(); ?>BabyLeaders/Excel_Matricula/"+parametro;
    }
</script>
</script>
