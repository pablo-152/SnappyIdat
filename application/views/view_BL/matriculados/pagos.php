        ...
        <div class="x_panel">
          ...
          <div class="heading-elements">
            <div class="heading-btn-group">
                <a type="button" href="<?= site_url('BabyLeaders/Matriculados') ?>">
...
<script>
    ...
    function Lista_Pagos(estado){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Pago_Matriculados";
    ...
    function Excel_Pago_Matriculados(){
        ...
        window.location ="<?php echo site_url(); ?>BabyLeaders/Excel_Pago_Matriculados/"+id_alumno+"/"+estado;
    }
</script>
