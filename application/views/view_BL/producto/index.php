            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        ...
                        app_crear_per="<?= site_url('BabyLeaders/Modal_Producto') ?>">
...
<script>
    ...
    function Lista_Producto(tipo){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Lista_Producto";
    ...
    function Delete_Producto(id){
        ...
        var url="<?php echo site_url(); ?>BabyLeaders/Delete_Producto";
    ...
    function Excel_Producto(){ 
        var tipo_excel = $("#tipo_excel").val();
        window.location = "<?php echo site_url(); ?>BabyLeaders/Excel_Producto/"+tipo_excel;
    }
</script>
