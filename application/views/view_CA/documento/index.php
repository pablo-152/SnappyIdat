                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <?php if($_SESSION['usuario'][0]['id_nivel']!=13){ ?>
                            <a title="Nuevo Documento" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" 
                                app_crear_per="<?= site_url('Ca/Modal_Documento') ?>">
                                <img src="<?= base_url() ?>template/img/nuevo.png" alt="Exportar Excel" />
                            </a>
                        <?php } ?>
                        <a href="<?= site_url('Ca/Excel_Documento') ?>">
...
<script>
    $(document).ready(function() {
        $("#documento").addClass('active');
        $("#hdocumento").attr('aria-expanded','true');
        $("#listas").addClass('active');
		document.getElementById("rdocumento").style.display = "block";
    ...
    function Lista_Documento(){
        ...
        var url="<?php echo site_url(); ?>Ca/Lista_Documento";
    ...
    function Delete_Documento(id){
        ...
        var url="<?php echo site_url(); ?>Ca/Delete_Documento";
