...
<div class="panel panel-flat">
            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        ...
                        app_crear_per="<?= site_url('Ca/Modal_Subrubro') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Exportar Excel" />
                        </a>
                        
                        <a href="<?= site_url('Ca/Excel_Subrubro') ?>">
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="lista_subrubro" class="col-lg-12">
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $("#configcont").addClass('active');
        $("#hconfigcont").attr('aria-expanded', 'true');
        $("#subrubros").addClass('active');
        document.getElementById("rconfigcont").style.display = "block";

        Lista_Subrubro();
    });

    function Lista_Subrubro(){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url="<?php echo site_url(); ?>Ca/Lista_Subrubro";

        $.ajax({
            type:"POST",
            url:url,
            success:function (resp) {
                $('#lista_subrubro').html(resp);
            }
        });
    }
    ...
    function Delete_Subrubro(id){
        ...
        var url="<?php echo site_url(); ?>Ca/Delete_Subrubro";
