                ...
                <div class="heading-elements"> 
                    <div class="heading-btn-group">
                        <?php if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                            ...
                            app_crear_mod="<?= site_url('CursosCortos/Modal_Update_Cierre_Caja') ?>/<?php echo $get_id[0]['id_cierre_caja']; ?>"> 
                                <img title="Editar" style="margin-right:5px;cursor:pointer;"  src="<?= base_url() ?>template/img/editar_grande.png" alt="">
                            </a>
                        <?php } ?>

                        <a type="button" href="<?= site_url('CursosCortos/Cierre_Caja') ?>">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-3">
                    <input type="text" class="form-control" disabled value="<?php echo 'FV1'; ?>">
                </div>
            </div> 
            ...
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-3"> 
                    <input type="text" class="form-control" disabled value="<?php echo '(FV) Chincha'; ?>">
                </div>
            </div> 
...
<script>
    ...
    function Lista_Detalle_Cierre_Caja(){
        ...
        var fecha = $("#fecha").val();
        var url="<?php echo site_url(); ?>CursosCortos/Lista_Detalle_Cierre_Caja";
