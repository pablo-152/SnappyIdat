            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="<?= site_url('CursosCortos/Excel_Cliente') ?>">
                ...
                <table class="table table-hover table-bordered table-striped" id="example" width="100%">
                    <thead>
                        <tr style="background-color: #E5E5E5;">
                            <th class="text-center" width="12%">DNI</th>
                            ...
                            <th class="text-center" width="14%">Teléfono Casa</th>
                    ...
                    <tbody>
                        <?php foreach($list_cliente as $list) {  ?>                                           
                            <tr class="even pointer text-center">
                                <td><?php echo $list['n_documento']; ?></td>
                                ...
                                <td><?php echo ""; ?></td>   
                                <td class="text-left"><?php echo $list['nombre_distrito']; ?></td>                                                       
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
