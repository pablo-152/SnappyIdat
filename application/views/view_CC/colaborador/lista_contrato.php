    ...
    <tbody >
        <?php foreach($list_contrato as $list){ ?>                                            
            <tr class="even pointer text-center">
                ...
                <td>
                    <a title="Editar" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('CursosCortos/Modal_Update_Contrato_Colaborador') ?>/<?php echo $list['id_contrato']; ?>">
