...
<?php }else{ ?> 
    <form method="post" id="formulario_excel" enctype="multipart/form-data" class="formulario">
        ...
        <div class="heading-btn-group">
            ...
            <a class="form-group btn" href="<?= site_url('CursosCortos/Excel_Vacio_Comercial') ?>" title="Estructura de Excel">
            ...
            <tbody>
                <?php foreach($list_registro as $list) {?>
                    <tr class="even pointer" <?php if($list['duplicado']==1){ echo 'style="background-color:'."#FBE5D6".'"'; } ?>>
                        ...
                        <a title="Más Información" href="<?= site_url('CursosCortos/Historial_Registro_Mail') ?>/<?php echo $list['id_registro']; ?>">
