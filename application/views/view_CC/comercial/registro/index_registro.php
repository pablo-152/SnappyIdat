        ...
        <div class="x_panel">
          ...
          <div class="heading-elements">
            <div class="heading-btn-group">
              <?php if($_SESSION['usuario'][0]['id_nivel']==15){ ?>
                <a type="button" href="<?= site_url('CursosCortos/Vista_Registro_Mail_Secretaria') ?>" title="Nuevo"><img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo Proyecto"></a>

                <a href="<?= site_url('CursosCortos/Excel_Dep_Comercial_Secretaria') ?>" style="margin-left:5px;">
                  <img src="<?= base_url() ?>template/img/excel.png" alt="Exportar Excel" />
                </a>
              <?php }else{ ?>
                <a title="Actualizar Datos" onclick="Actualizar_Datos_Comercial();" style="cursor:pointer;margin-right:0px;margin-left:5px;">
                  <img src="<?= base_url() ?>template/img/actualizar_datos.png" alt="Actualizar Datos">
                </a>

                <a style="cursor:pointer;margin-right:5px;margin-left:5px;" type="button" href="<?= site_url('CursosCortos/Vista_Registro_Mail') ?>" title="Nuevo"><img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo Proyecto"></a>
                
                <!--<a style="cursor:pointer;margin-left:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('CursosCortos/Modal_Registro_Mail_Mailing') ?>">
...
<script>
  /*function Cargar_Cabecera(){
      ...
      var url = "<?php echo site_url(); ?>CursosCortos/Cargar_Cabecera";
  ...
  function Buscar(parametro){
      ...
      if(parametro==2){
        var url = "<?php echo site_url(); ?>CursosCortos/Busqueda_Registro";
  ...
  function Actualizar_Datos_Comercial(){ 
      ...
      var url = "<?php echo site_url(); ?>CursosCortos/Actualizar_Datos_Comercial";
  ...
  function Duplicar(){
    ...
    if(contador==1){
      ...
      var url = "<?php echo site_url(); ?>CursosCortos/Duplicar_Registro";
  ...
  function Importar_Comercial() {
    ...
    var url="<?php echo site_url(); ?>CursosCortos/Validar_Importar_Comercial";
    var url2="<?php echo site_url(); ?>CursosCortos/Importar_Comercial";
    //var url3 = "<?php echo site_url(); ?>CursosCortos/Importar_Comercial_Sin_Validaciones"
  ...
  function Excel_Dep_Comercial(){
      ...
      var anio = $('#anio_busqueda').val();
      window.location = "<?php echo site_url(); ?>CursosCortos/Excel_Dep_Comercial/"+tipo_excel+"/"+anio;
  }
</script>
