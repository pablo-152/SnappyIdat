  ...
  <div class="container-fluid">
    <form id="formulario_r"  method="POST" enctype="multipart/form-data" class="formulario">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-default" href="<?= site_url('CursosCortos/Registro') ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
      </div>
    </form>
  </div>
</div>
...
<script>
  ...
  function Producto_Interese(id_empresa,id_sede){
  ...
  function Insert_Registro(){
    ...
    var dataString = new FormData(document.getElementById('formulario_r'));
    var url="<?php echo site_url(); ?>CursosCortos/Insert_Registro_Mail";
