...
<div class="panel panel-flat">
    ...
    <div class="container-fluid">
        ...
        <div class="modal-footer">
            ...
            <a type="button" class="btn btn-default" href="<?= site_url('CursosCortos/Detalle_Curso') ?>/<?php echo $get_id[0]['id_curso']; ?>">
...
<script>
    ...
    function Asignar_Seccion(){ 
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Asignar_Seccion";
        ...
        if (Valida_Asignar_Seccion()) {
            $.ajax({
                ...
                success:function (data) {
                    window.location = "<?php echo site_url(); ?>CursosCortos/Detalle_Curso/"+id_curso;
                }
            });
        }
    }
