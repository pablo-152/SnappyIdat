                ...
                <div class="heading-elements">
                    <div class="heading-btn-group" >
                        <?php if($get_id[0]['estado_cierre']==1){ ?>
                            ...
                            <a href="<?= site_url('CursosCortos/Curso') ?>">
                                <img class="top" src="<?= base_url() ?>template/img/icono-regresar.png">
                            </a>
                        <?php }else{ ?>
                            <a style="margin-right:5px;" title="Editar Curso" href="<?= site_url('CursosCortos/Modal_Update_Curso') ?>/<?php echo $get_id[0]['id_curso']; ?>">
                                <img class="top" src="<?= base_url() ?>template/img/editar_grande.png">
                            </a>

                            <a title="Asignar Sección" href="<?= site_url('CursosCortos/Vista_Asignar_Seccion') ?>/<?php echo $get_id[0]['id_curso']; ?>" style="margin-right:5px;">
                                <img class="top" src="<?= base_url() ?>template/img/asignar_seccion.png">
                            </a>

                            <a title="Nuevo Requisito" data-toggle="modal" data-target="#acceso_modal" 
                                app_crear_per="<?= site_url('CursosCortos/Modal_Requisito') ?>/<?php echo $get_id[0]['id_curso']; ?>" style="margin-right:5px;">
                                <img class="top" src="<?= base_url() ?>template/img/ceba/crear_requisito.png">
                            </a>
                            ...
                            <a title="Regresar" href="<?= site_url('CursosCortos/Curso') ?>">
                                <img class="top" src="<?= base_url() ?>template/img/icono-regresar.png">
                            </a>
                        <?php } ?>
                    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="datos_cambiantes" class="col-md-12 row">
                ...
                <div class="form-group col-md-1">
                    <label class="col-sm-3 control-label text-bold margintop">Curso:</label> 
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="tab-panels">
                    ...
                    <section id="rauchbier2" class="tab-panel">
                        <div class="box-body table-responsive">
                            ...
                            app_crear_eli="<?= site_url('CursosCortos/Modal_Alumno_Curso') ?>/<?php echo $get_id[0]['id_curso']; ?>">
...
<script>
    ...
    function Lista_Seccion(){
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Lista_Seccion_Curso";
    ...
    function Lista_Requisito(){
        ...
        var id_curso = $("#id_curso").val();
        var url="<?php echo site_url(); ?>CursosCortos/Lista_Requisito_Curso";
    ...
    function Lista_Alumno(){
        ...
        var id_curso = $("#id_curso").val();
        var url="<?php echo site_url(); ?>CursosCortos/Lista_Alumno_Curso";
    ...
    function Cerrar_Curso(id,nombre){
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Cerrar_Curso";
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if(data=="error"){
                            ...
                            window.location = "<?php echo site_url(); ?>CursosCortos/Detalle_Curso/"+id;
                            });
                        }
                    }
                });
