    ...
    <tbody >
        <?php foreach($list_grado as $list){ ?>                                           
            <tr class="even pointer text-center">
                ...
                <td>
                    <img title="Editar Datos Curso" data-toggle="modal" data-target="#acceso_modal_mod" 
                    app_crear_mod="<?= site_url('CursosCortos/Modal_Update_Grado') ?>/<?php echo $list["id_grado"]; ?>" 
