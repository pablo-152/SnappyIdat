...
<div class="panel panel-flat">
            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo grado" style="cursor:pointer;margin-right:5px;" href="<?= site_url('CursosCortos/Modal_Matricula') ?>">
    ...
    <div class="container-fluid">
        <div class="heading-btn-group">
            <a onclick="Lista_Matricula(1);" id="matriculados_boton" style="color:#ffffff;background-color:#00C000;" class="form-group btn clase_boton"><span>Matriculados</span><i class="icon-arrow-down52"></i></a>
            <a onclick="Lista_Matricula(2);" id="todos_boton" style="color:#000000; background-color:#0070c0;" class="form-group btn clase_boton"><span>Todos</span><i class="icon-arrow-down52"></i> </a>
...
<script>
    ...
    function Lista_Matricula(parametro){
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Lista_Matricula";
        ...
        var matriculados = document.getElementById('matriculados_boton');
        var todos = document.getElementById('todos_boton');
    ...
    function Excel_Matricula(){
        ...
        window.location ="<?php echo site_url(); ?>CursosCortos/Excel_Matricula/"+parametro;
    }
</script>
</script>
