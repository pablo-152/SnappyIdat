            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('CursosCortos/Matricula') ?>">
...
<script>
    ...
    function Provincia_Alum(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Busca_Provincia";
    ...
    function Distrito_Alum(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Busca_Distrito";
        var id_departamento = $('#id_departamento_alum').val();
    ...
    function Traer_Provincia_Prin(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Provincia";
        var id_departamento = $('#id_departamento_alum').val();
        var id_provincia = $('#id_provincia_alum').val();
        var tipo = 1;
    ...
    function Traer_Distrito_Prin(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Distrito";
        var id_departamento = $('#id_departamento_alum').val();
        var id_provincia = $('#id_provincia_alum').val();
        var id_distrito = $('#id_distrito_alum').val();
        var tipo = 1;
    ...
    function Traer_Producto(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Producto";
    ...
    function Insert_Datos_Alumno(){
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Datos_Alumno";
            ...
            $.ajax({
                ...
                success:function (data) {
                    swal.fire(
                        ...
                        //Traer_Datos_Alumno();
                        window.location = "<?php echo site_url(); ?>CursosCortos/Modal_Matricula";
                    });
                }
            });       
        }
    ...
    function Update_Datos_Alumno(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Update_Datos_Alumno";
    ...
    function Traer_Datos_Alumno(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Datos_Alumno";
    ...
    function Insert_Datos_Tutor(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Datos_Tutor";
    ...
    function Update_Datos_Tutor(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Update_Datos_Tutor";
    ...
    function Traer_Datos_Tutor(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Datos_Tutor";
    ...
    function Insert_Datos_Informacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Datos_Informacion";
    ...
    function Update_Datos_Informacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Update_Datos_Informacion";
    ...
    function Traer_Datos_Informacion(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Datos_Informacion";
    ...
    function Insert_Datos_Documento(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Datos_Documento";
    ...
    function Update_Datos_Documento(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Update_Datos_Documento";
    ...
    function Traer_Datos_Documento(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Datos_Documento";
    ...
    function Descargar_Archivo_Documento(id_documento){
        window.location.replace("<?php echo site_url(); ?>CursosCortos/Descargar_Archivo_Documento/"+id_documento);
    }
    ...
    function Insert_Datos_Matricula(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Datos_Matricula";
    ...
    function Update_Datos_Matricula(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Update_Datos_Matricula";
    ...
    function Traer_Datos_Matricula(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Datos_Matricula";
    ...
    function Insert_Datos_Confirmacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Datos_Confirmacion";
    ...
    function Update_Datos_Confirmacion(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Update_Datos_Confirmacion";
    ...
    function Traer_Datos_Confirmacion(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Traer_Datos_Confirmacion";
    ...
    function Descargar_Archivo_Matricula(orden){
        window.location.replace("<?php echo site_url(); ?>CursosCortos/Descargar_Archivo_Matricula/"+orden);
    }
    ...
    function Enviar_Sms(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Enviar_Sms";
    ...
    function Pdf_Hoja_Matricula(){
        ...
        var url = "<?php echo site_url(); ?>CursosCortos/Valida_Pdf_Hoja_Matricula";
        ...
        $.ajax({
            ...
            success: function(resp){
                if(resp=="error"){
                    ...
                    window.open('<?php echo site_url(); ?>CursosCortos/Pdf_Hoja_Matricula', '_blank');
                }
            }
        });
    }
    ...
    function Insert_Matricula(){
        ...
        var dataString = new FormData(document.getElementById('formulario'));
        var url="<?php echo site_url(); ?>CursosCortos/Insert_Matricula";
                ...
                success:function (data) {
                    if(data=="alumno"){
                        ...
                        swal.fire(
                            ...
                            window.location = "<?php echo site_url(); ?>CursosCortos/Matricula";
                        });
                    }
                }
            });       
