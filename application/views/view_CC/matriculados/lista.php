    ...
    <tbody>
        <?php foreach ($list_alumno as $list) { 
            ...
            <tr class="even pointer text-center">
                ...
                <td>
                    <a title="Pagos" href="<?= site_url('CursosCortos/Pago_Matriculados') ?>/<?php echo $list['Id']; ?>">
                        <img title="Pagos" src="<?= base_url() ?>template/img/ver.png" style="cursor:pointer;"/>
                    </a>
                </td>
                <td>
                    <a title="Más Información" href="<?= site_url('CursosCortos/Detalle_Matriculados') ?>/<?php echo $list['Id']; ?>">
