...
<div class="panel panel-flat">
            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        ...
                        app_crear_per="<?= site_url('CursosCortos/Modal_Producto') ?>">
    ...
    <div class="container-fluid">
        <div class="heading-btn-group">
            <a onclick="Lista_Producto(1);" id="btn_activos" style="color: #ffffff;background-color: #00C000;height: 32px;width: 150px;padding: 5px;" class="form-group btn"><span>Activos</span><i class="icon-arrow-down52"></i></a>
            <a onclick="Lista_Producto(2);" id="btn_todos" style="color: #000000; background-color: #0070C0;height: 32px;width: 150px;padding: 5px;" class="form-group btn"><span>Todos</span><i class="icon-arrow-down52"></i></a>
...
<script>
    ...
    function Lista_Producto(tipo){
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Lista_Producto";
    ...
    function Delete_Producto(id){
        ...
        var url="<?php echo site_url(); ?>CursosCortos/Delete_Producto";
    ...
    function Excel_Producto(){ 
        var tipo_excel = $("#tipo_excel").val();
        window.location = "<?php echo site_url(); ?>CursosCortos/Excel_Producto/"+tipo_excel;
    }
</script>
