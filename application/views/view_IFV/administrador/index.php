   ...
   <?php $this->load->view('view_IFV/header'); ?>
    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
      ...
      <link href="<?=base_url() ?>template/css/boton.css" rel="stylesheet" type="text/css">
        ...
        <input type="hidden" id="" name="" value="<?php echo $fondo_ifv[0]['estado']; ?>">
        <div class="row" >
        <div class="col-md-12" class="collapse" id="collapseExample" align="center">
        <div class="row">
          <div class="col-md-12" class="collapse" id="collapseExample" align="center">
          <?php if(count($fondo_ifv)>0){ ?>
            <div class="row">
              <div class="col-12 blog-details">
                <div class="blog-details-img">
                  <img class="img-fluid" src="<?=base_url().$fondo_ifv[0]['foto']; ?>" alt="Intro" width="600" height="600">
