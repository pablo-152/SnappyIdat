<table class="table">
    <thead>
        <tr>
            ...
            <th class="color">Nombre(s)</th>
            <th class="color" title="Especialidad">Esp.</th>
            <th class="color">Grupo</th>
            <th class="color">Módulo</th>
    ...
    <tbody>
        <?php foreach($list_registro_ingreso as $list){ ?> 
            <tr>
                ...
                <td <?php if($list['nom_tipo_acceso']=="Colaborador"){ ?> style="background-color:#C8C8C8;" <?php } ?>><?php echo $list['abreviatura']; ?></td>
                <td <?php if($list['nom_tipo_acceso']=="Colaborador"){ ?> style="background-color:#C8C8C8;" <?php } ?>><?php echo $list['grupo']; ?></td>
                <td <?php if($list['nom_tipo_acceso']=="Colaborador"){ ?> style="background-color:#C8C8C8;" <?php } ?>><?php echo $list['modulo']; ?></td>
                ...
                <td <?php if($list['nom_tipo_acceso']=="Colaborador"){ ?> style="background-color:#C8C8C8;" <?php } ?>>
                    <a title="Eliminar" data-toggle="modal" data-target="#modal_contrasena" app_contrasena="<?= site_url('AppIFV/Modal_Delete_Registro_Ingreso') ?>/<?php echo $list['id_registro_ingreso']; ?>">
