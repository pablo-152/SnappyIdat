...
<div id="modal_contrasena" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog">
            ...
            <div class="modal-body" style="max-height:520px; overflow:auto;">
                <div class="col-md-12 row">
                    ...
                    <div class="modal-footer text-center">
                        ...
                        <img src="<?= base_url() ?>template/img/iconslupa.png" style="position: absolute;left: 20px;bottom: 15px; width: 5%;" data-toggle="modal" data-target="#modal_ver2" app_crear_ver="<?= site_url('AppIFV/Lista_Historico')?>">
                        -->
...
<script>
    ...
    $("#modal_contrasena").on("show.bs.modal", function(e) {
        var link = $(e.relatedTarget);
        $(this).find(".modal-content").load(link.attr("app_contrasena"));
    });
        ...
        <div class="contenedor-datos">
            <div class="contenedor-busqueda">
                <div class="contenedor-busqueda-input">
                    <input type="text" class="text" id="codigo_alumno" name="codigo_alumno" onkeypress="if(event.keyCode == 13){ Insert_Alumno_FV(); }">
                    <?php if($_SESSION['usuario'][0]['id_usuario']==7 || $_SESSION['usuario'][0]['id_usuario']==10 || $_SESSION['usuario'][0]['id_usuario']==76 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                        <!--<a class="contenedor-busqueda-lupa" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('AppIFV/Modal_Registro_Ingreso') ?>">
                            <img src="<?= base_url() ?>template/img/lupa.png" class="contenedor-busqueda-lupa-img"></img>
                        </a>-->

                        <a class="contenedor-busqueda-lupa" data-toggle="modal" data-target="#modal_contrasena" app_contrasena="<?= site_url('AppIFV/Modal_Valida_Registro_Manual') ?>">
                            <img src="<?= base_url() ?>template/img/lupa.png" class="contenedor-busqueda-lupa-img"></img>
                        </a>
                    <?php }else{ ?>
...
<script>
    $(document).ready(function() {
        ...
        $("#registros_asistencias").addClass('active');
	...
	function Lista_Registro_Ingreso(){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Lista_Registro_Ingreso";
    ...
    function Botones_Bajos(){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Botones_Bajos";
	...
	function Insert_Alumno_FV(){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Insert_Alumno_FV";
        var url2 = "<?php echo site_url(); ?>AppIFV/ReInsert_Alumno_FV";
        var url3 = "<?php echo site_url(); ?>AppIFV/Update_Alumno_FV";
    ...
    function Insert_Observacion(){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Insert_Observacion";
    ...
    $("#modal_contrasena").on("hidden.bs.modal", function () {
        $('#clave_admin').val('');
    }); 
    ...
    function Autorizacion_Condicionado(){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Autorizacion_Condicionado";
    ...
    function No_Ingresa_Condicionado(){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/No_Ingresa_Condicionado";
        var observacion = $('#observacion_condicionado').val();
        var codigo_alumno = $("#cod_alum").val();
...
<script>
    ...
    function abrirmodal2(){
        var url = "<?php echo site_url(); ?>AppIFV/Lista_Historico";
        var codigo_alumno = $("#cod_alum").val();
...
<script>
    ...
    function Limpiar_Select_Alumno(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Limpiar_Select_Alumno";
