...
<div class="contenedor-mostrar-datos">
    <div class="contenedor-mostrar-inputs">
        ...
        <div class="text3"><label>&nbsp;&nbsp;<b>Modulo:</b> <?php echo $get_id[0]['Modulo']; ?></label><div style="width: 50%; text-align:end;"> <img src="<?= base_url() ?>template/img/iconslupa.png" style="width: 20%;" data-toggle="modal" data-target="#modal_ver2" app_crear_ver="<?= site_url('AppIFV/Lista_Historico')?>/<?php echo $get_id[0]['Codigo']; ?>"></div></div>
        ...
        <div class="text5">
            <?php if($get_id[0]['Tipo']==1){ ?>
                ...
                <?php if($get_id[0]['Fotocheck']>0){ ?>
                    <label class="descrip" style="color:#5a485b;">&nbsp;&nbsp;Pago Fotocheck Efectuado</label>
                <?php }else{ ?>
                    <label class="descrip" style="color:#5a485b;">&nbsp;&nbsp;Pendiente Pago Fotocheck</label>
                <?php } ?>
