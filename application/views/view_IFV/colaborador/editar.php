            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group"> 
                        <a type="button" href="<?= site_url('AppIFV/Detalle_Colaborador/') ?><?php echo $get_id[0]['id_colaborador'] ?>">
        ...
        <form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control solo_numeros" id="dni" name="dni" placeholder="DNI" maxlength="12" value="<?php echo $get_id[0]['dni']; ?>">
                </div>
            </div>
            ...
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="date" class="form-control" id="fec_nacimiento" name="fec_nacimiento" value="<?php echo $get_id[0]['fec_nacimiento']; ?>">
                </div>
            </div>
            ...
            <div class="col-md-12 row">
                <div class="form-group col-md-1">
                    <label class="control-label text-bold">Cód&nbsp;GLL: </label>
            ...
            <div class="col-md-12 row"> 
                ...
                <div class="form-group col-md-1">
                    ...
                    <div>
                        <label for=""><?php echo $get_id[0]['codigo_glla']; ?></label>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-default" href="<?= site_url('AppIFV/Detalle_Colaborador/') ?><?php echo $get_id[0]['id_colaborador'] ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function Traer_Provincia_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Traer_Provincia_Colaborador";
    ...
    function Traer_Distrito_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Traer_Distrito_Colaborador";
    ...
    function Update_Colaborador() {
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Update_Colaborador";
