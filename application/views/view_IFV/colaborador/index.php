            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo" type="button" href="<?= site_url('AppIFV/Registrar_Colaborador') ?>">
...
<script>
    ...
    function Lista_Colaborador(tipo){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Lista_Colaborador";
    ...
    function Delete_Colaborador(id){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Delete_Colaborador";
    ...
    function Excel_Colaborador(){ 
        Cargando();
        var tipo_excel = $("#tipo_excel").val();
        window.location = "<?php echo site_url(); ?>AppIFV/Excel_Colaborador/"+tipo_excel;
    }
</script>
