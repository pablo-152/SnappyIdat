<form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
        ...
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <select name="id_perfil_u" id="id_perfil_u" class="form-control">
                    ...
                    <option value="<?php echo $list['id_perfil'] ?>" <?php if($get_id[0]['id_perfil']==$list['id_perfil']){echo "selected";}?>><?php echo $list['nom_perfil'] ?></option>    
                    <?php }?>
                </select>
            </div>
            ...
            <div class="form-group col-md-4">
                <select name="id_tipo_contrato1_u" id="id_tipo_contrato1_u" class="form-control">
                    ...
                    <option value="<?php echo $list['id'] ?>" <?php if($get_id[0]['id_tipo_contrato1']==$list['id']){echo "selected";}?>><?php echo $list['nombre'] ?></option>    
                    <?php }?>
                </select>
            </div>
            ...
            <div class="form-group col-md-4">
                <select name="id_tipo_contrato2_u" id="id_tipo_contrato2_u" class="form-control">
                    <option value="0">Seleccione</option>
                    <?php foreach($list_tipo_contrato as $list){?> 
                        <option value="<?php echo $list['id'] ?>" <?php if($get_id[0]['id_tipo_contrato2']==$list['id']){echo "selected";}?>><?php echo $list['nombre'] ?></option>    
                    <?php }?>
                </select>
            </div>
         ...
         <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <select name="estado_contrato_u" id="estado_contrato_u" class="form-control">
                    ...
                    <option value="<?php echo $list['id_status'] ?>" <?php if($get_id[0]['estado_contrato']==$list['id_status']){echo "selected";}?>><?php echo $list['nom_status'] ?></option>    
                    <?php }?>
                </select>
            </div>
        </div>  		           	                	        
    ...
    <div class="modal-footer">
        ...
        <input type="hidden" id="id_colaborador_u" name="id_colaborador_u" value="<?php echo $get_id[0]['id_colaborador']; ?>">
...
<script>
    ...
    function Update_Contrato_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Update_Contrato_Colaborador";
