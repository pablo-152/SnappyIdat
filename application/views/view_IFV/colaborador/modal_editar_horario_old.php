    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <select name="id_contrato_u" id="id_contrato_u" class="form-control">
                    <option value="0">Seleccione</option>
                    <?php foreach($list_contrato as $list){?>
                    <option value="<?php echo $list['id_contrato'] ?>" <?php if($get_detalle[0]['id_contrato']==$list['id_contrato']){echo "selected";}?>><?php echo $list['referencia'] ?></option>    
                    <?php }?>
                </select>
            </div>
...
<script>
    ...
    function Update_Horario() {
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Insert_Horario_Colaborador/2";
