    ...
    <div class="container-fluid"> 
        <form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-default" href="<?= site_url('AppIFV/Colaborador') ?>"><i class="glyphicon glyphicon-remove-sign"></i>Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function Insert_Colaborador() {
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Insert_Colaborador";
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data=="error"){
                        ...
                        window.location = "<?php echo site_url(); ?>AppIFV/Colaborador";
                    }
                }
            });
        }
