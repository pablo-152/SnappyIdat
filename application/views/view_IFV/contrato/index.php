...
<script>
    ...
    function Lista_Contrato(tipo){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Lista_Contrato";
    ...
    function Actualizar_Lista_Contrato(id){  
        ...
        var url="<?php echo site_url(); ?>AppIFV/Actualizar_Lista_Contrato";
    ...
    function Reenviar_Email(id){ 
        ...
        var tipo_excel=$('#tipo_excel').val();
        var url="<?php echo site_url(); ?>AppIFV/Reenviar_Email";
    ...
    function Excel_Contrato() {
        var tipo_excel=$('#tipo_excel').val();
        window.location = "<?php echo site_url(); ?>AppIFV/Excel_Contrato/"+tipo_excel;
    }
</script>
