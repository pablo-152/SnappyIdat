<table id="example" class="table table-hover table-bordered table-striped" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th width="18%" class="text-center">Especialidad</th> 
            <th width="4%" class="text-center">Edad</th> 
            ...
            <th width="12%" class="text-center" title="Documentos">Doc.</th>
            <th class="text-center" title="Declaración Jurada">Dec.Jur.</th>
            <th class="text-center" title="Declaración Jurada">D41.</th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($list_alumno as $list){ ?>
            <tr class="even pointer text-center">
                ...
                <td class="text-center"><?php echo $list['edad'] ?></td>
