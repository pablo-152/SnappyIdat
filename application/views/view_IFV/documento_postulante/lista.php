    ...
    <tbody>
        <?php foreach($list_documento_postulante as $list){ ?>                                           
            <tr class="even pointer text-center">
                ...
                <td><?php echo $list['nom_confgen']; ?></td>   
                <td nowrap>
                    <a title="Editar Datos" data-toggle="modal" data-target="#acceso_modal_mod" 
                    app_crear_mod="<?= site_url('AppIFV/Modal_Update_Documento_Postulante') ?>/<?php echo $list['id_documento']; ?>">
                        <img src="<?= base_url() ?>template/img/editar.png">
                    </a>
                    <a href="#" class="" title="Eliminar" onclick="Delete_Documento_Postulante('<?php echo $list['id_documento']; ?>')" role="button">
