...
<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <h5 class="modal-title"><b>Documento Postulante (Nuevo)</b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <input type="text" class="form-control" id="departamento_i" name="departamento_i" placeholder="Departamento" maxlength="100">
            </div>
            ...
            <div class="form-group col-md-6">
                <input type="checkbox" class="grande_check" id="aparece_doc_i" name="aparece_doc_i" value="1">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="Insert_Documento_Postulante()">
...
<script>
    function Insert_Documento_Postulante(){
        Cargando();

        var dataString = new FormData(document.getElementById('formulario_insert'));
        var url="<?php echo site_url(); ?>AppIFV/Insert_Documento_Postulante";

        if (Valida_Insert_Documento_Postulante()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
    ...
    function Valida_Insert_Documento_Postulante() {
