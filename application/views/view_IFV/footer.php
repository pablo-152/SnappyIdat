	...
	<!-- NOUISLIDER -->
	<script src="<?php echo base_url(); ?>template/plugins/noUiSlider/nouislider.min.js"></script>
	<script src="<?php echo base_url(); ?>template/plugins/noUiSlider/custom-nouiSlider.js"></script>
</body>
</html>