<form method="post" id="formulario_web_insertar" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h5 class="modal-title"><b>Imagen Web (Nueva)</b></h5>
    </div>
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-6">
                <input maxlength="25" type="text" class="form-control" id="refe_comuimg" name="refe_comuimg" placeholder="Ingresar Referencia" autofocus>
            </div>
        </div>
        ...
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <input type="date" class="form-control" id="inicio_comuimg" name="inicio_comuimg" autofocus>
            </div>
            ...
            <div class="form-group col-md-4">
                <input type="date" class="form-control" id="fin_comuimg" name="fin_comuimg" autofocus>
            </div>
        </div>
        ...
        <div class="col-md-12 row">
            <div class="form-group col-md-6">
                ...
                <input id="img_comuimg" name="img_comuimg" type="file" size="100" onchange="return validarExt()" required data-allowed-file-extensions='["jpg"]'>
    ...
    <div class="modal-footer">
        <button id="btn_producto" name="btn_producto" type="button" onclick="Insert_Web_Img()" class="btn btn-primary" data-loading-text="Loading..." autocomplete="off">
...
<script>
    function Insert_Web_Img() {
        ...
        var dataString = new FormData(document.getElementById('formulario_web_insertar'));
