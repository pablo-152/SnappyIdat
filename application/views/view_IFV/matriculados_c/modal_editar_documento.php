...
<form method="post" id="formulario_doc_update" enctype="multipart/form-data" class="formulario">
    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        ...
        <!--<div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                ...
                print '<select id="year_u" name="year_u" class="form-control">';
    ...
    <div class="modal-footer">
        <input type="hidden" id="id_detalle" name="id_detalle" value="<?php echo $get_detalle[0]['id_detalle']; ?>">
        <input type="hidden" id="archivo_actual" name="archivo_actual" value="<?php echo $get_detalle[0]['archivo']; ?>">
        <input type="hidden" id="cod_documento_u" value="<?php echo $get_documento[0]['cod_documento']; ?>">
...
<script>
    function Validar_Extension_U(){
        var cod_documento = document.getElementById('cod_documento_u');
    ...
    function Update_Documento(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Update_Documento_Alumno";
