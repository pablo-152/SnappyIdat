        ...
        <?php foreach($list_perfil as $list){ ?>                                            
            <tr class="even pointer text-center"> 
                ...
                <td>
                    ...
                    app_crear_mod="<?= site_url('AppIFV/Modal_Update_Perfil') ?>/<?php echo $list['id_perfil']; ?>">
                        <img src="<?= base_url() ?>template/img/editar.png">
                    </a>

                    <a href="#" class="" title="Eliminar" onclick="Delete_Perfil('<?php echo $list['id_perfil']; ?>')" role="button">
