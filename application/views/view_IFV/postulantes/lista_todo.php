    ...
    <tbody >
        <?php foreach($list_postulantes as $list) {  ?>                                           
            <tr class="even pointer">
                ...
                <td align="center" nowrap><?php echo $list['fecha_inscripcion']; ?></td>
                ...
                <td align="center">
                    <?php if($list['estado_postulante']==31 || $list['estado_postulante']==64 || $list['estado_postulante']==33){
                        if($busqueda!=false){
                            echo $list_resultados[$posicion]['puntaje'];
                        } 
                    } ?>
                </td>
                <td align="center"><?php if($list['estado_postulante']==31 || $list['estado_postulante']==64 || $list['estado_postulante']==33){ 
                    if($busqueda!=false){
                        echo $list_resultados[$posicion]['puntaje_arpay'];
                    }} ?>
                </td>
                <td align="center" nowrap ><?php if($list['estado_postulante']==31 || $list['estado_postulante']==64){
                    if($busqueda!=false){
                        if($list_resultados[$posicion]['tiempo_inicio']!=""){
