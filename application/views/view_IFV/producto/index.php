...
<div class="panel panel-flat">
    ...
    <div class="container-fluid">
        <div class="heading-btn-group">
            ...
            <a onclick="Lista_Producto(2);" id="todos" style="color: #000000; background-color: #0070c0;height: 32px;width: 150px;padding: 5px;" class="form-group btn"><span>Todos</span><i class="icon-arrow-down52"></i></a>
...
<script>
    ...
    function Lista_Producto(tipo){
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Lista_Producto";
    ...
    function Excel_Producto() {
        ...
        window.location = "<?php echo site_url(); ?>AppIFV/Excel_Producto/"+tipo_excel;
    }
</script>
