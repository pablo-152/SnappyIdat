        ...
        <div class="heading-elements" style="position: absolute;top: 50%;margin: -25px 0 0 -25px;">
          <div class="heading-btn-group">
            <a type="button" href="<?= site_url('AppIFV/Registro') ?>">
              <img class="top" src="<?= base_url() ?>template/img/ceba/regresar2.png" width="50">
            </a>
          </div>
        </div>
      </div>
    ...
    <form id="formulario" method="POST" enctype="multipart/form-data" class="formulario">
      <div class="col-md-12 row" style="margin-top:15px;margin-bottom:15px;">
          <div class="form-group col-md-2">
            ...
            <?php if($get_id[0]['tipo']==="1"){ ?>
              <option value="1" selected >Actas</option>
            <?php }else if($get_id[0]['tipo']==="2"){ ?>
              <option value="2" selected >Nominas</option>
            <?php }else if($get_id[0]['tipo']==="3"){ ?>
        ...
        <label style="color:transparent;">Ref</label>
          ...
          <?php if($get_id[0]['ref_lugar']==="1"){ ?>
              <option value="1" selected >Chincha</option>
            <?php }else if($get_id[0]['ref_lugar']==="2"){ ?>
      ...
      <div class="col-md-12 row">
        <div id="div_estado" class="form-group col-md-2">
          ...
          <!--<input type="text" class="form-control" disabled value="<?php echo $get_id[0]['segundo_estado']; ?>">-->
...
<script>
  ...
  function Div_Editar_Registro() {
    var id_registro = $('#id_registro').val();
    var url = "<?php echo site_url(); ?>AppIFV/Div_Editar_Registro/"+id_registro;
    $.ajax({
      url: url,
      type: 'POST',
  ...
  function Update_Registro() {
    ...
    var url = "<?php echo site_url(); ?>AppIFV/Update_Registro";
