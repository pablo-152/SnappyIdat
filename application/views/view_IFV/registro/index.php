            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('AppIFV/Registrar_Registro') ?>"> <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo Ticket" />
                        </a>

                        <a href="<?= site_url('AppIFV/Excel_Registro') ?>" style="margin-left: 5px;">
...
<script>
    ...
    function Lista_Registro() {
        ...
        var url = "<?php echo site_url(); ?>AppIFV/Lista_Registro";
    ...
    function Delete_Registro(id) {
        ...
        var id = id;
        var url = "<?php echo site_url(); ?>AppIFV/Delete_Registro";
        Swal({
