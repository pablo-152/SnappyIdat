<table class="table table-hover table-bordered table-striped" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th class="text-center" width="12%">Ref</th>
            <th class="text-center" width="14%">Especialidad</th>
            <th class="text-center" width="14%">Grupo</th>
            <th class="text-center" width="8%" title="Fecha Envio">F. Env.</th>
            <th class="text-center" width="8%" title="Número Alumnos">N. Alu.</th>
            <th class="text-center" width="22%">Producto</th>
    ...
    <tbody>
        <?php foreach ($list_registro as $list) {  ?>
            <tr class="even pointer">
                ...
                <td><?php echo $list['producto']; ?></td>
                <td class="text-center"><?php echo $list['primer_estado']; ?></td>
                <td class="text-center">
                    <a href="<?= site_url('AppIFV/Editar_Registro') ?>/<?php echo $list['id_registro']; ?>"><img title="Editar" src="<?= base_url() ?>template/img/editar.png" style="cursor:pointer; cursor: hand;"></a>
