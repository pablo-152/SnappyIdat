...
<div class="panel panel-flat">
    ...
    <div class="container-fluid">
        ...
        <div class="heading-btn-group">
            <a onclick="Lista_Asistencia(1);" id="alumnos_btn" style="background-color: #0070C0;height: 32px;width: 150px;padding: 5px;" class="form-group btn"><span>Alumnos</span><i class="icon-arrow-down52"></i></a>
            <a onclick="Lista_Asistencia(2);" id="invitados_btn" style="background-color: #0070C0;height: 32px;width: 150px;padding: 5px;" class="form-group btn"><span>Invitados</span><i class="icon-arrow-down52"></i> </a>
...
<script>
    ...
    function Lista_Asistencia(tipo){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Lista_Asistencia_Registro_Ingreso";

        $.ajax({
            type:"POST",
            url:url,
            data:{'semana':semana, 'tipo':tipo},
