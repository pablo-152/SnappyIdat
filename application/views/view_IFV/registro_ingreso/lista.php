<table class="table table-hover table-striped table-bordered" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th class="text-center" width="5%" title="Especialidad">Esp.</th>
            <th class="text-center" width="4%" title="Grupo">Gru.</th>
            <th class="text-center" width="4%" title="Módulo">Mo.</th>
    ...
    <tbody>
        <?php foreach($list_registro_ingreso as $list){ ?>                                         
            <tr class="even pointer text-center">
                ...
                <td class="text-left"><?php echo $list['estado_asistencia']//$list['nom_estado_reporte']; ?></td>
                <td class="text-left"><?php echo $list['usuario_codigo']; ?></td>
                <td class="text-left"><?php echo $list['estado_ing']; ?></td>
                <td class="text-left"><?php echo $list['nom_tipo_acceso']; ?></td>
                <td><?php echo $list['reg_automatico']; ?></td>
                ...
                <td>
                    ...
                    <?php } ?>-->
                    <a title="Más Información" href="<?= site_url('AppIFV/Registro_Ingreso_x_alumno') ?>/<?php echo $list['codigo2']; ?>"> 
                    ...
                    <!--<a title="Editar Datos" data-toggle="modal" data-target="#acceso_modal_mod" 
                            app_crear_mod="<?= site_url('AppIFV/Registro_Ingreso_x_alumno') ?>/<?php echo $list['codigo2'];?>">
                            <img src="<?= base_url() ?>template/img/ver.png">
                        </a>-->
                    <?php if($_SESSION['usuario'][0]['id_nivel']==1 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                        <!--<a href="#" title="Eliminar" onclick="Delete_Registro_Ingreso('<?php echo $list['id_registro_ingreso']; ?>')" role="button"> 
