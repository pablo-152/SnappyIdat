        ...
        <form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
            <div class="col-md-12 row">
                <div class="form-group col-md-2">
                    ...
                    <select class="form-control" id="planta_u" name="planta_u">
                        ...
                        <option value="5" <?php if($get_id[0]['planta']==5){ echo "selected"; } ?>>5</option>
                    </select>
                </div>
            ...
            <div class="col-md-12 row">
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control solo_numeros" id="capacidad_u" name="capacidad_u" placeholder="Capacidad Alumno" value="<?php echo $get_id[0]['capacidad']; ?>">
                </div>

                <div class="form-group col-md-2">
                    <label class="control-label text-bold">Disponibilidad Alum.:</label>
                    <input type="text" class="form-control solo_numeros" id="disponible_u" name="disponible_u" placeholder="Disponiblidad Alumno" value="<?php echo $get_id[0]['disponible']; ?>">
                </div>

                <div class="form-group col-md-2">
                    <label class="control-label text-bold">Aforo CP Dbl:</label>
                    <input type="text" class="form-control solo_numeros" id="aforodbl_u" name="aforodbl_u" placeholder="Capacidad" value="<?php echo $get_id[0]['aforodbl']; ?>">
                </div>

                <div class="form-group col-md-2">
                    <label class="control-label text-bold">Aforo CP Ind:</label>
                    <input type="text" class="form-control solo_numeros" id="aforoind_u" name="aforoind_u" placeholder="Aforo CP Ind" value="<?php echo $get_id[0]['aforoind']; ?>">
                </div>

                <div class="form-group col-md-2">
                    <label class="control-label text-bold">Carpetas (Tp):</label>
                    <select class="form-control" id="carpetatp_u" name="carpetatp_u">
                        <option value="0">Seleccione</option>
                        <option value="1" <?php if("1"==$get_id[0]['carpetatp']){ echo "selected"; } ?>>Dobles</option>
                        <option value="2" <?php if("2"==$get_id[0]['carpetatp']){ echo "selected"; } ?>>Individuales</option>
                    </select>
                </div>

                <div class="form-group col-md-2">
                    <label class="control-label text-bold">Carpetas (Cant):</label>
                    <input type="text" class="form-control solo_numeros" id="carpetacant_u" name="carpetacant_u" placeholder="Carpetas (Cant)" value="<?php echo $get_id[0]['carpetacant']; ?>">
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" href="<?= site_url('AppIFV/Salon') ?>">
...
<script>
    ...
    function Update_Salon(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Update_Salon";
