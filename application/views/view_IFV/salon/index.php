            ...
            <div class="x_panel">
                ...
                <div class="heading-elements"> 
                    <div class="heading-btn-group">
                        <a title="Nuevo" style="cursor:pointer;margin-right:5px;" href="<?= site_url('AppIFV/Registrar_Salon') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo">
                        </a>

                        <a href="<?= site_url('AppIFV/Excel_Salon') ?>">
                    ...
                    <tbody>
                        <?php foreach($list_salon as $list) {  ?>                                           
                            <tr class="even pointer text-center">
                                ...
                                <td>
                                    <a title="Editar" href="<?= site_url('AppIFV/Editar_Salon') ?>/<?php echo $list['id_salon']; ?>">
...
<script>
    ...
    function Delete_Salon(id){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Delete_Salon";
