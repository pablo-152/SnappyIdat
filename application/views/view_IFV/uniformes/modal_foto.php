<form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="Update_Matriculados_C()">
...
<script>
    ...
    function Update_Matriculados_C(){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url="<?php echo site_url(); ?>AppIFV/Valida_Update_Matriculados_C";
        var url2="<?php echo site_url(); ?>AppIFV/Update_Matriculados_C";
