      ...
      <div class="row">
        <div class="x_panel">
          <div class="page-title" style="background-color: #C1C1C1;">
            ...
            <h4 style="font-size:40px; color:white; position: absolute;top: 40%;left: 4%;margin: -25px 0 0 -25px;"><span class="text-semibold"><b> Actualizar Datos de Retiro Alumno</b></span></h4>
          </div>
      ...
      <form id="form-retiro" method="POST" enctype="multipart/form-data" class="formulario">
        <div class="row">
          ...
          <div class="col-md-12 row" style="background-color:#c1c1c1;margin-left: auto;">
            ...
            <div class="form-group col-md-2">
              <input type="date" class="form-control" id="Fecha_Fin_Arpay" name="Fecha_Fin_Arpay" value="<?php if(count($get_id)>0){echo $get_id[0]['Fecha_Fin_Arpay'];} ?>">
            </div>
            ...
            <div style="display:<?php if(count($get_id)>0){if($get_id[0]['Motivo_Arpay']=='Otro (mencionar en observaciones)'){ echo "block"; }else{echo "none";}} ?>">
              ...
              <div class="form-group col-md-10">
                <input type="text" class="form-control" id="Observaciones_Arpay" name="Observaciones_Arpay" disabled value="<?php if(count($get_id)>0){echo $get_id[0]['Observaciones_Arpay'];} ?>">
              </div>              
            </div>
            <div class="form-group col-md-12" >
            </div>
            ...
            <div class="form-group col-md-2">
              <label class="control-label text-bold margintop">Motivo Snapy: </label>
            </div>
            <div class="form-group col-md-2">
              <select class="form-control" name="id_motivo" id="id_motivo" onchange="Motivo()">
                <option value="0">Seleccione</option>
                <?php foreach($list_motivo as  $list){?> 
                  <option value="<?php echo $list['id_motivo'] ?>" <?php if(count($get_retirado)>0){if($get_retirado[0]['id_motivo']==$list['id_motivo']){echo "selected";}}?>><?php echo $list['nom_motivo'] ?></option>  
                <?php } ?>
              </select>
            </div>
            ...
            <div id="div_otro" style="display:<?php if(count($get_retirado)>0){if($get_retirado[0]['id_motivo']==1){ echo "block"; }else{echo "none";}}else{echo "none";} ?>">
              ...
              <div class="form-group col-md-10">
                <input type="text" class="form-control" id="otro_motivo" name="otro_motivo" value="<?php if(count($get_retirado)>0){echo $get_retirado[0]['otro_motivo'];} ?>">
              </div>
            </div>
            ...
            <div class="form-group col-md-2">
              <input type="text" class="form-control" id="tkt_boleta" name="tkt_boleta" value="<?php if(count($get_retirado)>0){echo $get_retirado[0]['tkt_boleta'];} ?>">
            </div>
            <div class="form-group col-md-12" >
            </div>
            <div class="form-group col-md-1" >
            ...
            <div class="form-group col-md-1">
              <input type="text" class="margintop form-control " disabled value="<?php if(count($get_retirado)>0){echo $get_retirado[0]['Matricula'];} ?>">
            </div>
            ...
            <div class="form-group col-md-1">
              <input type="text" class="margintop form-control" id="monto" name="monto" onkeypress="return soloNumeros(event)" value="<?php if(count($get_retirado)>0){echo $get_retirado[0]['monto'];} ?>">
            </div>
          ...
          <div class="col-md-12 row">
            ...
            <div class="form-group col-md-2">
              <input type="date" class="form-control" id="fecha_contacto" name="fecha_contacto" value="<?php if(count($get_retirado)>0){echo $get_retirado[0]['fecha_contacto'];} ?>">
            </div>
            <div class="form-group col-md-1" >
              <label class=" control-label text-bold margintop">Hora:</label>
            </div>
            <div class="form-group col-md-1">
              <input type="time" class="form-control" id="hora_contacto" name="hora_contacto" value="<?php if(count($get_retirado)>0){echo $get_retirado[0]['hora_contacto'];} ?>">
            </div>
            <div class="form-group col-md-12" >
              <label class=" control-label text-bold margintop">Resuma de una forma clara contenido de ese contacto</label>
            </div>
            <div class="form-group col-md-12" >
              <textarea class="form-control" name="resumen" id="resumen" cols="4" rows="4"><?php if(count($get_retirado)>0){echo $get_retirado[0]['resumen'];} ?></textarea>
            </div>
            <div class="form-group col-md-12" >
              <label class=" control-label text-bold margintop">Observación de Retiro</label>
            </div>
            <div class="form-group col-md-12" >
              <textarea class="form-control" name="obs_retiro" id="obs_retiro" cols="4" rows="4"><?php if(count($get_retirado)>0){echo $get_retirado[0]['obs_retiro'];}else{echo $get_id[0]['Observacion'];} ?></textarea>
            </div>
            <div class="form-group col-md-2">
            ...
            <div class="form-group col-md-12" >
              <label class=" control-label text-bold margintop">Actualizado por: <?php if(count($get_retirado)>0){echo $get_retirado[0]['usuario_codigo']." ".$get_retirado[0]['fecha_actualizacion'];}?></label><br>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" onclick="Update_Retiro()" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Actualizar </button>
