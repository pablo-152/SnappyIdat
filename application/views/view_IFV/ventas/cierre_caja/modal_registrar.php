...
<script>
    ...
    function Saldo_Fecha(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Saldo_Fecha"; 
    ...
    function Productos_Fecha(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Productos_Fecha"; 
        var id_vendedor = $("#id_vendedor_i").val(); 
        var fecha = $("#fecha_i").val(); 
    ...
    function Insert_Cierre_Caja(){
        ...
        var url="<?php echo site_url(); ?>AppIFV/Insert_Cierre_Caja"; 
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data=="movimiento"){
                        ...
                        window.open('<?php echo site_url(); ?>AppIFV/Pdf_Cierre_Caja/'+data, '_blank'); 
                        Lista_Cierre_Caja(1);
