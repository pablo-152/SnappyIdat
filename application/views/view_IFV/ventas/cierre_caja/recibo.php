    ...
    <div id="contenido">
        <div id="contenido_recibo">
            <table id="cabecera_tabla">
                <tr>
                    <td>
                        <!--<img id="imagen_superior" src="<?= base_url() ?>template/img/recibo_la_gris.png">-->
                    </td>
                    <td class="letra_titulo">
                        <div id="nom_empresa" class="negrita">FV CHINCHA SAC</div>
                        <div class="ruc_empresa">RUC: 20602759939</div>
                    </td>
                </tr>
            </table>
            ...
            <table id="segunda_tabla">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="altura_tabla borde_inferior centro sin_negrita"><?php echo 0; ?></td>
                        <td class="altura_tabla borde_inferior derecha sin_negrita">S/ <?php echo 0; ?></td>
                    </tr>
                    <tr>
            ...
            <div class="letra_titulo">
                <div  class="negrita">www.ifv.edu.pe</div>
                <div class="ruc_empresa sin_negrita">Visita Nuestro Facebook</div>
            </div>
