<div class="col-md-12 row">
    <div class="form-group col-md-1 text-right"> 
        <label class="control-label text-bold margin_top">Alumno: </label>
    </div>
    <div class="form-group col-md-4"> 
        <select class="form-control basic" id="id_alumno" name="id_alumno" onchange="Update_Alumno_Nueva_Venta();"> 
            ...
            <?php foreach($list_alumno as $list){ ?>
                <option value="<?php echo $list['id_alumno']; ?>" <?php if($list['id_alumno']==$get_id[0]['id_alumno']){ echo "selected"; } ?>>
