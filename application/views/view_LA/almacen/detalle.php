            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <?php if($get_id[0]['principal']==1){ ?>
                            <a title="Añadir Compra" style="margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Laleli/Modal_Compra_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
                                <img src="<?= base_url() ?>template/img/anadir_compra.png" alt="Añadir Compra" />
                            </a>

                            <!--<a title="Añadir Producto" style="margin-right:5px;" href="<?= site_url('Laleli/Detalle_Anadir_Producto') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
                                <img src="<?= base_url() ?>template/img/anadir_producto.png" alt="Añadir Producto" />
                            </a>-->
                        <?php } ?> 
                        ...
                        <?php if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==7 || $_SESSION['usuario'][0]['id_nivel']==6 || $_SESSION['usuario'][0]['id_usuario']==$get_id[0]['id_supervisor'] || $_SESSION['usuario'][0]['id_usuario']==$get_id[0]['id_responsable']){ ?>
                            <a title="Transferir Producto" style="margin-right:5px;" href="<?= site_url('Laleli/Detalle_Transferir_Producto') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
                        ...
                        <?php if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==7 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                            <a title="Retirar Producto" style="margin-right:5px;" href="<?= site_url('Laleli/Detalle_Retirar_Producto') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
                                <img src="<?= base_url() ?>template/img/retirar_producto.png" alt="Retirar Producto" />
                            </a>
                        <?php } ?>

                        <a title="Editar Almacén" style="margin-right:5px;" href="<?= site_url('Laleli/Editar_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>"> 
                            <img src="<?= base_url() ?>template/img/editar_grande.png">
                        </a>

                        <a type="button" href="<?= site_url('Laleli/Almacen') ?>" style="margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/icono-regresar.png" alt="">
                        </a>

                        <a href="<?= site_url('Laleli/Excel_Detalle_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
...
<script>
    ...
    function Lista_Detalle_Almacen(){
        ...
        var url="<?php echo site_url(); ?>Laleli/Lista_Detalle_Almacen";
