<!--<table class="table table-hover table-bordered table-striped" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th class="text-center" width="20%">De/Para</th>
            <th class="text-center" width="10%">Fecha Compra</th>
            <th class="text-center" width="8%">Año</th> 
            <th class="text-center" width="10%">Precio Compra</th> 
            <th class="text-center" width="8%">Arpay</th>
    ...
    <tbody>
        <?php foreach($list_movimiento_almacen as $list){ ?>                                           
            <tr class="even pointer text-center"> 
                ...
                <td class="text-right"><?php echo $list['precio_compra']; ?></td>
                <td><?php echo $list['gasto_arpay']; ?></td> 
                <td><?php echo $list['cantidad']; ?></td>            
                <td><?php echo $list['saldo']; ?></td>          
                <td>
                    <a title="Eliminar" onclick="Delete_Movimiento_Almacen('<?php echo $list['id_movimiento']; ?>')">
