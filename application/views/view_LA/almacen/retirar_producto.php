        ...
        <div class="row">
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <a title="Buscar" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Laleli/Modal_Retirar_Producto_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
...
<script>
    ...
    function Lista_Temporal_Retirar_Producto(){
        ...
        var url="<?php echo site_url(); ?>Laleli/Lista_Temporal_Retirar_Producto";
    ...
    function Buscar_Producto_Retirar(){
        ...
        var url="<?php echo site_url(); ?>Laleli/Buscar_Producto_Retirar";
    ...
    function Insert_Temporal_Retirar_Producto(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli/Insert_Temporal_Retirar_Producto";
    ...
    function Delete_Temporal_Retirar_Producto(id){
        ...
        var url="<?php echo site_url(); ?>Laleli/Delete_Temporal_Retirar_Producto";
    ...
    function Retirar_Producto(){
        ...
        var url="<?php echo site_url(); ?>Laleli/Valida_Retirar_Producto";
        var url2="<?php echo site_url(); ?>Laleli/Retirar_Producto";
        var id_almacen = $("#id_almacen").val();
