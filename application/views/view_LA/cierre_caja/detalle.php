                ...
                <div class="heading-elements"> 
                    <div class="heading-btn-group"> 
                        <?php if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                            <a title="Asignar Cofre" data-toggle="modal" data-target="#acceso_modal_mod" 
                            app_crear_mod="<?= site_url('Laleli/Modal_Update_Cierre_Caja') ?>/<?php echo $get_id[0]['id_cierre_caja']; ?>" style="margin-right:5px;cursor:pointer;"> 
                                <img src="<?= base_url() ?>template/img/asignar_cofre.png">
                            </a>
                        <?php } ?> 

                        <a type="button" href="<?= site_url('Laleli/Cierre_Caja') ?>">
