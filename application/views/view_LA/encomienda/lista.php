            ...
            <tr class="even pointer text-center">
                ...
                <td>
                    <?php if($list['estado_e']==0 && $list['anulado']==0){ ?>
                        <a title="Encomendar" data-toggle="modal" data-target="#acceso_modal_pequeno" app_crear_peq="<?= site_url('Laleli/Modal_Entrega_Encomienda') ?>/<?php echo $list['id_encomienda']; ?>">
                            <img src="<?= base_url() ?>template/img/encomendar.png">
                        </a>
                    <?php } ?>

                    <?php if($list['id_tipo_documento']==1){ ?>
                        <a title="Documento" href="<?= site_url('Laleli/Recibo_Venta') ?>/<?php echo $list['id_venta']; ?>" target="_blank">
                            <img src="<?= base_url() ?>template/img/icono_impresora.png">
                        </a>
                    <?php }else{ ?> 
                        <a title="Documento" href="<?= site_url('Laleli/Pdf_Venta') ?>/<?php echo $list['id_venta']; ?>" target="_blank">
                            <img src="<?= base_url() ?>template/img/icono_impresora.png">
                        </a>
                    <?php } ?>
                </td>                           
