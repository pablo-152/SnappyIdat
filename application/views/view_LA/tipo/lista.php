        ...
        <?php foreach($list_tipo as $list){ ?>                                           
            <tr class="even pointer text-center">
                ...
                <td>
                    ...
                    app_crear_mod="<?= site_url('Laleli/Modal_Update_Tipo') ?>/<?php echo $list['id_tipo']; ?>" 
                    src="<?= base_url() ?>template/img/editar.png" style="cursor:pointer;"/>

                    <img title="Eliminar" onclick="Delete_Tipo('<?php echo $list['id_tipo']; ?>')"
