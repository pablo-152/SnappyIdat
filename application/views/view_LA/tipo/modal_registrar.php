    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <input type="text" class="form-control" id="nom_tipo_i" name="nom_tipo_i" maxlength="25" placeholder="Ingresar Nombre" onkeypress="if(event.keyCode == 13){ Insert_Tipo(); }">
            </div>
...
<script>
    function Insert_Tipo(){
        ...
        var url="<?php echo site_url(); ?>Laleli/Insert_Tipo";
