            ...
            <tr class="even pointer text-center">
                ...
                <td>
                    <?php if($list['estado_e']==0 && $list['anulado']==0){ ?>
                        <a title="Encomendar" data-toggle="modal" data-target="#acceso_modal_pequeno" app_crear_peq="<?= site_url('Laleli1/Modal_Entrega_Encomienda') ?>/<?php echo $list['id_encomienda']; ?>">
