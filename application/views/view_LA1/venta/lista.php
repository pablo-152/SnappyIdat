            ...
            <tr class="even pointer text-center"> 
                ...
                <td>
                    <?php /*if($list['id_tipo_documento']==1){ ?> 
                        <a title="Documento" href="<?= site_url('Laleli1/Recibo_Venta') ?>/<?php echo $list['id_venta']; ?>" target="_blank">
                            <img src="<?= base_url() ?>template/img/icono_impresora.png">
                        </a>
                    <?php }else{ ?>
                        <a title="Documento" href="<?= site_url('Laleli1/Pdf_Venta') ?>/<?php echo $list['id_venta']; ?>" target="_blank">
                            <img src="<?= base_url() ?>template/img/icono_impresora.png">
                        </a>
                    <?php }*/ ?>

                    <a title="Documento" href="<?= site_url('Laleli1/Documento_Venta') ?>/<?php echo $list['id_venta']; ?>" target="_blank">
                        <img src="<?= base_url() ?>template/img/icono_impresora.png">
                    </a>

                    <?php if($list['estado_venta']==1 && $list['anulado']==0){ ?>
                        <a title="Devolución" data-toggle="modal" data-target="#acceso_modal_mod" 
                        app_crear_mod="<?= site_url('Laleli1/Modal_Anular_Venta') ?>/<?php echo $list['id_venta']; ?>">
