            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('Laleli2/Detalle_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
        ...
        <div class="row">
            <div class="col-md-12 row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <a title="Buscar" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Laleli2/Modal_Retirar_Producto_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>">
...
<script>
    ...
    function Lista_Temporal_Retirar_Producto(){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Lista_Temporal_Retirar_Producto";
    ...
    function Buscar_Producto_Retirar(){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Buscar_Producto_Retirar";
    ...
    function Insert_Temporal_Retirar_Producto(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli2/Insert_Temporal_Retirar_Producto";
    ...
    function Delete_Temporal_Retirar_Producto(id){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Delete_Temporal_Retirar_Producto";
    ...
    function Retirar_Producto(){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Valida_Retirar_Producto"; 
        var url2="<?php echo site_url(); ?>Laleli2/Retirar_Producto";
        var id_almacen = $("#id_almacen").val();
                                ...
                                Swal({
                                    ...
                                    if (result.value) {
                                        $.ajax({
                                            ...
                                            data: {'id_almacen':id_almacen},
                                            success:function () {
                                                window.location = "<?php echo site_url(); ?>Laleli2/Detalle_Almacen/" + id_almacen;
                                            }
                                        });
                                    }
                                })
