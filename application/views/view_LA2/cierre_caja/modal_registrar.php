...
<script>
    ...
    function Saldo_Fecha(){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Saldo_Fecha"; 
    ...
    function Productos_Fecha(){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Productos_Fecha"; 
        var id_vendedor = $("#id_vendedor_i").val(); 
        var fecha = $("#fecha_i").val(); 
    ...
    function Insert_Cierre_Caja(){
        ...
        var url="<?php echo site_url(); ?>Laleli2/Insert_Cierre_Caja"; 
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data=="error"){
                        ...
                        window.open('<?php echo site_url(); ?>Laleli2/Pdf_Cierre_Caja/'+data, '_blank'); 
                        Lista_Cierre_Caja(1);
