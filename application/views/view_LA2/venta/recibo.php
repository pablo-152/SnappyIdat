    ...
    <div id="contenido">
        <div id="contenido_recibo">
            <table id="cabecera_tabla">
                <tr>
                    <td>
                        <img id="imagen_superior" src="<?= base_url() ?>template/img/recibo_la_blanco.png"><!--<?php echo $get_id[0]['color_logo']; ?> -->
                    </td>
                    <td id="letra_titulo">
            ...
            <table id="tercera_tabla">
                <thead>
                    <tr>
                        <th class="th_tercera_tabla borde_derecha sin_negrita" width="40%">Descripción</th>
                        <th class="th_tercera_tabla borde_derecha sin_negrita" width="12%">Talla</th>
                        <th class="th_tercera_tabla borde_derecha sin_negrita" width="25%">Código</th>
                        <th class="th_tercera_tabla sin_negrita" width="21%">Precio</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div id="letra_titulo" class="sin_negrita">
