            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('Laleli3/Detalle_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>" style="margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/icono-regresar.png" alt="">
                        </a>

                        <a href="<?= site_url('Laleli3/Excel_Movimiento_Almacen') ?>/<?php echo $get_id[0]['id_almacen']; ?>/<?php echo str_replace('-','_',$get_producto[0]['codigo']); ?>">
...
<script>
    ...
    function Lista_Movimiento_Almacen(){
        ...
        var url="<?php echo site_url(); ?>Laleli3/Lista_Movimiento_Almacen";
