...
<script>
    ...
    function Buscar_Producto_Transferir(){
        ...
        var url="<?php echo site_url(); ?>Laleli3/Buscar_Producto_Transferir";
    ...
    function Detalle_Transferencia(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli3/Detalle_Transferencia";
    ...
    function Transferir_Producto(){
        ...
        var url="<?php echo site_url(); ?>Laleli3/Valida_Transferir_Producto";
        var url2="<?php echo site_url(); ?>Laleli3/Transferir_Producto";
        var dataString = $("#formulario_transferir").serialize();
        var id_almacen = $("#id_almacen").val();
