            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Nuevo" style="cursor:pointer;margin-right:5px;" href="<?= site_url('Laleli3/Nueva_Venta') ?>">
...
<script>
    ...
    function Lista_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli3/Lista_Venta";
    ...
    function Excel_Venta() {
        window.location = "<?php echo site_url(); ?>Laleli3/Excel_Venta";
    }
</script>
