...
<script>
    function Traer_Producto_Retirar(id_tipo_producto){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url="<?php echo site_url(); ?>Laleli4/Traer_Producto_Retirar";
    ...
    function Insert_Modal_Retirar_Producto_Almacen(cod_producto){
        ...
        var id_almacen = $("#id_almacen").val();
        var url="<?php echo site_url(); ?>Laleli4/Insert_Modal_Retirar_Producto_Almacen";
