...
<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;"> 
        <div class="col-md-12 row">
            ...
            <?php //if($id_usuario==1 || $id_nivel==6 || in_array($id_usuario, $list_sup_adm)){ ?>
                <div class="form-group col-md-4">
...
<script>
    ...
    function Saldo_Fecha(){
        ...
        var url="<?php echo site_url(); ?>Laleli4/Saldo_Fecha"; 
    ...
    function Productos_Fecha(){
        ...
        var url="<?php echo site_url(); ?>Laleli4/Productos_Fecha"; 
        var id_vendedor = $("#id_vendedor_i").val(); 
        var fecha = $("#fecha_i").val(); 
    ...
    function Insert_Cierre_Caja(){
        ...
        var url="<?php echo site_url(); ?>Laleli4/Insert_Cierre_Caja";  
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data=="error"){
                        ...
                        window.open('<?php echo site_url(); ?>Laleli4/Pdf_Cierre_Caja/'+data, '_blank'); 
                        Lista_Cierre_Caja(1);
