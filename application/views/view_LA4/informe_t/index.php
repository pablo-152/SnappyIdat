...
<script>
    ...
    function Lista_Informe_Transferencia(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli4/Lista_Informe_Transferencia";
    ...
    function Pdf_Informe_Transferencia() {
        window.open('<?php echo site_url(); ?>Laleli4/Pdf_Informe_Transferencia', '_blank');
    }

    function Excel_Informe_Transferencia() {
        window.location = "<?php echo site_url(); ?>Laleli4/Excel_Informe_Transferencia";
    }
</script>
