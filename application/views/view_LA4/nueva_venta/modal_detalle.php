...
<script>
    ...
    function Insert_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli4/Insert_Venta"; 
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.split("*")[0]=="correcto"){
                        window.open('<?php echo site_url(); ?>Laleli4/Documento_Venta/'+data.split("*")[1], '_blank');
                        window.location = "<?php echo site_url(); ?>Laleli4/Nueva_Venta"; 
                    }else if(data.split("*")[0]=="producto"){
                        Swal({
                        ...
                        if (validacion == 1) {
                            ...
                            window.open('<?php echo site_url(); ?>Laleli4/Pdf_Venta/'+data.split("*")[1], '_blank');
                            window.location = "<?php echo site_url(); ?>Laleli4/Nueva_Venta";
                        }
                    }
                }
    ...
    function Valida_Insert_Venta() {
        if($('#id_alumno').val().trim() === '0-0') {
            Swal(
                'Ups!',
                'Debe seleccionar Alumno/Colaborador.',
                'warning'
            ).then(function() { });
            return false;
        }
