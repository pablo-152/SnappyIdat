...
<div id="contenido">
    <div id="contenido_recibo">
        <table id="cabecera_tabla">
            <tr>
                ...
                <td id="letra_titulo">
                    ...
                    <div id="ruc_empresa" class="sin_negrita">RUC: 20602823891</div>
                </td>
            </tr>
        </table>
        ...
        <table id="tercera_tabla">
            <thead>
            <tr>
                <th class="th_tercera_tabla borde_derecha negrita" width="45%">Descripción</th>
                <th class="th_tercera_tabla borde_derecha negrita" width="12%">Talla</th>
                <th class="th_tercera_tabla borde_derecha negrita" width="25%">Código</th>
                <th class="th_tercera_tabla negrita" width="25%">Precio</th>
            </tr>
            </thead>
            <tbody>
            <?php $total = 0; foreach($list_detalle as $list){ ?>
                <tr>
                    <td class="td_tercera_tabla sin_negrita"><?php echo $list['descripcion']; ?></td>
                    <td class="centro td_tercera_tabla sin_negrita"><?php echo $list['talla']; ?></td>
                    <td class="centro td_tercera_tabla sin_negrita"><?php echo $list['codigo']; ?></td>
                    <td class="derecha td_tercera_tabla sin_negrita">S/ <?php echo number_format(($list['precio']*$list['cantidad']),2); ?></td>
                </tr>
            ...
            <tr>
                ...
                <td class="derecha td_final_tercera_tabla sin_negrita">S/ <?php echo number_format($total,2); ?></td>
            </tr>
            </tbody>
        </table>
        ...
        <div id="letra_titulo">
            ...
            <div class="sin_negrita">Visita Nuestro Facebook</div>
        </div>
