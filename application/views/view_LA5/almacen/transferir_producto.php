...
<script>
    ...
    function Buscar_Producto_Transferir(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Buscar_Producto_Transferir";
    ...
    function Detalle_Transferencia(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli5/Detalle_Transferencia";
    ...
    function Transferir_Producto(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Valida_Transferir_Producto";
        var url2="<?php echo site_url(); ?>Laleli5/Transferir_Producto";
        var dataString = $("#formulario_transferir").serialize();
        var id_almacen = $("#id_almacen").val();
