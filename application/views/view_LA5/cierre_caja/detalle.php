                ...
                <div class="heading-elements"> 
                    <div class="heading-btn-group">
                        <?php if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_nivel']==6){ ?>
                            ...
                            app_crear_mod="<?= site_url('Laleli5/Modal_Update_Cierre_Caja') ?>/<?php echo $get_id[0]['id_cierre_caja']; ?>"> 
                                <img title="Editar" style="margin-right:5px;cursor:pointer;"  src="<?= base_url() ?>template/img/editar_grande.png" alt="">
                            </a>-->
                        <?php } ?>

                        <a type="button" href="<?= site_url('Laleli5/Cierre_Caja') ?>">
...
<script>
    ...
    function Lista_Ingreso(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Lista_Ingreso_Cierre_Caja";
    ...
    function Excel_Ingreso(){
        var id_cierre_caja = $("#id_cierre_caja").val();
        window.location ="<?php echo site_url(); ?>Laleli5/Excel_Ingreso_Cierre_Caja/"+id_cierre_caja;
    }
    ...
    function Lista_Egreso(){
        ...
        var id_cierre_caja = $("#id_cierre_caja").val();
        var url="<?php echo site_url(); ?>Laleli5/Lista_Egreso_Cierre_Caja";
    ...
    function Excel_Egreso(){
        var id_cierre_caja = $("#id_cierre_caja").val();
        window.location ="<?php echo site_url(); ?>Laleli5/Excel_Egreso_Cierre_Caja/"+id_cierre_caja;
    }
</script>
