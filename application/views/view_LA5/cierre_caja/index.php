            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Cerrar Caja" style="cursor:pointer;margin-right:5px;" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Laleli5/Modal_Cierre_Caja') ?>">
...
<script>
    ...
    function Lista_Cierre_Caja(tipo){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Lista_Cierre_Caja";
    ...
    function Delete_Cierre_Caja(id){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Delete_Cierre_Caja";
    ...
    function Excel_Cierre_Caja() {
        ...
        window.location = "<?php echo site_url(); ?>Laleli5/Excel_Cierre_Caja/"+tipo_excel; 
    }
</script>
