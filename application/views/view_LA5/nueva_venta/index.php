            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Limpiar" href="<?= site_url('Laleli5/Nueva_Venta') ?>">
        ...
        <div class="col-md-9 row parte_inferior_izquierda">
            <div class="row">
                ...
                <div class="form-group col-md-1">
                    <a title="Buscar" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('Laleli5/Modal_Producto_Nueva_Venta') ?>">
...
<script>
    ...
    function Alumno_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Alumno_Nueva_Venta";
    ...
    function Lista_Producto_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Lista_Producto_Nueva_Venta";
    ...
    function Facturacion_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Facturacion_Nueva_Venta";
    ...
    function Botones_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Botones_Nueva_Venta";
    ...
    function Detalle_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Detalle_Nueva_Venta";
    ...
    function Update_Alumno_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Update_Alumno_Nueva_Venta";
    ...
    function Delete_Alumno_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Delete_Alumno_Nueva_Venta";
    ...
    function Insert_Producto_Nueva_Venta(){  
        ...
        var url="<?php echo site_url(); ?>Laleli5/Insert_Producto_Nueva_Venta";
        var id_alumno =  $("#id_alumno").val();
    ...
    function Delete_Producto_Nueva_Venta(id){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Delete_Producto_Nueva_Venta";
    ...
    function Update_Facturacion_Nueva_Venta(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli5/Update_Facturacion_Nueva_Venta";
