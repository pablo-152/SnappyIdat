...
<script>
    function Lista_Modal_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Lista_Modal_Nueva_Venta";
    ...
    function Lista_Modal_Producto_Nueva_Venta(id_tipo_producto){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Lista_Modal_Producto_Nueva_Venta";
    ...
    function Modal_Botones_Nueva_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Modal_Botones_Nueva_Venta";
    ...
    function Traer_Producto_Nueva_Venta(id_tipo_producto){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Traer_Producto_Nueva_Venta";
    ...
    function Volver_Producto_Nueva_Venta(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli5/Volver_Producto_Nueva_Venta";
    ...
    function Delete_Modal_Producto_Nueva_Venta(cod_producto,id_tipo_producto){
        ...
        var url="<?php echo site_url(); ?>Laleli5/Delete_Modal_Producto_Nueva_Venta"; 
    ...
    function Insert_Modal_Producto_Nueva_Venta(cod_producto,id_tipo_producto){ 
        ...
        var url="<?php echo site_url(); ?>Laleli5/Insert_Modal_Producto_Nueva_Venta";
