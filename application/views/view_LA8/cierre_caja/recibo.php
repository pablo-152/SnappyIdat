            ...
            <table id="cabecera_tabla">
                <tr>
                    ...
                    <td id="letra_titulo">
                        ...
                        <div id="ruc_empresa"><?php echo $get_id[0]['cod_sede']; ?><?php echo substr($get_id[0]['nom_sede'],0,4); ?></div>
                    </td>
                </tr>
            </table>
            ...
            <table id="segunda_tabla">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="altura_tabla borde_inferior centro"><?php echo $get_id[0]['boletas']; ?></td>
                        <td class="altura_tabla borde_inferior derecha">S/ <?php echo $get_id[0]['boletas']; ?></td>
                    </tr>
                    <tr>
                        <td class="altura_tabla borde_inferior"><span class="color_blanco">11</span>Facturas:</td>
                        <td class="altura_tabla borde_inferior centro"><?php echo $get_id[0]['facturas']; ?></td>
                        <td class="altura_tabla borde_inferior derecha">S/ <?php echo $get_id[0]['facturas']; ?></td>
                    </tr>
                    <tr>
