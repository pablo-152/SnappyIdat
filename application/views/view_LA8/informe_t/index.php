...
<script>
    ...
    function Lista_Informe_Transferencia(){ 
        ...
        var url="<?php echo site_url(); ?>Laleli8/Lista_Informe_Transferencia";
    ...
    function Pdf_Informe_Transferencia() {
        window.open('<?php echo site_url(); ?>Laleli8/Pdf_Informe_Transferencia', '_blank');
    }

    function Excel_Informe_Transferencia() {
        window.location = "<?php echo site_url(); ?>Laleli8/Excel_Informe_Transferencia";
    }
</script>
