...
<script>
    ...
    function Insert_Venta(){
        ...
        var url="<?php echo site_url(); ?>Laleli9/Insert_Venta"; 
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.split("*")[0]=="correcto"){
                        window.open('<?php echo site_url(); ?>Laleli9/Recibo_Venta/'+data.split("*")[1], '_blank');
                        window.location = "<?php echo site_url(); ?>Laleli9/Nueva_Venta"; 
                        ...
                        if (validacion == 1) {
                            ...
                            window.open('<?php echo site_url(); ?>Laleli9/Pdf_Venta/'+data.split("*")[1], '_blank');
                            window.location = "<?php echo site_url(); ?>Laleli9/Nueva_Venta";
                        }
                    }
                }
