<table class="table table-hover table-bordered table-striped" id="example" width="100%">
    ...
    <tbody>
        <?php foreach($list_c_contrato as $list){ ?>                                           
            <tr class="even pointer text-center" <?php if($list['id_c_contrato']==17){ echo "style='background-color:#FF000036;'"; } ?>>
                ...
                <td>
                    ...
                    app_crear_mod="<?= site_url('LittleLeaders/Modal_Update_C_Contrato') ?>/<?php echo $list['id_c_contrato']; ?>">
