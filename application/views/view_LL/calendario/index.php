            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group" >
                        <a title="Nuevo" data-toggle="modal" data-target="#acceso_modal" app_crear_per="<?= site_url('LittleLeaders/Modal_Calendario') ?>" style="margin-right:5px">
...
<script>
    ...
    function Lista_Calendario(tipo){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Calendario";
    ...
    function Delete_Calendario(id){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Delete_Calendario";
    ...
    function Excel_Calendario(){ 
        var tipo_excel = $("#tipo_excel").val();
        window.location = "<?php echo site_url(); ?>LittleLeaders/Excel_Calendario/"+tipo_excel;
    }
</script>
