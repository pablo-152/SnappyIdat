            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group"> 
                        ...
                        app_crear_per="<?= site_url('LittleLeaders/Modal_Contrato_Colaborador') ?>/<?php echo $get_id[0]['id_colaborador']; ?>" style="margin-right:5px;">
                        ...
                        app_crear_per="<?= site_url('LittleLeaders/Modal_Pago_Colaborador') ?>/<?php echo $get_id[0]['id_colaborador']; ?>" style="margin-right:5px;">
...
<script>
    ...
    function Descargar_Foto_Colaborador(id){
        Cargando();
        window.location.replace("<?php echo site_url(); ?>LittleLeaders/Descargar_Foto_Colaborador/"+id);
    }
    ...
    function Update_Cv_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Update_Cv_Colaborador";
        ...
        if (Valida_Update_Cv_Colaborador()) {
            $.ajax({
                ...
                success:function (data) {
                    window.location = "<?php echo site_url(); ?>LittleLeaders/Detalle_Colaborador/"+id_colaborador;
                }
            });
        }
    }
    ...
    function Lista_Contrato(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Contrato_Colaborador";
    ...
    function Descargar_Contrato_Colaborador(id){
        window.location.replace("<?php echo site_url(); ?>LittleLeaders/Descargar_Contrato_Colaborador/"+id);
    }

    function Delete_Contrato_Colaborador(id){
        Cargando();

        var url="<?php echo site_url(); ?>LittleLeaders/Delete_Contrato_Colaborador";
    ...
    function Lista_Pago(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Pago_Colaborador";
    ...
    function Delete_Pago_Colaborador(id){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Delete_Pago_Colaborador";
    ...
    function Lista_Asistencia(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Asistencia_Colaborador";
    ...
    function Excel_Asistencia(){
        var id_colaborador = $("#id_colaborador").val();
        window.location ="<?php echo site_url(); ?>LittleLeaders/Excel_Ingresos_Colaborador/"+id_colaborador;
    }
    ...
    function Lista_Observacion(){ 
        ...
        var id_colaborador = $("#id_colaborador").val();
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Observacion_Colaborador";
    ...
    function Insert_Observacion_Colaborador(){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Insert_Observacion_Colaborador";
    ...
    function Delete_Observacion_Colaborador(id){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Delete_Observacion_Colaborador";
