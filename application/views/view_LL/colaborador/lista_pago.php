    ...
    <tbody >
        <?php foreach($list_pago as $list){ ?>                                            
            <tr class="even pointer text-center">
                ...
                <td>
                    <a title="Editar" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('LittleLeaders/Modal_Update_Pago_Colaborador') ?>/<?php echo $list['id_pago']; ?>">
