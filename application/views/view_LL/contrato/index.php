...
<script>
    ...
    function Lista_Contrato(tipo){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Contrato";
    ...
    function Actualizar_Lista_Contrato(id){ 
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Actualizar_Lista_Contrato";
    ...
    function Reenviar_Email(id){ 
        ...
        var tipo_excel=$('#tipo_excel').val();
        var url="<?php echo site_url(); ?>LittleLeaders/Reenviar_Email";
    ...
    function Delete_Contrato(id){ 
        ...
        var tipo_excel=$('#tipo_excel').val();
        var url="<?php echo site_url(); ?>LittleLeaders/Delete_Contrato";
    ...
    function Excel_Contrato() {
        var tipo_excel=$('#tipo_excel').val();
        window.location = "<?php echo site_url(); ?>LittleLeaders/Excel_Contrato/"+tipo_excel;
    }
</script>
