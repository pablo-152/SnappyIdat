...
<table class="table table-hover table-bordered table-striped" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th class="text-center" width="5%" title="Parentesco">Paren.</th>
        ...
        <?php foreach($list_nuevos as $list){ ?>                                           
            <tr class="even pointer text-center">
                ...
                <td>
                    ...
                    app_crear_mod="<?= site_url('LittleLeaders/Modal_Update_Email_Contrato') ?>/<?php echo $list['id_documento_firma']; ?>">
                    ...
                    <?php if($list['estado_d']==2 && ($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==7 || $_SESSION['usuario'][0]['id_usuario']==85 || $id_nivel==6)){ ?>
