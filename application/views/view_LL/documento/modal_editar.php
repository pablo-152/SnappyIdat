        ...
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <select class="form-control" name="nom_grado_u" id="nom_grado_u">
                    ...
                    <option value="1 Años" <?php if($get_id[0]['nom_grado']=="1 Años"){ echo "selected"; } ?>>1 Años</option>
                    <option value="2 Años" <?php if($get_id[0]['nom_grado']=="2 Años"){ echo "selected"; } ?>>2 Años</option>
                    <option value="3 Años" <?php if($get_id[0]['nom_grado']=="3 Años"){ echo "selected"; } ?>>3 Años</option>
                    <option value="4 Años" <?php if($get_id[0]['nom_grado']=="4 Años"){ echo "selected"; } ?>>4 Años</option>
                    <option value="5 Años" <?php if($get_id[0]['nom_grado']=="5 Años"){ echo "selected"; } ?>>5 Años</option>
                </select>
            </div>
...
<script>
    function Update_Documento(){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Update_Documento";
