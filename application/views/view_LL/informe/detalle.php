            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('LittleLeaders/Informe') ?>" style="margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/icono-regresar.png">
                        </a>

                        <a href="<?= site_url('LittleLeaders/Excel_Detalle_Informe') ?>/<?php echo $CourseId; ?>">
                    ...
                    <tbody>      
                        <?php $i=1; foreach($list_detalle as $list){ ?>                                
                            <tr class="even pointer text-center">  
                                ...
                                <td>
                                    <a title="Detalle" role="button" href="<?php echo site_url(); ?>LittleLeaders/Detalle_Alumno/<?php echo $list['CourseId']; ?>/<?php echo substr($list['PaymentDueDate'],0,4).substr($list['PaymentDueDate'],5,2).substr($list['PaymentDueDate'],8,2); ?>">
