            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('LittleLeaders/Detalle_Informe/') ?><?php echo $CourseId;?>" style="margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/icono-regresar.png">
                        </a>

                        <a href="<?= site_url('LittleLeaders/Excel_Detalle_Alumno') ?>/<?php echo $CourseId; ?>/<?php echo $PaymentDueDate; ?>">
