            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="" style="cursor:pointer;margin-right:5px;"><!--onclick="Actualizar_Lista_Mailing();"-->
                            <img src="<?= base_url() ?>template/img/actualizar_lista.png">
                        </a>

                        <a title="Nuevo" data-toggle="modal" data-target="#acceso_modal" 
                        app_crear_per="<?= site_url('LittleLeaders/Modal_Mailing') ?>" 
                        style="cursor:pointer;margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/nuevo.png">
                        </a>

                        <a href="<?= site_url('LittleLeaders/Excel_Mailing') ?>">
...
<script>
    ...
    function Lista_Mailing(){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Lista_Mailing";
    ...
    function Actualizar_Lista_Mailing(id){ 
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Actualizar_Lista_Mailing";
    ...
    function Delete_Mailing(id){
        ...
        var url="<?php echo site_url(); ?>LittleLeaders/Delete_Mailing";
    ...
    function Descargar_Mailing(id){
        window.location.replace("<?php echo site_url(); ?>LittleLeaders/Descargar_Mailing/"+id); 
    }
</script>
