        ...
        <?php foreach($list_mailing as $list){ ?>                                            
            <tr class="even pointer text-center">
                ...
                <td>
                    ...
                    app_crear_mod="<?= site_url('LittleLeaders/Modal_Update_Mailing') ?>/<?php echo $list['id_mailing']; ?>">
                        <img src="<?= base_url() ?>template/img/editar.png">
                    </a>

                    <a title="Detalle" href="<?= site_url('LittleLeaders/Detalle_Mailing') ?>/<?php echo $list['id_mailing']; ?>">
