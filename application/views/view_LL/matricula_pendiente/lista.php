...
<table id="example" class="table table-hover table-bordered table-striped" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th width="10%" class="text-center">Grado <?php echo date('Y')-1; ?></th>
            <th width="10%" class="text-center">Grado <?php echo date('Y'); ?></th>
            ...
            <tr class="even pointer text-center">
                ...
                <td class="text-left">
                    <?php if($list['CourseGradeId']==0){echo "2 Primaria";}
                        ...
                        elseif($list['CourseGradeId']==15){echo "1 Año";}
                        elseif($list['CourseGradeId']==16){echo "2 Años";}
                    ?>
                </td>
