...
<table id="example_obs" class="table table-hover table-bordered table-striped" width="100%"> 
    <thead>
        <tr style="background-color: #E5E5E5;"> 
            ...
            <?php if($id_usuario==1 || $id_usuario==7 || $id_usuario==85 || $id_nivel==6){ ?>
...
<script>
    $(document).on('click', '#download_file', function () {
        ...
        window.location.replace("<?php echo site_url(); ?>LittleLeaders/Descargar_ArchivoOA/" + image_id);
    });
    ...
    if(nivel_actual==1 || nivel_actual==6 || nivel_actual==7 || nivel_actual==85){
