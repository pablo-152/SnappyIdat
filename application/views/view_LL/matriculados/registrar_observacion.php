...
<div class="modal-footer">
    <button type="button" class="btn btn-default" onclick="Registrar_Observacion_Alumno();">
        <i class="glyphicon glyphicon-remove-sign"></i>Limpiar
    </button>
    <button id="boton_obs" type="button" class="btn btn-primary" onclick="Insert_Observacion_Alumno();">
