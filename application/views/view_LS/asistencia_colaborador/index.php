...
<script>
    ...
    function Lista_Asistencia(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Asistencia_Colaborador_Lista";
    ...
    function Excel_Asistencia_Colaborador(){
        ...
        window.location = "<?php echo site_url(); ?>LeadershipSchool/Excel_Asistencia_Colaborador/"+fec_in+"/"+fec_fi;
    }
