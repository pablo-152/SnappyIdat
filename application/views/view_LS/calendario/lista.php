    ...
    <tbody>
        <?php foreach($list_festivo as $list) {  ?>                                           
            <tr class="even pointer text-center">
                ...
                <td>
                    <a title="Editar" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('LeadershipSchool/Modal_Update_Calendario') ?>/<?php echo $list['id_calendario']; ?>" >
