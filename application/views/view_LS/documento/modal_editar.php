...
<form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <select class="form-control" name="nom_grado_u" id="nom_grado_u">
                    <option value="Todos" <?php if($get_id[0]['nom_grado']=="Todos"){ echo "selected"; } ?>>Todos</option>
                    <option value="1 Primaria" <?php if($get_id[0]['nom_grado']=="1 Primaria"){ echo "selected"; } ?>>1 Primaria</option>
                    <option value="2 Primaria" <?php if($get_id[0]['nom_grado']=="2 Primaria"){ echo "selected"; } ?>>2 Primaria</option>
                    <option value="3 Primaria" <?php if($get_id[0]['nom_grado']=="3 Primaria"){ echo "selected"; } ?>>3 Primaria</option>
                    <option value="4 Primaria" <?php if($get_id[0]['nom_grado']=="4 Primaria"){ echo "selected"; } ?>>4 Primaria</option>
                    <option value="5 Primaria" <?php if($get_id[0]['nom_grado']=="5 Primaria"){ echo "selected"; } ?>>5 Primaria</option>
                    <option value="6 Primaria" <?php if($get_id[0]['nom_grado']=="6 Primaria"){ echo "selected"; } ?>>6 Primaria</option>
                    <option value="1 Secundaria" <?php if($get_id[0]['nom_grado']=="1 Secundaria"){ echo "selected"; } ?>>1 Secundaria</option>
                    <option value="2 Secundaria" <?php if($get_id[0]['nom_grado']=="2 Secundaria"){ echo "selected"; } ?>>2 Secundaria</option>
                    <option value="3 Secundaria" <?php if($get_id[0]['nom_grado']=="3 Secundaria"){ echo "selected"; } ?>>3 Secundaria</option>
                    <option value="4 Secundaria" <?php if($get_id[0]['nom_grado']=="4 Secundaria"){ echo "selected"; } ?>>4 Secundaria</option>
                    <option value="5 Secundaria" <?php if($get_id[0]['nom_grado']=="5 Secundaria"){ echo "selected"; } ?>>5 Secundaria</option>
                </select>
            </div>
...
<script>
    function Update_Documento(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Update_Documento";
