            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a type="button" href="<?= site_url('LeadershipSchool/Informe_Lista') ?>" style="margin-right:5px;">
...
<script>
    ...
    function Lista_Informe(tipo){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Informe";
    ...
    function Excel_Lista_Informe(){
        ...
        window.location = "<?php echo site_url(); ?>LeadershipSchool/Excel_Lista_Informe/"+tipo_excel;
    }
</script>
