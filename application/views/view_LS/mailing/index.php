            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        ...
                        app_crear_per="<?= site_url('LeadershipSchool/Modal_Mailing') ?>" 
                        style="cursor:pointer;margin-right:5px;">
                            <img src="<?= base_url() ?>template/img/nuevo.png">
                        </a>

                        <a href="<?= site_url('LeadershipSchool/Excel_Mailing') ?>">
...
<script>
    ...
    function Lista_Mailing(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Mailing";
    ...
    function Actualizar_Lista_Mailing(id){ 
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Actualizar_Lista_Mailing";
    ...
    function Delete_Mailing(id){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Delete_Mailing";
