<table class="table table-hover table-bordered table-striped" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <th class="text-center" width="12%" title="Tipo Envío">Día Envío</th> 
            <th class="text-center" width="22%">Título</th> 
    ...
    <tbody>
        <?php foreach($list_mailing as $list){ ?>                                            
            <tr class="even pointer text-center">
                ...
                <td class="text-left"><?php echo $list['dia_envio']; ?></td>      
                ...
                <td>
                    ...
                    app_crear_mod="<?= site_url('LeadershipSchool/Modal_Update_Mailing') ?>/<?php echo $list['id_mailing']; ?>">
                        <img src="<?= base_url() ?>template/img/editar.png">
                    </a>

                    <a title="Detalle" href="<?= site_url('LeadershipSchool/Detalle_Mailing') ?>/<?php echo $list['id_mailing']; ?>">
