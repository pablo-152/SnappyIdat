...
<div class="panel panel-flat">
    ...
    <div class="container-fluid">
        <div class="heading-btn-group">
            ...
            <a onclick="Lista_Matricula_Pendiente(2);" id="nuevos" style="background-color:#00C000;" class="form-group btn clase_boton"><span>Nuevos</span><i class="icon-arrow-down52"></i></a>
...
<script>
    ...
    function Lista_Matricula_Pendiente(tipo){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Matricula_Pendiente";
    ...
    function Excel_Matricula_Pendiente(){
        var tipo=$('#tipo').val();
        window.location ="<?php echo site_url(); ?>LeadershipSchool/Excel_Matricula_Pendiente/"+tipo;
    }
</script>
