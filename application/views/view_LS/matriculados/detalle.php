            ...
            <div class="x_panel">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a title="Editar" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('LeadershipSchool/Modal_Update_Sexo') ?>/<?php echo $get_id[0]['Id']; ?>" style="margin-right:5px;"> 
                            <img src="<?= base_url() ?>template/img/editar_grande.png" alt="" >
                        </a>

                        <a title="Adicionar Tutor" data-toggle="modal" data-target="#acceso_modal_mod" 
                        app_crear_mod="<?= site_url('LeadershipSchool/Modal_Tutor') ?>/<?php echo $get_id[0]['Id']; ?>" 
                ...
                <div class="tab-panels">
                            ...
                            <div class="panel panel-flat content-group-lg">
                                ...
                                <div class="panel-body" style="padding-bottom:0px;">
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="text" class="form-control" disabled value="<?php echo $get_id[0]['nom_sexo']; ?>" <?php if($get_id[0]['nom_sexo']==""){ echo "style='border-color:#FBE5D6;background-color: #FBE5D6 !important;'"; } ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel panel-flat content-group-lg">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                            ...
                                            app_crear_mod="<?= site_url('LittleLeaders/Modal_Update_Tutor') ?>/<?php echo $list['id_tutor']; ?>">
                    ...
                    <section id="rauchbier3" class="tab-panel">
                        <div class="boton_exportable">
                            <a title="Excel" href="<?= site_url('LeadershipSchool/Excel_Documento_Alumno') ?>/<?php echo $get_id[0]['Id']; ?>">
                                <img src="<?= base_url() ?>template/img/boton_excel_tabla.png">
                            </a>
                        </div>
                    ...
                    <section id="rauchbier7" class="tab-panel">
                        <div class="boton_exportable">
                            <a title="Excel" href="<?= site_url('LeadershipSchool/Excel_Sms_Alumno') ?>/<?php echo $get_id[0]['Id']; ?>">
                                <img src="<?= base_url() ?>template/img/boton_excel_tabla.png">
                            </a>
                        </div>
...
<script>
    ...
    function Descargar_Foto_Matriculados(id){
        window.location.replace("<?php echo site_url(); ?>LeadershipSchool/Descargar_Foto_Matriculados/"+id);
    }

    function Delete_Tutor(id){
        Cargando();

        var url="<?php echo site_url(); ?>LeadershipSchool/Delete_Tutor";
    ...
    function Lista_Documentos(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Documento_Matriculados";
    ...
    function Delete_Documento_Alumno(id_detalle){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Delete_Documento_Alumno";
    ...
    function Lista_Pagos(estado){
        ...
        var id_alumno = $('#id_alumno').val();
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Pago_Matriculados";
    ...
    function Excel_Pago_Matriculados(){
        ...
        window.location ="<?php echo site_url(); ?>LeadershipSchool/Excel_Pago_Matriculados/"+id_alumno+"/"+tipo_excel;
    }
    ...
    function Lista_Contratos(){
        ...
        var id_alumno = $('#id_alumno').val();
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Contrato_Matriculados";
    ...
    function Lista_Mensajes(){
        ...
        var id_alumno = $('#id_alumno').val();
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Mensaje_Matriculados";
    ...
    function Lista_Sms(){ 
        ...
        var id_alumno = $('#id_alumno').val();
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Sms_Matriculados";
    ...
    function Lista_Observacion(){
        ...
        var id_alumno = $("#id_alumno").val();
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Observacion_Alumno";
    ...
    function Registrar_Observacion_Alumno(id_alumno){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Registrar_Observacion_Alumno";
    ...
    function Lista_Ingreso(){ 
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Ingreso_Matriculados";
    ...
    function Excel_Modulo(){
        ...
        var id_alumno = $('#id_alumno').val();
        var modulo = document.querySelector('input[name=modulo]:checked').value;
        window.location ="<?php echo site_url(); ?>LeadershipSchool/Excel_Modulo/"+id_alumno+"/"+modulo;
    }
    ...
    function Insert_Observacion_Alumno(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Insert_Observacion_Alumno";
    ...
    function Editar_Observacion_Alumno(id){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Editar_Observacion_Alumno";
    ...
    function Update_Observacion_Alumno(){
        ...
        var dataString = new FormData(document.getElementById('formulario_obs'));
        var url="<?php echo site_url(); ?>LeadershipSchool/Update_Observacion_Alumno";
    ...
    function Delete_Observacion_Alumno(id){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Delete_Observacion_Alumno";
    ...
    function Excel_Observacion(){
        var id_alumno = $('#id_alumno').val();
        window.location ="<?php echo site_url(); ?>LeadershipSchool/Excel_Observacion_Alumno/"+id_alumno;
    }
</script>
