...
<div class="panel panel-flat">
    ...
    <div class="container-fluid">
        <div class="heading-btn-group">
            <a onclick="Lista_Matriculados(1);" id="matriculados_btn" style="color:#ffffff;background-color:#00C000;" class="form-group btn clase_boton"><span>Matriculados</span><i class="icon-arrow-down52"></i></a>
...
<script> 
    ...
    function Lista_Matriculados(tipo){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Lista_Matriculados";
    ...
    function Actualizar_Lista_Matriculados(){  
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Actualizar_Lista_Matriculados";
    ...
    function Excel_Matriculados(){
        var tipo=$('#tipo').val();
        window.location ="<?php echo site_url(); ?>LeadershipSchool/Excel_Matriculados/"+tipo;
    }
</script>
