<form id="formulario_update" method="POST" enctype="multipart/form-data" class="formulario">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="Update_Foto_Matriculados()">
...
<script>
    ...
    function Update_Foto_Matriculados(){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Valida_Update_Foto_Matriculados";
        var url2="<?php echo site_url(); ?>LeadershipSchool/Update_Foto_Matriculados";

        if (Valida_Update_Foto_Matriculados()) {
            $.ajax({
                url: url,
                data:dataString,
                type:"POST",
                                ...
                                $.ajax({
                                    ...
                                    success:function (data) {
                                        swal.fire(
                                            ...
                                            window.location = "<?php echo site_url(); ?>LeadershipSchool/Detalle_Matriculados/"+id_alumno;
                                        });
                                    }
                                });
                            }
    ...
    function Valida_Update_Foto_Matriculados() {
        if($('#foto').val().trim() === '') {
            Swal(
                'Ups!',
