    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;"> 
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-12">
                <textarea name="obs_retiro" id="obs_retiro" class="form-control" cols="10" rows="4" placeholder="Observación"><?php echo $get_id[0]['obs_retiro']; ?></textarea>
            </div>
        </div>
    </div>
...
<script>
    function Update_Obs_Motivo_Retiro(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Update_Obs_Motivo_Retiro";
