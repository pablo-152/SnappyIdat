<table class="table table-hover table-striped table-bordered" id="example" width="100%">
    <thead>
        <tr style="background-color: #E5E5E5;">
            ...
            <!--<th class="text-center" width="6%" title="Tipo Asistencia">T. Asist.</th>-->
            <th class="text-center" width="6%">Registro</th>
    ...
    <tbody>
        <?php foreach($list_registro_ingreso as $list){ ?>                                        
            <tr class="even pointer text-center" <?php /*if($list['Tipo_Acceso']==2){ ?> style="background-color:#fbe5d6;" <?php } */?>>
                ...
                <td>
                    <?php if($list['obs']=="Si"){ ?>
                        ...
                        app_crear_mod="<?= site_url('LeadershipSchool/Modal_Historial_Registro_Ingreso') ?>/<?php echo $list['id_registro_ingreso']; ?>">
