            ...
            <div class="x_panel">
                ...
                <div class="heading-elements"> 
                    <div class="heading-btn-group">
                        <a title="Nuevo" style="cursor:pointer;margin-right:5px;" href="<?= site_url('LeadershipSchool/Registrar_Salon') ?>">
                            <img src="<?= base_url() ?>template/img/nuevo.png" alt="Nuevo">
                        </a>

                        <a href="<?= site_url('LeadershipSchool/Excel_Salon') ?>">
                    ...
                    <tbody>
                        <?php foreach($list_salon as $list) {  ?>                                           
                            <tr class="even pointer text-center">
                                ...
                                <td>
                                    <a title="Editar" href="<?= site_url('LeadershipSchool/Editar_Salon') ?>/<?php echo $list['id_salon']; ?>">
...
<script>
    ...
    function Delete_Salon(id){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Delete_Salon";
