    ...
    <div class="row">
      ...
      <div class="heading-elements">
          <div class="heading-btn-group">
              <a type="button" href="<?= site_url('LeadershipSchool/Salon') ?>" >
    ...
    <form id="formulario_insert" method="POST" enctype="multipart/form-data" class="formulario">
        ...
        <div class="col-md-12 row">
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control solo_numeros" id="capacidad_i" name="capacidad_i" placeholder="Capacidad">
            </div>

            <div class="form-group col-md-2">
                <label class="control-label text-bold">Disponible:</label>
                <input type="text" class="form-control solo_numeros" id="disponible_i" name="disponible_i" placeholder="Disponible">
            </div>
        ...
        <div class="modal-footer">
            ...
            <a type="button" class="btn btn-default" href="<?= site_url('LeadershipSchool/Salon') ?>">
...
<script>
    ...
    function Insert_Salon(){
        ...
        var url="<?php echo site_url(); ?>LeadershipSchool/Insert_Salon";
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data=="error"){
                        ...
                        window.location = "<?php echo site_url(); ?>LeadershipSchool/Salon";
                    }
                }
            });
        }
