...
<table id="example" class="table table-hover table-bordered table-striped" width="100%">
    ...
    <tr style="background-color: #E5E5E5;">
        ...
        <th>Id</th>
        <th width="8%" class="text-center" title="Apellido Paterno">Ap.&nbsp;Pat.</th>
        <th width="8%" class="text-center" title="Apellido Materno">Ap.&nbsp;Mat.</th>
        <th width="11%" class="text-center" title="Nombre(s)">Nombre(s)</th>
        <th width="4%" class="text-center" title="Código GLL">C.&nbsp;GLL</th>
        <th width="4%" class="text-center" title="Código GLLA">C.&nbsp;GLLA</th>
        <th width="6%" class="text-center" title="Fecha Pago">Fecha P.</th>
        <th width="5%" class="text-center" title="Monto">Monto</th>
        <th width="6%" class="text-center" title="Foto">Foto</th>
        <th width="7%" class="text-center" title="Usuario">Usuario</th>
        <th width="6%" class="text-center" title="Envio">Envio</th>
        <th width="7%" class="text-center" title="Usuario">Usuario</th>
        <th width="7%" class="text-center" title="Cargo">Cargo</th>
        <th width="6%" class="text-center" title="Estado">Estado</th>
        <th width="8%"></th>
        <th title="Estado">Orden</th>
    </tr>
    </thead>
    <tbody>
    <?php foreach ($list_fotocheck as $list){ ?>
        <tr class="even pointer text-center">
            ...
            <td><?php echo $list['codigo_glla']; ?></td>
            ...
            <td>
                <?php if($list['id_fotocheck']!=''){
                    if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==5 || $_SESSION['usuario'][0]['id_nivel']==1 || $_SESSION['usuario'][0]['id_nivel']==9 || $_SESSION['usuario'][0]['id_usuario']==7 || $_SESSION['usuario'][0]['id_usuario']==33){ ?>
                        <a type="button" style="margin-right:5px;" data-toggle="modal" data-target="#modal_form_vertical" modal_form_vertical="<?= site_url('Colaborador/Modal_Detalle') ?>/<?php echo $list['id_fotocheck']; ?>">
                    ...
                    if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==5 || $_SESSION['usuario'][0]['id_usuario']==30 ||
                        ...
                        <a type="button" href="<?= site_url('Colaborador/Carne_Colaborador') ?>/<?php echo $list['id_fotocheck']; ?>" target="_blank" style="margin-right:5px;" >
                ...
                if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==5 || $_SESSION['usuario'][0]['id_usuario']==70 ||
                    ...
                    <a type="button" style="margin-right:5px;" data-toggle="modal" data-target="#acceso_modal_mod" app_crear_mod="<?= site_url('Colaborador/Modal_Foto') ?>/<?php echo $list['id_fotocheck']; ?>">
                ...
                <?php if($_SESSION['usuario'][0]['id_usuario']==1 || $_SESSION['usuario'][0]['id_usuario']==5 || $_SESSION['usuario'][0]['id_usuario']==33){
                    if($list['id_fotocheck']!=''){ ?>
                        <a type="button" style="margin-right:5px;" data-toggle="modal" data-target="#LargeLabelModal" LargeLabelModal="<?= site_url('Colaborador/Modal_Anular') ?>/<?php echo $list['id_fotocheck']; ?>">
