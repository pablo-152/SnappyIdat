<form id="formulario_foto" method="POST" enctype="multipart/form-data" class="formulario">
    <div class="modal-header">
        ...
        <div class="col-md-12 row">
            <div class="form-group col-md-6">
                <h5><b>Alumno(a): </b><?php echo $get_id[0]['Apellido_Paterno']."&nbsp".$get_id[0]['Apellido_Materno'].",&nbsp".$get_id[0]['Nombres']; ?></h5>
                <!--<h5><b>Especialidad: </b><?php echo $get_id[0]['Especialidad']; ?></h5>-->
            </div>
            <div class="form-group col-md-6">
                <h5><b>Código: </b><span><?php echo $get_id[0]['codigo_gll']; ?></span></h5>
            </div>
        </div>
    </div>
    ...
    <div class="modal-footer">
        ...
        <input type="hidden" id="id_sede" name="id_sede" value="<?php echo $get_id[0]['id_sede']; ?>">
...
<script>
    ...
    function Agregar_Foto() {
        ...
        var url="<?php echo site_url(); ?>Colaborador/Guardar_Foto";
