...
<div class="modal-body" style="max-height:520px; overflow:auto;">
    <div id="lista_registro_salida" class="col-md-12 row"> 
...
<script>
    function Lista_Registro_Salida(){
        ...
        var url = "<?php echo site_url(); ?>Asistencia/Lista_Registro_Salida";

        $.ajax({
            url: url,
            type: 'POST',
            success: function(resp){
                $('#lista_registro_salida').html(resp);
            }
        });
    }
    ...
    function Update_Registro_Salida(id){
        ...
        var url="<?php echo site_url(); ?>Asistencia/Update_Registro_Salida";
    ...
    function Update_Registro_Salida_No_Registrada(id){
        $(document)
        .ajaxStart(function () {
            $.blockUI({
                message: '<svg> ... </svg>',
        ...
        var url="<?php echo site_url(); ?>Asistencia/Update_Registro_Salida_No_Registrada";

        Swal({
            title: '¿Seguro que desea registrar esta Salida como no registrada?',
            text: "Esta acción no se puede revertir y se envia correo automático al colaborador y a la administración",
            type: 'warning',
