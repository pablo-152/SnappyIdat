...
<html lang="es">
		...
		<div class="contenedor-general">
            <div class="contenedor-superior">
				<div class="contenedor-img">
					<img src="<?= base_url() ?>template/img/logos leadership school blanco.png">
				</div>
				...
				<div class="contenedor-datos">
					<div class="contenedor-busqueda">
						<div class="contenedor-busqueda-input">
							<input type="text" class="text" id="codigo_alumno" name="codigo_alumno" > <!-- onkeypress="if(event.which === 13) {Insert_Alumno_FV();}"-->
    ...
    <!--<input id="codigo" name="codigo" type="text" value="<?php echo $id_usuario ?>">-->
</html>
...
<script>
    ...
    var barcodeValue = '';
    var timeout;
    document.getElementById('codigo_alumno').addEventListener('keydown', function(event) {
        var cod = $('#codigo').val();
    /*if(cod=='5'){*/
    ...
    function verificar(){
        var modal = document.getElementById('acceso_modal_eli');
        var modal2 = document.getElementById('acceso_modal_autorizacion');
        var estado = modal.style.display === 'block' ? '1' : '0';
        var estado2 = modal2.style.display === 'block' ? '1' : '0';
        //alert(estado);
        if(estado='1'){
            document.body.addEventListener('click', function() {
            // Obtén el elemento de entrada por su ID
            var inputElement = document.getElementById('codigo_alumno');
        ...
        if(estado2='1'){
            $('#clave_admin_condicionado').focus();
        document.body.addEventListener('click', function() {
        // Obtén el elemento de entrada por su ID
        var inputElement = document.getElementById('clave_admin_condicionado');
