...
<div class="contenedor-mostrar-datos">
    <div class="contenedor-mostrar-inputs">
        ...
        <div class="text2"><label>&nbsp;&nbsp;<b>Grado:</b> <?php echo $get_id[0]['Grado']; ?></label></div>
        <div class="text3"><label>&nbsp;&nbsp;<b>Sección:</b> <?php echo $get_id[0]['Seccion']; ?></label><div style="width: 50%; text-align:end;"> <img src="<?= base_url() ?>template/img/iconslupa.png" style="width: 20%;" data-toggle="modal" data-target="#modal_ver2" app_crear_ver="<?= site_url('Asistencia/Lista_Historico')?>/<?php echo $get_id[0]['Codigo']; ?>"></div></div>
        <div class="text4"><label>&nbsp;&nbsp;<b>Curso:</b> <?php echo $get_id[0]['Curso']; ?></label></div>
    </div>
