<?php
    ...
    $list_foto_pendiente = mysqli_query($conexion, "SELECT fo.id_fotocheck FROM fotocheck fo
                            ...
                            WHERE fo.esta_fotocheck=0 AND td.Alumno='Matriculado'"); 
    ...
    if($total>0){
        ...
        try {
            ...
            $mail->addAddress('dcomunicacion@ifv.edu.pe');
    
            $mail->isHTML(true);                                  // Set email format to HTML
    
            $mail->Subject = "Pendiente fotos de Fotocheck";
        
            $mail->Body = '<FONT SIZE=3>
                                ¡Hola!<br><br>
                                Tienes '.$total.' fotochecks pendientes de sacar fotos.<br><br>
