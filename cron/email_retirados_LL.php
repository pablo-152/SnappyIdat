<?php
    ...
    if(date('l')=="Friday"){
        $list_retirado = mysqli_query($conexion, "SELECT Id FROM todos_ll 
                        WHERE Alumno='Retirado' AND (SELECT COUNT(*) FROM alumno_retirado al
                        WHERE al.id_empresa=2 AND al.Id=todos_ll.Id AND al.estado=2)=0");
        ...
        try {
            ...
            $mail->setFrom('noreplay@ifv.edu.pe', 'Alumnos Retirados LL'); //desde donde se envia
            ...
            $mail->Subject = 'Alumnos Retirados LL';
