<?php
    ...
    if(date('l')=="Friday"){
        $list_retirado = mysqli_query($conexion, "SELECT Id FROM todos_ls 
                        WHERE Alumno='Retirado' AND (SELECT COUNT(*) FROM alumno_retirado al
                        WHERE al.id_empresa=4 AND al.Id=todos_ls.Id AND al.estado=2)=0");
        ...
        try {
            ...
            $mail->setFrom('noreplay@ifv.edu.pe', 'Alumnos Retirados LS'); //desde donde se envia
            ...
            $mail->Subject = 'Alumnos Retirados LS';
