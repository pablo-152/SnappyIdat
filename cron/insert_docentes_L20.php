<?php
    ...
    while($fila_p = mysqli_fetch_assoc( $query_p) ) {
        ...
        $codigoa1=$fila_p['codigo_gll']."''C"; 
        $query_ap = mysqli_query($conexion, "INSERT INTO matriculados_l20 (Tipo,Id,Dni,Email,Apellido_Paterno,
                    Apellido_Materno,Nombre, Codigo, Codigoa) 
                    ...
                    '".$fila_p['codigo_gll']."', '".addslashes($codigoa)."')");
        
        $query_ap1 = sqlsrv_query($conexion_vps, "INSERT INTO matriculados_l20 (Tipo,Id,Dni,Email,
                    Apellido_Paterno,Apellido_Materno,Nombre, Codigo, Codigoa) 
                    VALUES (2,'".$fila_p['id_colaborador']."','".$fila_p['dni']."',
                    '".$fila_p['correo_corporativo']."','".$fila_p['apellido_paterno']."',
                    '".$fila_p['apellido_materno']."','".$fila_p['nombres']."','".$fila_p['codigo_gll']."',
                    '".$codigoa1."')");
    }
