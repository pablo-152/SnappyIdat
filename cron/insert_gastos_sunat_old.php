<?php
    ...
    $query_c = sqlsrv_query($conexion_arpay,"SELECT ap.Id,FORMAT(ap.AccountingDate,'yyyy-MM-dd') AS Mes_Anio,
                ...
                WHERE YEAR(ap.PaymentDate) IN (2021,2022) AND ap.ReceiptTypeId IN (0,3,4,5,6,7,10,11,12,13) AND ap.AccountingPaymentStatusId=0 
                ORDER BY ap.ReceiptDate ASC");

    include 'conexion.php';

    $query_t = mysqli_query($conexion, "TRUNCATE TABLE gastos_sunat_arpay");
