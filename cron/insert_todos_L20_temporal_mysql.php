<?php
    ...
    mysqli_query($conexion, "TRUNCATE TABLE todos_l20_temporal");

    while( $fila = sqlsrv_fetch_array($query_c, SQLSRV_FETCH_ASSOC)) { 
        mysqli_query($conexion, "INSERT INTO todos_l20_temporal (Id,Dni,Email,Apellido_Paterno,Apellido_Materno,Nombre,
        ...
        Estado_Cuota_1) 
        VALUES ('".$fila['Id']."','".$fila['IdentityCardNumber']."','".$fila['Email']."','".$fila['FatherSurname']."',
        '".$fila['MotherSurname']."','".$fila['FirstName']."','".$fila['InternalStudentId']."','".$fila['CareerGroupText']."',
        '".substr($fila['CareerName'],0,-6)."','".$fila['CareerShifts']."','".$fila['Module']."','".$fila['Seccion']."',
        '".$fila['MatriculationStatus']."','".$fila['StudentStatus']."','".$fila['Fecha_Cumpleanos']."',
        '".$fila['MobilePhone']."','".$fila['Pago_Pendiente']."','".$fila['Documento_Pendiente']."','".$fila['Observation']."',
        '".$fila['Motivo_Arpay']."','".$fila['Observaciones_Arpay']."','".$fila['Fecha_Fin_Arpay']."','".$fila['Fotocheck']."',
        '".$fila['Estado_Matricula']."','".$fila['Estado_Cuota_1']."')");
    }
?>