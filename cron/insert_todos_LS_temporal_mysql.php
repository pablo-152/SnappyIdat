<?php
    ...
    $query_t = mysqli_query($conexion, "TRUNCATE TABLE todos_ls_temporal");

    while( $fila = sqlsrv_fetch_array( $query_c, SQLSRV_FETCH_ASSOC) ) {
        $query_a = mysqli_query($conexion, "INSERT INTO todos_ls_temporal (Id,Apellido_Paterno,Apellido_Materno,Nombre,Codigo,Dni,Email,Celular,Fecha_Cumpleanos,
