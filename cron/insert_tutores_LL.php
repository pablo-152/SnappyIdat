<?php
    ...
    $query_t = mysqli_query($conexion, "TRUNCATE TABLE tutores_ll");

    $query = mysqli_query($conexion, "SELECT GROUP_CONCAT(DISTINCT Id SEPARATOR ',') AS ids FROM todos_ll");
    ...
    while( $fila = sqlsrv_fetch_array( $query_a, SQLSRV_FETCH_ASSOC) ) {
        $query_i = mysqli_query($conexion, "INSERT INTO tutores_ll (Id_Tutor,Id_Alumno,Apellido_Paterno,Apellido_Materno,Nombre,Dni,Email,Celular,
