...
<body class="sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
    ...
    <form  method="post" id="formulario" enctype="multipart/form-data" action="<?= site_url('Examendeadmision/Pg6')?>" class="formulario">
        <div class="main-container" id="container">
                ...
                <div id="content" class="main-content">
                        ...
                        <div class="container">
                            ...
                            <!--<div id="navSection" data-spy="affix" class="nav  sidenav">
                                ...
                                <div style="text-align:center;padding:1em 0;"> <h3><a style="text-decoration:none;" href="https://www.zeitverschiebung.net/es/city/3936456"><span style="color:gray;">Hora actual en</span><br />Lima, Perú</a></h3> <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=es&size=medium&timezone=America%2FLima" width="100%" height="115" frameborder="0" seamless></iframe> </div>
                                    <a href="#pregunta1" class="active nav-link">Pregunta 41</a>
                                    <a href="#pregunta2" class="nav-link">Pregunta 42</a>
                                    <a href="#pregunta3" class="nav-link">Pregunta 43</a>
                                    <a href="#pregunta4" class="nav-link">Pregunta 44</a>
                                    <a href="#pregunta5" class="nav-link">Pregunta 45</a>
                                    <a href="#pregunta6" class="nav-link">Pregunta 46</a>
                                    <a href="#pregunta7" class="nav-link">Pregunta 47</a>
                                    <a href="#pregunta8" class="nav-link">Pregunta 48</a>
                                    <a href="#pregunta9" class="nav-link">Pregunta 49</a>
                                    <a href="#pregunta10" class="nav-link">Pregunta 50</a>
                                </div>
                            </div>-->
                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "41. ".$lista_pregunta[0]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[0]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P1();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[0]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta41" name="id_respuesta41" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "42. ".$lista_pregunta[1]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[1]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P2();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[1]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta42" name="id_respuesta42" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta42" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "43. ".$lista_pregunta[2]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[2]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P3();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[2]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta43" name="id_respuesta43" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta43" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "44. ".$lista_pregunta[3]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[3]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P4();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[3]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta44" name="id_respuesta44" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta44" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "45. ".$lista_pregunta[4]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[4]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P5();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[4]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta45" name="id_respuesta45" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta45" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "46. ".$lista_pregunta[5]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[5]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P6();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[5]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta46" name="id_respuesta46" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta46" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "47. ".$lista_pregunta[6]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[6]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P7();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[6]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta47" name="id_respuesta47" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta47" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "48. ".$lista_pregunta[7]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[7]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P8();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[7]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta48" name="id_respuesta48" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta48" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "49. ".$lista_pregunta[8]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[8]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P9();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[8]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta49" name="id_respuesta49" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta49" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "50. ".$lista_pregunta[9]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[9]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P10();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[9]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta50" name="id_respuesta50" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta50" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="col-lg-9" >
                        <div align="center">
                            <img src="template/img/5.png" id="por1" alt="">
...
<script type="text/javascript">
    ...
    $('#btn_asignar').on('click', function(e){
        ...
        var contador=0;
        $("input[id=id_respuesta41]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta42]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta43]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta44]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta45]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta46]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta47]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta48]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta49]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta50]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
