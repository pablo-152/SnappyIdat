...
<body class="sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
                ...
                <li class="nav-item align-self-center page-heading">
                    <div class="page-header">
                        <div class="page-title">
                            <h3><?php echo $areas[0]['nombre_area'] ?></h3>
    ...
    <form  method="post" id="formulario" enctype="multipart/form-data" action="<?= site_url('Examendeadmision/Pg3')?>" class="formulario">
        <div class="main-container" id="container">
                ...
                <div id="content" class="main-content">
                        ...
                        <div class="container">
                            ...
                            <!--<div id="navSection" data-spy="affix" class="nav  sidenav">
                                ...
                                <div style="text-align:center;padding:1em 0;"> <h3><a style="text-decoration:none;" href="https://www.zeitverschiebung.net/es/city/3936456"><span style="color:gray;">Hora actual en</span><br />Lima, Perú</a></h3> <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=es&size=medium&timezone=America%2FLima" width="100%" height="115" frameborder="0" seamless></iframe> </div>
                                    <a href="#pregunta1" class="active nav-link">Pregunta 11</a>
                                    <a href="#pregunta2" class="nav-link">Pregunta 12</a>
                                    <a href="#pregunta3" class="nav-link">Pregunta 13</a>
                                    <a href="#pregunta4" class="nav-link">Pregunta 14</a>
                                    <a href="#pregunta5" class="nav-link">Pregunta 15</a>
                                    <a href="#pregunta6" class="nav-link">Pregunta 16</a>
                                    <a href="#pregunta7" class="nav-link">Pregunta 17</a>
                                    <a href="#pregunta8" class="nav-link">Pregunta 18</a>
                                    <a href="#pregunta9" class="nav-link">Pregunta 19</a>
                                    <a href="#pregunta10" class="nav-link">Pregunta 20</a>
                                </div>
                            </div>-->
                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "11. ".$lista_pregunta[0]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[0]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P1();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[0]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta11" name="id_respuesta11" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "12. ".$lista_pregunta[1]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[1]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P2();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[1]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta12" name="id_respuesta12" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta12" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "13. ".$lista_pregunta[2]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[2]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P3();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[2]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta13" name="id_respuesta13" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta13" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "14. ".$lista_pregunta[3]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[3]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P4();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[3]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta14" name="id_respuesta14" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta14" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "15. ".$lista_pregunta[4]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[4]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P5();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[4]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta15" name="id_respuesta15" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta15" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "16. ".$lista_pregunta[5]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[5]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P6();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[5]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta16" name="id_respuesta16" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta16" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "17. ".$lista_pregunta[6]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[6]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P7();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[6]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta17" name="id_respuesta17" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta17" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "18. ".$lista_pregunta[7]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[7]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P8();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[7]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta18" name="id_respuesta18" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta18" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "19. ".$lista_pregunta[8]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[8]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P9();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[8]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta19" name="id_respuesta19" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta19" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "20. ".$lista_pregunta[9]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[9]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P10();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[9]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta20" name="id_respuesta20" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta20" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="col-lg-9" >
                        <div align="center">
                            <img src="template/img/2.png" id="por1" alt="">
...
<script type="text/javascript">
    ...
    $('#btn_asignar').on('click', function(e){
        ...
        var contador=0;
        $("input[id=id_respuesta11]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta12]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta13]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta14]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta15]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta16]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta17]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta18]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta19]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta20]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
