...
<body class="sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
    ...
    <div class="header-container fixed-top">
        ...
        <header class="header navbar navbar-expand-sm" style="background-color:#cdda06;">
            <ul class="navbar-item">
                <li class="nav-item notification-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="template/img/quimica.png" width="50" height="50" alt="">
                    </a>
                </li>
            </ul>
            <ul class="navbar-item flex-row">
                <li class="nav-item align-self-center page-heading">
                    <div class="page-header">
                        <div class="page-title">
                            <h3><?php echo $areas[2]['nombre_area'] ?></h3>
    ...
    <form  method="post" id="formulario" enctype="multipart/form-data" action="<?= site_url('Examendeadmision/Pg7')?>" class="formulario">
        <div class="main-container" id="container">
                ...
                <div id="content" class="main-content">
                        ...
                        <div class="container">
                            ...
                            <!--<div id="navSection" data-spy="affix" class="nav  sidenav">
                                ...
                                <div style="text-align:center;padding:1em 0;"> <h3><a style="text-decoration:none;" href="https://www.zeitverschiebung.net/es/city/3936456"><span style="color:gray;">Hora actual en</span><br />Lima, Perú</a></h3> <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=es&size=medium&timezone=America%2FLima" width="100%" height="115" frameborder="0" seamless></iframe> </div>
                                    <a href="#pregunta1" class="active nav-link">Pregunta 51</a>
                                    <a href="#pregunta2" class="nav-link">Pregunta 52</a>
                                    <a href="#pregunta3" class="nav-link">Pregunta 53</a>
                                    <a href="#pregunta4" class="nav-link">Pregunta 54</a>
                                    <a href="#pregunta5" class="nav-link">Pregunta 55</a>
                                    <a href="#pregunta6" class="nav-link">Pregunta 56</a>
                                    <a href="#pregunta7" class="nav-link">Pregunta 57</a>
                                    <a href="#pregunta8" class="nav-link">Pregunta 58</a>
                                    <a href="#pregunta9" class="nav-link">Pregunta 59</a>
                                    <a href="#pregunta10" class="nav-link">Pregunta 60</a>
                                </div>
                            </div>-->
                            ...
                            <div class="row">
                                <div id="pregunta1" class="col-lg-12 layout-spacing">
                                    <div class="statbox widget box box-shadow">
                                        <div class="widget-header" style="background-color:#cdda06">                                
                                            <div class="row">
                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "51. ".$lista_pregunta[0]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[0]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P1();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[0]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta51" name="id_respuesta51" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "52. ".$lista_pregunta[1]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[1]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P2();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[1]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta52" name="id_respuesta52" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta52" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "53. ".$lista_pregunta[2]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[2]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P3();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[2]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta53" name="id_respuesta53" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta53" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "54. ".$lista_pregunta[3]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[3]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P4();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[3]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta54" name="id_respuesta54" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta54" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "55. ".$lista_pregunta[4]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[4]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P5();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[4]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta55" name="id_respuesta55" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta55" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "56. ".$lista_pregunta[5]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[5]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P6();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[5]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta56" name="id_respuesta56" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta56" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "57. ".$lista_pregunta[6]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[6]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P7();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[6]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta57" name="id_respuesta57" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta57" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "58. ".$lista_pregunta[7]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[7]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P8();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[7]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta58" name="id_respuesta58" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta58" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "59. ".$lista_pregunta[8]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[8]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P9();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[8]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta59" name="id_respuesta59" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta59" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "60. ".$lista_pregunta[9]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[9]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P10();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[9]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta60" name="id_respuesta60" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta60" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="col-lg-9" >
                        <div align="center">
                            <img src="template/img/6.png" id="por1" alt="">
...
<script type="text/javascript">
    ...
    $('#btn_asignar').on('click', function(e){
        ...
        var contador=0;
        $("input[id=id_respuesta51]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta52]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta53]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta54]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta55]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta56]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta57]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta58]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta59]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta60]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
