...
<body class="sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
    ...
    <form  method="post" id="formulario" enctype="multipart/form-data" action="<?= site_url('Examendeadmision/Final')?>" class="formulario">
                        ...
                        <div class="container">
                            ...
                            <!--<div id="navSection" data-spy="affix" class="nav  sidenav">
                                ...
                                <div style="text-align:center;padding:1em 0;"> <h3><a style="text-decoration:none;" href="https://www.zeitverschiebung.net/es/city/3936456"><span style="color:gray;">Hora actual en</span><br />Lima, Perú</a></h3> <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=es&size=medium&timezone=America%2FLima" width="100%" height="115" frameborder="0" seamless></iframe> </div>
                                    <a href="#pregunta1" class="active nav-link">Pregunta 71</a>
                                    <a href="#pregunta2" class="nav-link">Pregunta 72</a>
                                    <a href="#pregunta3" class="nav-link">Pregunta 73</a>
                                    <a href="#pregunta4" class="nav-link">Pregunta 74</a>
                                    <a href="#pregunta5" class="nav-link">Pregunta 75</a>
                                    <a href="#pregunta6" class="nav-link">Pregunta 76</a>
                                    <a href="#pregunta7" class="nav-link">Pregunta 77</a>
                                    <a href="#pregunta8" class="nav-link">Pregunta 78</a>
                                    <a href="#pregunta9" class="nav-link">Pregunta 79</a>
                                    <a href="#pregunta10" class="nav-link">Pregunta 80</a>
                                </div>
                            </div>-->
                                                            ...
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "71. ".$lista_pregunta[0]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[0]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P1();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[0]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta71" name="id_respuesta71" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "72. ".$lista_pregunta[1]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[1]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P2();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[1]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta72" name="id_respuesta72" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta72" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "73. ".$lista_pregunta[2]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[2]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P3();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[2]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta73" name="id_respuesta73" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta73" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "74. ".$lista_pregunta[3]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[3]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P4();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[3]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta74" name="id_respuesta74" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta74" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "75. ".$lista_pregunta[4]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[4]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P5();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[4]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta75" name="id_respuesta75" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta75" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "76. ".$lista_pregunta[5]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[5]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P6();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[5]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta76" name="id_respuesta76" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta76" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "77. ".$lista_pregunta[6]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[6]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P7();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[6]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta77" name="id_respuesta77" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta77" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "78. ".$lista_pregunta[7]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[7]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P8();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[7]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta78" name="id_respuesta78" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta78" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "79. ".$lista_pregunta[8]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[8]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P9();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[8]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta79" name="id_respuesta79" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta79" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div  class="col-xl-10 col-md-10 col-sm-10" >
                                                        <div class="form-check">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-15" align="left">
                                                                        <h6 style="color:black" ><?php echo "80. ".$lista_pregunta[9]['pregunta']; ?>&nbsp;&nbsp;<?php if($lista_pregunta[9]['img']!=""){ ?> <a style="cursor:pointer;" class="" href="#" onclick="Img_P10();" title="Ver Imagen"><u> Ver Imagen</u></a> <?php }  ?></h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if($lista_pregunta[9]['id_pregunta']==$rpta['id_pregunta']){ ?>
                                                            <div class="form-check">
                                                                <div class="container">
                                                                    <div class="row">
                                                                        <div class="col-1" >
                                                                            <input type="radio"  style="width: 30px;" id="id_respuesta80" name="id_respuesta80" class="form-check-input" value="<?php echo $rpta['id_respuesta']."-".$rpta['correcto'] ?>" >
                                                                        </div>
                                                                        <div class="col-15" align="left">
                                                                            <label class="form-check-label" for="id_respuesta80" style="color:black; word-break: break-all;word-break: break-word;">
                                                                                <?php echo $rpta['desc_respuesta'] ?>
                                                                            </label>
                                                                        </div>
                                                                    </div>
...
<script type="text/javascript">
    ...
    $('#btn_asignar').on('click', function(e){
        ...
        var contador=0;
        $("input[id=id_respuesta71]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta72]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta73]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta74]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta75]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta76]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta77]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta78]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta79]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
        $("input[id=id_respuesta80]").each(function(){
        if($(this).is(":checked"))
            contador++;
        });
