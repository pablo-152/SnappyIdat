        ...
        <div class="modall modal-closer" id="quitaragregar">
            ...
            <div class="cuerpololamento">
                ...
                <div>
                    ...
                    Alguna duda por favor entra en contacto con nosotros.<br>
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <!--<h3 class="page-title">Estimado postulante</h3>

                        <h3 class="page-title">excedió el tiempo para responder el examen de admisión</h3>-->
